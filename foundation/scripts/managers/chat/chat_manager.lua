...
ChatManager.send_chat_message = function (self, channel_id, message, rpc)
...
ChatManager.register_chat_rpc_callbacks = function (self, callback_table)
...
ChatManager.enable_logger = function (self)
	if self._logger then
		self._logger:subscribe()
	end
end

ChatManager.set_chatlog_format_callback = function (self, name, func)
	if self._logger then
...
ChatManagerCallbacks.rpc_chat_message = function (self, sender, channel_id, message_sender, message)
