...
PackageManager.load = function (self, package_name, callback)
...
PackageManager.load_multiple = function (self, package_list, callback)
	if callback then
...
PackageManager.unload = function (self, package_name)
