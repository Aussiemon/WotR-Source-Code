...
InputManager._reset_mappings = function (self)
	self._source_map = {}
...
InputManager.map_controller = function (self, controller, slot)
...
InputManager.update_slot = function (self, slot)
...
InputManager.get_slot_controller_types = function (self, slot)
	local descriptions = {}
...
InputManager.get_slot_controllers = function (self, slot)
	local controllers = {}
...
InputManager.set_slot_mapping = function (self, slot, mapping_name)
	self._slot_mapping[slot] = mapping_name
end

InputManager.get_keymapping_type = function (self, slot)
	return self._slot_mapping[slot]
end

InputManager.unmap_controller = function (self, controller)
...
InputManager.map_slot = function (self, slot, mapping_template, default_mapping)
...
InputManager.unmap_input_source = function (self, input_source)
...
InputManager.update_input_source = function (self, input_source)
...
InputManager.get_input_keyname = function (self, slot, output)
...
InputManager.get_controller_type = function (self, controller)
...
InputManager.get_controller_settings_type = function (self, controller)
...
InputManager.get_controller = function (self, controller)
	local lut = {
		mouse = Mouse,
		keyboard = Keyboard,
		pad = Pad1,
...
InputManager._update_indices = function (self, controller, mapping)
...
InputManager._update_filters = function (self, dt)
...
InputManager._update_states = function (self, dt)
	for _, source in ipairs(self._mapped_input_sources) do
		source:update_states(dt)
	end
end

InputManager._update_current_global_input = function (self)
...
InputManager.active_mapping = function (self, slot_id)
	return self._active_input_mapping[slot_id] or InputManager.default_slot_mapping[slot_id]
end

InputManager.pad_active = function (self, slot_id)
