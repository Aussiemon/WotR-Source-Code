...
FilterVirtualAxis.init = function (self, params, controller)
	self._controller = controller
	self._params = params
	self._scale = params.scale or 1
end

FilterVirtualAxis.evaluate = function (self, source)
...
FilterInvertAxisY.init = function (self, params, controller)
	self._controller = controller
	self._params = params
	self._scale = params.scale or 1
end

FilterInvertAxisY.evaluate = function (self, source)
...
FilterAxisScale.init = function (self, params, controller)
	self._controller = controller
	self._params = params
...
FilterAxisScale.evaluate = function (self, source)
	local axis = source:get(self._params.axis)
...
FilterAxisScaleDt.init = function (self, params, controller)
	self._controller = controller
	self._params = params
	self._scale = params.scale
...
FilterAxisScaleDt.evaluate = function (self, source)
	return self._update_value
end

FilterAxisScaleDt.update = function (self, source, dt)
	local axis = source:get(self._params.axis)
...
FilterAxisScaleTimeRampDt.init = function (self, params, controller)
	self._controller = controller
	self._params = params
...
FilterAxisScaleTimeRampDt.evaluate = function (self, source)
	return self._update_value
end

FilterAxisScaleTimeRampDt.update = function (self, source, dt)
...
FilterAxisScaleRampDt.init = function (self, params, controller)
	self._controller = controller
	self._params = params
...
FilterAxisScaleRampDt.evaluate = function (self, source)
	return self._update_value
end

FilterAxisScaleRampDt.update = function (self, source, dt)
	local axis = source:get(self._params.axis)
	local x, y
	local scale_x = self._scale_x
	local scale_y = self._scale_y
...
FilterNumberToBoolean.init = function (self, params, controller)
	self._controller = controller
	self._params = params
end

FilterNumberToBoolean.evaluate = function (self, source)
...
FilterAlias.init = function (self, params, controller)
	self.alias_name = params.name
end

FilterAlias.evaluate = function (self, source)
...
FilterAxisNonZero.init = function (self, params, controller)
	self._params = params
end

FilterAxisNonZero.evaluate = function (self, source)
	local axis = source:get(self._params.axis)
...
FilterOr.init = function (self, params, controller)
...
FilterOr.evaluate = function (self, source)
...
FilterOrAxis.init = function (self, params, controller)
...
FilterOrAxis.evaluate = function (self, source)
	for _, input in pairs(self._params) do
...
FilterDoubleTap.init = function (self, params, controller)
...
FilterDoubleTap.update = function (self, source, dt)
	self._double_tap = false
...
FilterDoubleTap.evaluate = function (self)
	return self._double_tap
end

FilterControllerMenuMovement = class(FilterControllerMenuMovement)

FilterControllerMenuMovement.init = function (self, params, controller)
...
FilterControllerMenuMovement.evaluate = function (self, source)
	for _, input in pairs(self._params) do
...
FilterControllerMenuMovement.update = function (self, source, dt)
...
FilterCursorCompensator.init = function (self, params, controller)
...
FilterCursorCompensator.evaluate = function (self, source)
	for _, input in pairs(self._params) do
