...
InputSource.init = function (self, slot, mapping_template)
	self.slot = slot
...
InputSource.apply_mapping = function (self, controllers, mapping, global_mapping)
...
InputSource.clear = function (self)
...
InputSource.has = function (self, name)
...
InputSource.set_state = function (self, name, value)
	self.states[name] = value
end

InputSource.register_state_key = function (self, key, value)
	self.state_keys[key] = value
end

InputSource.get = function (self, name)
	fassert(self.mapping_table, "Trying to access unmapped input source.")
...
InputSource.update_filters = function (self, dt)
...
InputSource.update_states = function (self, dt)
