...
GrailPlantInteractable.init = function (self, world, unit, input)
...
GrailPlantInteractable.can_interact = function (self, player)
...
GrailPlantInteractable.interaction_complete = function (self, player)
...
GrailPlantInteractable.flow_cb_activate_interactable = function (self, team_side)
	self:_objective_activated(team_side, true)
	GrailPlantInteractable.super.flow_cb_activate_interactable(self, team_side)
end

GrailPlantInteractable.flow_cb_deactivate_interactable = function (self, team_side)
	self:_objective_activated(team_side, false)
	GrailPlantInteractable.super.flow_cb_deactivate_interactable(self, team_side)
end

GrailPlantInteractable._on_client_active_changed = function (self, team_side, active)
	self:_objective_activated(team_side, active)
end

GrailPlantInteractable._objective_activated = function (self, team_side, active)
