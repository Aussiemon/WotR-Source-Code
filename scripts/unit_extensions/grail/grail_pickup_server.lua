...
GrailPickupServer.init = function (self, world, unit, team_name, lifetime_on_drop, spawn_point)
	self._world = world
	self._unit = unit
...
GrailPickupServer._create_game_object = function (self)
	local data_table = {
...
GrailPickupServer.cb_game_session_disconnect = function (self)
	self._frozen = true
	self._id = nil
	self._game = nil
end

GrailPickupServer.update = function (self, unit, input, dt, context)
...
GrailPickupServer.despawn_on_drop = function (self)
	self._spawn_point:grail_drop_time_out()
	self:die()
end

GrailPickupServer.despawn_on_plant = function (self)
	self:die()
end

GrailPickupServer.die = function (self)
...
GrailPickupServer.can_be_picked_up = function (self, picker_unit)
	return not self._carried
end

GrailPickupServer.pickup = function (self, carrier_unit)
	self._carried = true
...
GrailPickupServer.can_be_dropped = function (self, carrier_unit)
	return self._carried and self._carrier_unit == carrier_unit
end

GrailPickupServer.drop = function (self)
	self._carried = false
...
GrailPickupServer.destroy = function (self)
	return
end
