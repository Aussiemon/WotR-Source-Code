...
GrailPickupClient.init = function (self, world, unit)
	self._world = world
	self._unit = unit
	self._id = nil
	self._carried = false
...
GrailPickupClient.set_game_object_id = function (self, obj_id, game)
	self._id = obj_id
...
GrailPickupClient.update = function (self, unit, input, dt, context)
...
GrailPickupClient.can_be_picked_up = function (self, picker_unit)
	return not self._carried
end

GrailPickupClient.pickup = function (self, carrier_unit)
	self._carried = true
...
GrailPickupClient.can_be_dropped = function (self, dropper_unit)
	return self._carried and self._carrier_unit == dropper_unit
end

GrailPickupClient.drop = function (self)
	self._carried = false
	self._carrier_unit = nil
...
GrailPickupClient.destroy = function (self)
