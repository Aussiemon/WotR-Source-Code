...
AINavigation.init = function (self, world, unit, steering)
...
AINavigation.follow_spline = function (self, spline_name, callback)
...
AINavigation.patrol_spline = function (self, spline_name)
	local spline = Level.spline(self._level, spline_name)
...
AINavigation.move_to_unit = function (self, unit, callback)
	self._command_callback = callback
...
AINavigation.move_to = function (self, target_pos)
...
AINavigation.follow_path = function (self, path)
...
AINavigation._follow_arrived = function (self, unit)
...
AINavigation.patrol_path = function (self, path)
	local position = path:current()
...
AINavigation._patrol_arrived = function (self, unit)
	if self._path:is_last() then
		self._path:reverse()
		self._path:reset()
	else
