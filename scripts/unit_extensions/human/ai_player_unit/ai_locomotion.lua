...
AILocomotion.init = function (self, world, unit, profile, player)
...
AILocomotion.finalize = function (self, profile)
	self._states.onground:finalize(profile)
end

AILocomotion._create_game_object = function (self, unit)
...
AILocomotion.cb_game_session_disconnect = function (self)
	self.id = nil
	self.game = nil
end

AILocomotion._create_states = function (self)
...
AILocomotion._init_public_variables = function (self, unit)
...
AILocomotion._init_inventory = function (self, profile)
...
AILocomotion._setup_inventory = function (self, player_profile)
	local player = self.player
	local tint_color = {
		1,
		0,
...
AILocomotion.update = function (self, t, dt, context, force)
...
AILocomotion._update_culling = function (self, dt, t)
...
AILocomotion._update_bone_lod = function (self, dt, unit, distance)
...
AILocomotion.update_locomotion = function (self, t, dt)
...
AILocomotion._calculate_wanted_velocity = function (self, t, dt)
...
AILocomotion._update_look = function (self, t, dt, wanted_vel)
...
AILocomotion._update_animation = function (self, t, dt, wanted_vel)
	local wanted_speed = Vector3.length(wanted_vel)
...
AILocomotion._change_movement_type = function (self, move_type)
...
AILocomotion._calculate_anim_speed_from_mps = function (self, wanted_speed)
...
AILocomotion._update_rotation = function (self, t, dt, wanted_vel)
...
AILocomotion._update_movement = function (self, t, dt, wanted_vel)
...
AILocomotion.set_pose = function (self, pose)
...
AILocomotion.set_look_target = function (self, pos)
	self._override_look_target = true

	self._wanted_look_target:store(pos)
end

AILocomotion.look_target = function (self)
	return self._look_target:unbox()
end

AILocomotion.player = function (self)
	return self._player
end

AILocomotion.set_velocity = function (self, velocity)
	self._velocity:store(velocity)
end

AILocomotion.get_velocity = function (self)
	return self._velocity:unbox()
end

AILocomotion.set_pose_blends = function (self, pose_x, pose_y)
...
AILocomotion.get_pose_blends = function (self)
	return Unit.animation_get_variable(self.unit, self._pose_x_var), Unit.animation_get_variable(self.unit, self._pose_y_var)
end

AILocomotion.inventory = function (self)
	return self._inventory
end

AILocomotion.aim_direction = function (self)
	return self._aim_direction:unbox()
end

AILocomotion.player_dead = function (self)
	self:_change_state("dead")
end

AILocomotion.has_perk = function (self, perk_name)
	return false
end

AILocomotion.mount = function (self, mount_unit)
	self.mounted_unit = mount_unit

	self:_change_state("mounted")
end

AILocomotion.unmount = function (self, mount_unit)
	if self.current_state_name == "mounted" and self.mounted_unit == mount_unit then
		self:_change_state("onground")
	end
end

AILocomotion.mounted = function (self)
	return self.current_state_name == "mounted"
end

AILocomotion.destroy = function (self)
	self._inventory:destroy()
end

AILocomotion.destroy_game_objects = function (self)
...
AILocomotion.wield_weapon = function (self, slot_name)
...
AILocomotion.begin_melee_attack = function (self, swing_dir, charge_time)
	self.current_state:melee_attack(swing_dir, charge_time)
end

AILocomotion.begin_ranged_attack = function (self, draw_time)
	self.current_state:ranged_attack(draw_time)
end

AILocomotion.block_attack = function (self, direction, attacking_units_locomotion)
	self.current_state:block_attack(direction, attacking_units_locomotion)
end

AILocomotion.hot_join_synch = function (self, sender, player)
...
AILocomotion.damage_interrupt = function (self, hit_zone, impact_direction, impact_type)
...
AILocomotion.hurt_sound_event = function (self)
