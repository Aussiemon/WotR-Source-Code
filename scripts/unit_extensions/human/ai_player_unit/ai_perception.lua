...
AIPerception.init = function (self, world, unit, blackboard, config)
...
AIPerception.set_config = function (self, params)
...
AIPerception.update = function (self, t, dt)
...
AIPerception._scan = function (self)
...
AIPerception.cb_overlap_result = function (self, actors)
...
AIPerception.cb_raycast_result = function (self, player_unit, hit)
