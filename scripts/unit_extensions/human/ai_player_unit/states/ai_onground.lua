...
AIOnground.init = function (self, unit, internal)
	AIOnground.super.init(self, unit, internal)

	self._level = LevelHelper:current_level(self._internal.world)
end

AIOnground.finalize = function (self, profile)
	self._ai_props = profile.properties
end

AIOnground.enter = function (self)
	return
end

AIOnground.melee_attack = function (self, swing_direction, charge_time)
...
AIOnground.swing_finished = function (self)
	AIOnground.super.swing_finished(self)

	self._internal.melee_attack = false
end

AIOnground.ranged_attack = function (self, draw_time)
	self._draw_time = draw_time
	self._internal.ranged_attack = true
end

AIOnground.wield_weapon = function (self, slot_name)
	self._slot_name = slot_name
	self._internal.wield_new_weapon = true
end

AIOnground.block_attack = function (self, direction, attacking_units_locomotion)
...
AIOnground.crouch = function (self)
	self._internal.start_or_stop_crouch = true
end

AIOnground.update = function (self, dt, t)
	local internal = self._internal
...
AIOnground._update_weapons = function (self, t, dt)
	local internal = self._internal
...
AIOnground._update_tether = function (self, t, dt)
...
AIOnground._update_crouch = function (self, t, dt)
	local internal = self._internal
...
AIOnground._update_swing = function (self, t, dt)
...
AIOnground._update_pose_attempt = function (self, dt)
	local internal = self._internal
...
AIOnground._update_charge = function (self, dt, t)
	if t >= self._charge_time_end then
		self._charge_done = true
	end
end

AIOnground._update_ranged_weapons = function (self, t, dt)
	local internal = self._internal
	local inventory = internal:inventory()
...
AIOnground.can_reload = function (self, slot_name, aim_input)
	local internal = self._internal
	local inventory = internal:inventory()
...
AIOnground._update_weapon_wield = function (self, t, dt)
...
AIOnground._update_block = function (self, t, dt)
...
AIOnground.can_raise_block = function (self, t, dt)
...
AIOnground._crouch = function (self)
	self:anim_event("to_crouch")

	self._internal.crouching = true
end

AIOnground._abort_pose = function (self)
	AIOnground.super._abort_pose(self)

	self._internal.melee_attack = false
end

AIOnground.post_update = function (self, dt, t)
	return
end
