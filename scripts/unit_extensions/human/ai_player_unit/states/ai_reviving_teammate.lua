...
AIRevivingTeammate.enter = function (self, old_state, target_unit, t)
...
AIRevivingTeammate._exit_on_fail = function (self)
...
AIRevivingTeammate.update = function (self, dt, t)
