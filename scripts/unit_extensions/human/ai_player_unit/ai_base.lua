...
AIBase.init = function (self, world, unit, player_index, profile, spawner)
	self._world = world
	self._unit = unit
	self._blackboard = {
		world = world,
...
AIBase.set_properties = function (self, params)
...
AIBase._parse_properties = function (self)
...
AIBase._init_player_profile = function (self)
...
AIBase._init_locomotion = function (self)
...
AIBase._init_brain = function (self)
...
AIBase._init_perception = function (self)
...
AIBase._finalize = function (self)
	self._locomotion:finalize(self._profile)
end

AIBase.locomotion = function (self)
	return self._locomotion
end

AIBase.steering = function (self)
	return self._steering
end

AIBase.navigation = function (self)
	return self._navigation
end

AIBase.brain = function (self)
	return self._brain
end

AIBase.perception = function (self)
	return self._perception
end

AIBase.profile = function (self)
	return self._profile
end

AIBase.blackboard = function (self)
	return self._blackboard
end

AIBase.update = function (self, unit, input, dt, context, t)
...
AIBase.player_dead = function (self)
	self._locomotion:player_dead()
end

AIBase.alerted = function (self)
	Unit.flow_event(self._spawner, "lua_on_alerted")
end

AIBase.destroy = function (self)
