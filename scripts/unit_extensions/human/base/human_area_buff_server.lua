...
HumanAreaBuffServer.init = function (self, world, unit)
	self._world = world
	self._unit = unit
...
HumanAreaBuffServer._create_game_object = function (self)
	local data_table = {
...
HumanAreaBuffServer.update = function (self, dt, t)
	return
end

HumanAreaBuffServer.cb_game_session_disconnect = function (self)
	self._id = nil
	self._game = nil
end

HumanAreaBuffServer.buff_multiplier = function (self, buff_type)
	if self._game then
...
HumanAreaBuffServer.buff_level = function (self, buff_type)
	if self._game then
...
HumanAreaBuffServer.end_time = function (self, buff_type)
	if self._game then
...
HumanAreaBuffServer.set_buff_level = function (self, buff_type, value)
...
HumanAreaBuffServer.set_end_time = function (self, buff_type, value)
...
HumanAreaBuffServer.remove_game_object_id = function (self)
	self._id = nil
	self._game = nil
end

HumanAreaBuffServer.destroy = function (self)
