...
HumanMounted.can_unmount = function (self, t)
...
HumanMounted._can_activate_officer_buff = function (self, buff_index, t)
	local internal = self._internal
...
HumanMounted.can_wield_weapon = function (self, slot_name, t)
	local internal = self._internal
...
HumanMounted.can_toggle_weapon = function (self, slot_name, t)
	local internal = self._internal
...
HumanMounted.can_attempt_pose_melee_weapon = function (self, t)
	local internal = self._internal
	local inventory = internal:inventory()
...
HumanMounted.can_pose_melee_weapon = function (self)
	local internal = self._internal
	local inventory = internal:inventory()
	local slot_name = inventory:wielded_melee_weapon_slot()
...
HumanMounted.can_swing_melee_weapon = function (self, t)
	local internal = self._internal
	local inventory = internal:inventory()
...
HumanMounted.can_abort_melee_swing = function (self)
	local internal = self._internal
	local inventory = internal:inventory()
...
HumanMounted.can_aim_ranged_weapon = function (self)
	do return false end
...
HumanMounted.can_unaim_ranged_weapon = function (self)
	local internal = self._internal
	local inventory = internal:inventory()
...
HumanMounted.can_reload = function (self, slot_name, aim_input)
	local internal = self._internal
	local inventory = internal:inventory()
	local gear = inventory:_gear(slot_name)
	local extensions = gear:extensions()
...
HumanMounted.can_fire_ranged_weapon = function (self)
	local internal = self._internal
	local inventory = internal:inventory()
	local slot_name = internal.aim_slot_name
...
HumanMounted.can_raise_block = function (self, t)
	local internal = self._internal
	local inventory = internal:inventory()
...
HumanMounted.can_lower_block = function (self)
	local internal = self._internal
	local inventory = internal:inventory()
...
HumanMounted.can_couch = function (self, t)
	local internal = self._internal
	local inventory = internal:inventory()
