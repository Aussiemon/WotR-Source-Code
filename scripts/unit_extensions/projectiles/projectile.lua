...
Projectile.init = function (self, world, unit, owning_player_index, user_unit, weapon_unit, is_husk, game, projectile_name, firing_gear_name, exit_velocity, gravity_multiplier, damage_multiplier, properties_id)
	self._world = world
	self._unit = unit
...
Projectile._spawn_arrow_trail = function (self, params)
...
Projectile._translate_properties_id = function (self, properties_id)
	local properties = {}
	local i = 1
...
Projectile.user_unit = function (self)
	return self._user_unit
end

Projectile.set_active = function (self, active)
	self._active = active
end

Projectile._init_raycast = function (self)
...
Projectile.update = function (self, unit, input, dt, context)
...
Projectile._update_movement = function (self, unit, t, dt)
...
Projectile._position = function (self, t)
...
Projectile._raycast_result = function (self, position, distance, normal, actor)
...
Projectile._calculate_damage = function (self, victim_unit, position, actor, normal, impact_direction)
...
Projectile._apply_damage = function (self, victim_unit, position, normal, actor, damage_type, damage, damage_range_type, hit_zone, impact_direction)
...
Projectile._hit = function (self, hit_unit, position, actor, damage, penetrated, target_type, hit_zone, impact_direction, normal)
	local unit = self._unit
...
Projectile.link_projectile = function (self, hit_unit, actor_node, local_pos, local_rot, damage, penetrated, target_type, hit_zone, impact_direction, normal)
	local unit = self._unit
...
Projectile._stun = function (self, own_player, hit_unit)
...
Projectile.drop_projectile = function (self, hit_unit, position, rotation, damage, penetrated, target_type, hit_zone, impact_direction, normal)
	local unit = self._unit
