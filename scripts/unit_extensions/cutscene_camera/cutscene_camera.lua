...
CutsceneCamera.init = function (self, world, unit)
...
CutsceneCamera.finalize = function (self, cameras)
...
CutsceneCamera.update = function (self, dt, t)
...
CutsceneCamera._update_transition = function (self, progress, camera)
...
CutsceneCamera.next_camera = function (self)
	return self._next_camera
end

CutsceneCamera.activate = function (self)
...
CutsceneCamera.deactivate = function (self)
	return
end

CutsceneCamera.name = function (self)
	return self._name
end
