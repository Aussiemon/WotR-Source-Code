...
WeaponOneHanded.init = function (self, world, unit, user_unit, player, id, ai_gear, attachments, properties, attachment_multipliers)
	self._world = world
	self._unit = unit
...
WeaponOneHanded.category = function (self)
	return self._weapon_category
end

WeaponOneHanded.set_wielded = function (self, wielded)
	if not wielded and self._attacking then
		self:end_attack()
	end
end

WeaponOneHanded._enable_hit_collision = function (self)
	for _, actor in ipairs(self._collision_actors) do
		Actor.set_collision_enabled(actor, true)
	end
end

WeaponOneHanded._disable_hit_collision = function (self)
	for _, actor in ipairs(self._collision_actors) do
		Actor.set_collision_enabled(actor, false)
	end
end

WeaponOneHanded.update = function (self, dt, t)
...
WeaponOneHanded.can_wield = function (self)
	return true
end

WeaponOneHanded.wield_finished_anim_name = function (self)
	return nil
end

WeaponOneHanded.start_attack = function (self, charge_time, swing_direction, quick_swing, abort_attack_func, attack_duration)
...
WeaponOneHanded.end_attack = function (self)
...
WeaponOneHanded._activate_sweep_collision = function (self)
...
WeaponOneHanded._calculate_sweep_extents = function (self, sweep_settings)
	local unit = self._unit
...
WeaponOneHanded.debug_draw_sweep_area = function (self)
...
WeaponOneHanded._update_sweep_collision = function (self, dt, sweep_settings, current_attack)
...
WeaponOneHanded._deactivate_sweep_collision = function (self)
	self._sweep_collision = false
end

WeaponOneHanded._abort_attack = function (self, reason)
...
WeaponOneHanded.non_damage_hit_cb = function (self, hit_unit, actor, normal, position, self_actor, couching, interpolated_attack_time)
...
WeaponOneHanded.hit_cb = function (self, hit_unit, actor, normal, position, self_actor, couching, interpolated_attack_time)
	if not hit_unit or not Unit.alive(hit_unit) or not self._attacking and not couching then
		return
	end
...
WeaponOneHanded.push_hit_cb = function (self, hit_unit, actor, normal, position, self_actor, couching)
...
WeaponOneHanded._check_parry = function (self, attacker_unit, victim_unit, not_previously_hit)
...
WeaponOneHanded._check_blocking = function (self, attacker_unit, victim_unit)
	local victim_locomotion = ScriptUnit.extension(victim_unit, "locomotion_system")
...
WeaponOneHanded._target_type = function (self, hit_unit, current_attack)
	local target_type
	local abort = false
...
WeaponOneHanded._hit_character = function (self, hit_unit, position, normal, actor, hit_zone, impact_direction, interpolated_attack_time)
	local current_attack = self._current_attack
	local attack_name = current_attack.attack_name
...
WeaponOneHanded._fully_charged_attack = function (self, current_attack)
	local attack_name = current_attack.attack_name
...
WeaponOneHanded._push_hit_character = function (self, hit_unit, position, normal, actor, hit_zone, impact_direction)
	local current_attack = self._current_attack
	local network_manager = Managers.state.network
	local game = network_manager:game()
	local world = self._world
...
WeaponOneHanded._hit_parrying_gear = function (self, gear_owner, hit_gear, position, normal, actor, impact_direction, interpolated_attack_time, no_damage)
...
WeaponOneHanded._hit_blocking_gear = function (self, gear_owner, hit_gear, position, normal, actor, impact_direction, interpolated_attack_time, no_damage)
...
WeaponOneHanded._hit_damagable_prop = function (self, hit_unit, position, normal, actor, impact_direction, interpolated_attack_time)
	local target_type
	local current_attack = self._current_attack
	local attack_name = current_attack.attack_name
...
WeaponOneHanded._hit_non_damagable_prop = function (self, hit_unit, position, normal, actor, impact_direction, interpolated_attack_time)
...
WeaponOneHanded._add_damage = function (self, victim_unit, position, normal, actor, hit_zone, apply_damage, current_attack, impact_direction, damage_multiplier, interpolated_attack_time)
...
WeaponOneHanded._damage_type = function (self, attack)
	return attack.damage_type
end

WeaponOneHanded._valid_hamstring_attack = function (self, unit, impact_direction, hit_zone, current_attack)
	local locomotion = ScriptUnit.extension(self._user_unit, "locomotion_system")
	local unit_rot = Unit.world_rotation(unit, 0)
...
WeaponOneHanded._debug_draw_weapon_velocity = function (self)
	local unit = self._unit
	local current_attack = self._current_attack
	local attack_name = current_attack.attack_name
...
WeaponOneHanded.hot_join_synch = function (self, sender, player, player_object_id, slot_name)
	return
end

WeaponOneHanded.enter_ghost_mode = function (self)
	return
end

WeaponOneHanded.exit_ghost_mode = function (self)
	self:_disable_hit_collision()
end

WeaponOneHanded.parry = function (self, direction, block_time, max_delay)
...
WeaponOneHanded.stop_parry = function (self)
	if not self._ai_gear then
		local locomotion = ScriptUnit.extension(self._user_unit, "locomotion_system")
...
WeaponOneHanded.pose = function (self, t, pose_direction)
	if not self._ai_gear then
		local locomotion = ScriptUnit.extension(self._user_unit, "locomotion_system")
...
WeaponOneHanded._reset_blackboard = function (self, blackboard)
	blackboard.pose_factor = 0
end

WeaponOneHanded.update_pose = function (self, dt, t)
...
WeaponOneHanded.stop_pose = function (self)
	local locomotion = ScriptUnit.extension(self._user_unit, "locomotion_system")
...
WeaponOneHanded.destroy = function (self)
	return
end
