...
WeaponHandgonne.init = function (self, world, unit, user_unit, player, id, ai_gear, attachments, properties, attachment_multipliers)
...
WeaponHandgonne.destroy = function (self)
	self._fire_raycast_from_camera = nil
	self._fire_raycast_from_muzzle = nil
end

WeaponHandgonne._init_raycast = function (self)
...
WeaponHandgonne.start_release_projectile = function (self, slot_name, draw_time, callback, t)
...
WeaponHandgonne.release_projectile = function (self, slot_name, draw_time)
...
WeaponHandgonne.update_fire = function (self, dt, t)
...
WeaponHandgonne.fire = function (self, raycast_position, raycast_direction)
...
WeaponHandgonne._fire_raycast_result_one = function (self, hit, position, distance, normal, actor)
	if hit then
...
WeaponHandgonne._fire_raycast_result_two = function (self, hit, position, distance, normal, actor, direction)
	if hit then
...
WeaponHandgonne._hit = function (self, position, normal, actor, victim_unit, distance)
...
WeaponHandgonne._hit_character = function (self, victim_unit, position, damage, stun, hit_zone, impact_direction)
...
WeaponHandgonne._spawn_fuse_dummy = function (self)
...
WeaponHandgonne.hide_fuse_dummy = function (self)
	Unit.set_unit_visibility(self._fuse_dummy_unit, false)
end

WeaponHandgonne.show_fuse_dummy = function (self)
	Unit.set_unit_visibility(self._fuse_dummy_unit, true)
end

WeaponHandgonne._play_fire_sound = function (self)
...
WeaponHandgonne.update = function (self, dt, t)
...
WeaponHandgonne.update_reload = function (self, dt, t, fire_input)
...
WeaponHandgonne.finish_reload = function (self, reload_successful)
...
WeaponHandgonne.can_wield = function (self)
	return not self._reloading
end

WeaponHandgonne.start_reload = function (self, reload_time, reload_blackboard)
