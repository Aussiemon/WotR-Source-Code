...
WeaponCrossbow.init = function (self, world, unit, user_unit, player, id, ai_gear, attachments, properties, attachment_multipliers)
...
WeaponCrossbow.ready_projectile = function (self, slot_name)
...
WeaponCrossbow.release_projectile = function (self, slot_name, draw_time)
...
WeaponCrossbow.fire = function (self, projectile_position, projectile_velocity, forward_direction)
	local projectile_name = self._projectile_name
...
WeaponCrossbow._play_fire_sound = function (self)
...
WeaponCrossbow.update = function (self, dt, t)
...
WeaponCrossbow.can_aim = function (self)
	return not self._raising_crossbow
end

WeaponCrossbow.can_steady = function (self)
	return true
end

WeaponCrossbow.update_reload = function (self, dt, t, fire_input)
...
WeaponCrossbow._random_angle = function (self)
	return (self._reload_blackboard.grab_area_rot_angle - (math.pi + (math.random() - 0.5) * (math.pi / 2))) % (2 * math.pi)
end

WeaponCrossbow._update_hook_rotation = function (self, dt, t, grab_area_start_rot)
	local reload_blackboard = self._reload_blackboard
...
WeaponCrossbow._hit_grab_area = function (self, settings, hit_section_size)
	local reload_blackboard = self._reload_blackboard
...
WeaponCrossbow.finish_reload = function (self, reload_successful, slot_name)
	self._reload_timer = 0
	self._modification_timer = 0
	self._hook_state = "normal"
	self._hook_speed_multiplier = 1
...
WeaponCrossbow.set_wielded = function (self, wielded)
...
WeaponCrossbow._has_safety = function (self, misc_attachments)
