...
WeaponHandgonneBase.init = function (self, world, unit, user_unit, player, id)
...
WeaponHandgonneBase.release_projectile = function (self, slot_name, draw_time)
...
WeaponHandgonneBase._play_fire_sound = function (self)
...
WeaponHandgonneBase.unaim = function (self)
