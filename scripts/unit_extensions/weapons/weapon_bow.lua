...
WeaponBow.init = function (self, world, unit, user_unit, player, id, ai_gear, attachments, properties, attachment_multipliers)
...
WeaponBow.ready_projectile = function (self, slot_name)
...
WeaponBow.start_release_projectile = function (self, slot_name, draw_time, callback, t)
...
WeaponBow.release_projectile = function (self, slot_name, draw_time, draw_time_loss)
...
WeaponBow.fire = function (self, projectile_position, projectile_velocity, forward_direction, damage_multiplier)
	local projectile_name = self._projectile_name
...
WeaponBow._play_fire_sound = function (self)
...
WeaponBow.update = function (self, dt, t)
...
WeaponBow.can_aim = function (self)
	return not self._stop_aim_timer
end

WeaponBow.unaim = function (self)
	self._aim_blackboard = nil
...
WeaponBow._reset_blackboard = function (self, blackboard)
...
WeaponBow.update_aim = function (self, dt, t)
...
WeaponBow._bow_shake_speed = function (self, t, hit_section_halved, bow_shake_time)
...
WeaponBow._force_lower_aim = function (self, t)
	local timpani_world = World.timpani_world(self._world)
...
WeaponBow.set_wielded = function (self, wielded)
...
WeaponBow.fire_anim_name = function (self)
