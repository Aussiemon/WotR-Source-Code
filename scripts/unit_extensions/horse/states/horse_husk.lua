...
HorseHusk.init = function (self, unit, internal)
...
HorseHusk.enter = function (self, old_state)
	HorseHusk.super.enter(self, old_state)

	self._internal.cruise_control = false
end

HorseHusk.update = function (self, unit, internal, controller, dt, context)
...
HorseHusk._update_culling = function (self, dt)
...
HorseHusk._update_physics_culling = function (self, dt, unit, distance)
...
HorseHusk.destroy = function (self)
	return
end
