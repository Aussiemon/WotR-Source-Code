...
HorseLanding.update = function (self, unit, internal, controller, dt, context, t)
...
HorseLanding.enter = function (self, old_state)
	HorseLanding.super.enter(self, old_state)
	self:anim_event("horse_landing")
end

HorseLanding.exit = function (self, new_state)
...
HorseLanding.update_transition = function (self, dt)
...
HorseLanding.cb_evaluate_inair_transition = function (self, actor_list)
...
HorseLanding.anim_cb_landing_to_onground = function (self)
	self._transition = "onground"
end

HorseLanding.update_movement = function (self, dt)
