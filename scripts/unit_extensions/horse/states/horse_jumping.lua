...
HorseJumping.update = function (self, unit, internal, controller, dt, context, t)
...
HorseJumping.update_transition = function (self)
...
HorseJumping.fall_height = function (self)
	return self._fall_height
end

HorseJumping.update_transition = function (self, dt, world)
	local unit = self._unit
	local mover = Unit.mover(unit)
...
HorseJumping.enter = function (self, old_state)
...
HorseJumping.exit = function (self, new_state)
	HorseJumping.super.exit(self, new_state)
end

HorseJumping.anim_cb_jump_top = function (self)
	self._movement_type = "falling"
end

HorseJumping.anim_cb_to_inair = function (self)
	self:change_state("inair")
end

HorseJumping.update_animation = function (self, dt)
	return
end

HorseJumping.update_rotation = function (self, dt)
	local internal = self._internal
...
HorseJumping.update_movement = function (self, dt)
