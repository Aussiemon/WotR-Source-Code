...
HorseOnground.cap_speed = function (self, speed)
	self._behaviour_speed_cap = speed
end

HorseOnground._update_stamina = function (self, dt, t)
	local internal = self._internal
...
HorseOnground._update_speed_cap = function (self, dt, t)
	self._speed_cap = math.min(self._behaviour_speed_cap, self._fatigue_speed_cap, self._area_speed_cap)
end

HorseOnground.ground_raycast = function (self, unit, internal)
...
HorseOnground.ground_raycast_cb = function (self, internal, pos_x, pos_y, pos_z, any_hit, position, distance, normal, actor)
...
HorseOnground.enter = function (self, old_state)
...
HorseOnground.exit = function (self, new_state)
...
HorseOnground.update_transition = function (self, dt, t)
...
HorseOnground.cb_evaluate_inair_transition = function (self, actor_list)
	local internal = self._internal
...
HorseOnground.check_jump = function (self, dt, t)
...
HorseOnground.check_brake = function (self, dt, t)
...
HorseOnground.can_brake = function (self, dt)
	local internal = self._internal
...
HorseOnground.update_movement_speed = function (self, dt)
...
HorseOnground.begin_charge = function (self, t)
	local internal = self._internal
...
HorseOnground.end_charge = function (self, t)
	local internal = self._internal
...
HorseOnground.update_charge = function (self, dt, t)
	local internal = self._internal
...
HorseOnground._update_gait_anim_rotation_state = function (self)
	local internal = self._internal
	local gait = HorseUnitMovementSettings.gaits[HorseUnitMovementSettings.gait_order[internal.gait_index]]
...
HorseOnground._enter_cruise_control = function (self)
...
HorseOnground._update_cruise_control = function (self, dt, t)
	local internal = self._internal
...
HorseOnground._speed_multiplier = function (self)
	local rider = Unit.get_data(self._unit, "user_unit")
...
HorseOnground._gait_speed_max = function (self, gait)
...
HorseOnground.update_gait = function (self, dt, t)
	local internal = self._internal
	local move = self._controller and self._controller:get("mount_move") or Vector3(0, 0, 0)
...
HorseOnground._play_gait_animation = function (self, gait, internal)
...
HorseOnground.change_gait = function (self, change)
	local internal = self._internal
	local current_gait = HorseUnitMovementSettings.gaits[HorseUnitMovementSettings.gait_order[internal.gait_index]]
...
HorseOnground._match_gait = function (self)
...
HorseOnground.update_movement = function (self, dt)
	local internal = self._internal
	local unit = self._unit
...
HorseOnground._calculate_charge_strafe = function (self, unit, dt)
...
HorseOnground.update_rotation = function (self, dt)
	local internal = self._internal
	local unit = self._unit
...
HorseOnground.anim_event = function (self, event, ...)
	HorseOnground.super.anim_event(self, event, ...)
end

HorseOnground._update_yaw = function (self, internal, unit, move, dt)
...
HorseOnground.stop = function (self)
	self._stop = true
...
HorseOnground.go = function (self)
	self._stop = false
end

HorseOnground.set_deflect = function (self, flag)
	self._deflect = flag
end

HorseOnground.set_align_direction = function (self, direction)
