...
HorseBrake.init = function (self, unit, locomotion)
	HorseBrake.super.init(self, unit, locomotion)
end

HorseBrake.update = function (self, unit, internal, controller, dt, context, t)
...
HorseBrake.ground_raycast = function (self, unit, internal)
...
HorseBrake.ground_raycast_cb = function (self, internal, pos_x, pos_y, pos_z, any_hit, position, distance, normal, actor)
	if any_hit then
...
HorseBrake.enter = function (self, old_state)
...
HorseBrake.exit = function (self, new_state)
...
HorseBrake.update_transition = function (self, dt)
...
HorseBrake.cb_evaluate_inair_transition = function (self, actor_list)
	local internal = self._internal
...
HorseBrake._update_brake_speed = function (self, dt, t)
...
HorseBrake.update_movement = function (self, dt, t)
	local internal = self._internal
...
HorseBrake.update_rotation = function (self, dt, t)
	local internal = self._internal
...
HorseBrake._update_yaw = function (self, internal, unit, move, dt, t)
	local brake_settings = HorseUnitMovementSettings.hand_brake
