...
HorseDamage.init = function (self, world, unit, input)
	self._world = world
	self._unit = unit
	self._damage = 0
	self._dead = false
...
HorseDamage._setup_hit_zones = function (self, hit_zones)
	local actor_table = {}
...
HorseDamage.network_recieve_add_damage_over_time = function (self, ...)
	self:add_damage_over_time(...)
end

HorseDamage.add_damage_over_time = function (self, ...)
	return
end

HorseDamage.network_recieve_add_damage = function (self, attacker_player, attacker_unit, damage_type, damage, position, normal, damage_range_type, gear_name, hit_zone, impact_direction, real_damage, range, mirrored)
...
HorseDamage.add_damage = function (self, attacker_player, attacker_unit, damage_type, damage, position, normal, actor, damage_range_type, gear_name, hit_zone, impact_direction, real_damage, range, mirrored)
...
HorseDamage.die = function (self, attacker_player, damage_type, damage, position, normal, actor, impact_direction)
	self._dead = true
...
HorseDamage.rpc_set_dead = function (self)
	self._dead = true
end

HorseDamage.is_dead = function (self)
	return self._dead
end

HorseDamage.is_alive = function (self)
	return not self._dead
end

HorseDamage.destroy = function (self)
