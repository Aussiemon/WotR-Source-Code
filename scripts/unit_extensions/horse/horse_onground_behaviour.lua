...
HorseOngroundBehaviour.init = function (self, locomotion)
...
HorseOngroundBehaviour.destroy = function (self)
	self._raycast = nil
end

HorseOngroundBehaviour._setup_raycast = function (self)
...
HorseOngroundBehaviour.on_raycast_result = function (self, hit, pos, distance, normal, actor)
...
HorseOngroundBehaviour.update = function (self, t, dt)
