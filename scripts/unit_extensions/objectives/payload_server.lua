...
PayloadServer.init = function (self, world, unit)
	self._world = world
	self._unit = unit
...
PayloadServer.event_start_round = function (self, params)
	self:_init_teams()
end

PayloadServer.flow_cb_set_spline_limit = function (self, limit_type, spline, acceleration)
...
PayloadServer.event_round_started = function (self, params)
	if Managers.state.network:game() then
		self:_create_game_object()
	end
end

PayloadServer.flow_cb_add_player_unit = function (self, unit)
	self._units_in_proximity[unit] = true
end

PayloadServer.flow_cb_remove_player_unit = function (self, unit)
	self._units_in_proximity[unit] = nil
end

PayloadServer.flow_cb_set_owner = function (self, team)
	self:set_owner(team)
end

PayloadServer.set_owner = function (self, team)
...
PayloadServer.flow_cb_set_active = function (self, team, active)
	self:_set_active(team, active)
end

PayloadServer._set_active = function (self, team, active)
...
PayloadServer.active = function (self, side)
	return self._active[side]
end

PayloadServer.owned = function (self, side)
	return self._owner == side
end

PayloadServer._init_teams = function (self)
...
PayloadServer.flow_cb_set_auto_move = function (self, set)
	self._auto_moving = set
end

PayloadServer.update = function (self, unit, input, dt, context, t)
...
PayloadServer._update_player_collision = function (self, t, dt)
...
PayloadServer._update_buff = function (self, t, dt)
...
PayloadServer.cb_calculate_eligble_buff_targets = function (self)
	return self:friendly_units()
end

PayloadServer.friendly_units = function (self)
	local new_table = {}
...
PayloadServer.is_contributing = function (self, player)
...
PayloadServer._create_area_buff = function (self, duration, eligible_targets_function)
	local unit = self._unit
...
PayloadServer._update_units_in_proximity = function (self, dt, t)
...
PayloadServer._update_movement = function (self, dt, t, has_friendlies_in_proximity, has_hostiles_in_proximity)
...
PayloadServer._set_spline_index = function (self, new_spline_index)
...
PayloadServer._throw_flow_events = function (self, dt, t, current_spline_index)
...
PayloadServer._update_spline_game_object_fields = function (self, dt, t, index, subdivision, spline_t)
	local game = Managers.state.network:game()
	local id = self._id
...
PayloadServer._end_reached = function (self)
	local unit = self._unit
...
PayloadServer._set_speed = function (self, target_speed, acceleration, dt)
...
PayloadServer._set_position = function (self, pos)
...
PayloadServer._set_rotation = function (self, rot)
...
PayloadServer.destroy = function (self)
	return
end

PayloadServer._create_game_object = function (self)
	local unit = self._unit
	local movement = self._spline_curve:movement()
	local data_table = {
...
PayloadServer.set_game_object_id = function (self, id)
	self._id = id
end

PayloadServer.cb_game_session_disconnect = function (self)
	self._game = nil
end
