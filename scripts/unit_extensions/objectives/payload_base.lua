...
PayloadBase._init_movement_spline = function (self, world, unit)
...
PayloadBase.objective = function (self, side)
...
PayloadBase._parse_next_config = function (self, configs, last_string_index)
...
PayloadBase.level_index = function (self)
	return GameSession.game_object_field(self._game, self._id, "level_unit_index")
end

PayloadBase._parse_next_index = function (self, indices, last_string_index)
...
PayloadBase._parse_settings = function (self, splines, spline_interval_indices, spline_interval_configs)
