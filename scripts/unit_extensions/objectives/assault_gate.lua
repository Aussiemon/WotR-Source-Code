...
AssaultGate.init = function (self, world, unit, input)
...
AssaultGate.event_start_round = function (self)
...
AssaultGate.update = function (self, unit, input, dt, context, t)
	GenericUnitInteractable.update(self, unit, input, dt, context, t)
end

AssaultGate._create_game_object = function (self)
	local data_table = {
...
AssaultGate.enable_destructible = function (self, enable)
	self._blackboard.destructible_enabled = enable
end

AssaultGate._server_update = function (self, t, dt)
...
AssaultGate._client_update = function (self, t, dt)
...
AssaultGate.interaction_complete = function (self, player)
...
AssaultGate.flow_cb_add_player_unit = function (self, player_unit)
...
AssaultGate.flow_cb_remove_player_unit = function (self, player_unit)
	self._nearby_defenders[player_unit] = nil
end

AssaultGate.can_interact = function (self, player)
	return (not self._interaction_timer or self._interaction_timer < Managers.time:time("game")) and not self._perma_open
end

AssaultGate.interact_gate = function (self)
...
AssaultGate.open_gate = function (self, interaction_timer)
...
AssaultGate.close_gate = function (self, interaction_timer)
	if Managers.lobby.server then
		self._state = "closed"
...
AssaultGate.perma_open_gate = function (self)
	self._perma_open = true

	self:open_gate(GATE_DELAY)
end

AssaultGate.crush_player_unit = function (self, player_unit)
...
AssaultGate.hot_join_synch = function (self, sender)
...
AssaultGate.rpc_synch_assault_gate = function (self, gate_state)
...
AssaultGate.destructible_objective_activated = function (self, team_side, active)
...
AssaultGate.is_dead = function (self)
...
AssaultGate._objective_activated = function (self, team_side, active)
	local no_active_before = true
	local no_active_after = true
...
AssaultGate.destructible_active = function (self, team_side)
	if Managers.lobby.server then
