...
ObjectiveUnitInteractable.init = function (self, world, unit, input)
...
ObjectiveUnitInteractable.flow_cb_set_owner = function (self, side)
...
ObjectiveUnitInteractable._set_owner = function (self, owner)
	self._owner = owner
...
ObjectiveUnitInteractable._client_update = function (self, t, dt)
...
ObjectiveUnitInteractable.interaction_complete = function (self, player)
...
ObjectiveUnitInteractable.cb_capture_assists = function (self, capturing_player, capture_unit, actors)
...
ObjectiveUnitInteractable.flow_cb_activate_interactable = function (self, team_side)
	self:_objective_activated(team_side, true)
	ObjectiveUnitInteractable.super.flow_cb_activate_interactable(self, team_side)
end

ObjectiveUnitInteractable.flow_cb_deactivate_interactable = function (self, team_side)
	self:_objective_activated(team_side, false)
	ObjectiveUnitInteractable.super.flow_cb_deactivate_interactable(self, team_side)
end

ObjectiveUnitInteractable.owned = function (self, side)
	return self._owner == side
end

ObjectiveUnitInteractable._on_client_active_changed = function (self, team_side, active)
	self:_objective_activated(team_side, active)
end

ObjectiveUnitInteractable._objective_activated = function (self, team_side, active)
	if self._dead then
		return
	end
