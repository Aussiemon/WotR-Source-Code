...
AssaultLadder.init = function (self, world, unit, input)
...
AssaultLadder._align_to_pivot_point = function (self)
...
AssaultLadder.update = function (self, unit, input, dt, context, t)
...
AssaultLadder._rotate_unit_around_pivot = function (self, unit, position, pivot_position, rotation_axis, angle)
...
AssaultLadder._raise = function (self)
	self._raised = true
	self._animate = true
...
AssaultLadder.interaction_complete = function (self, player)
...
AssaultLadder.rpc_raise_assault_ladder = function (self)
	if self._raised == false then
		self:_raise()
	end
end

AssaultLadder.hot_join_synch = function (self, sender)
	RPC.rpc_synch_assault_ladder(sender, self._game_object_id, self._raised)
end

AssaultLadder.rpc_synch_assault_ladder = function (self, raised)
	if raised then
		self:_raise()
	end
end

AssaultLadder.can_interact = function (self, player)
