...
ObjectiveUnitDamage.init = function (self, world, unit, input)
...
ObjectiveUnitDamage.event_round_started = function (self)
...
ObjectiveUnitDamage.enable_destructible = function (self, team_side, enable)
	if Managers.lobby.server then
...
ObjectiveUnitDamage.can_receive_damage = function (self, attacker_unit)
...
ObjectiveUnitDamage._parse_damage_levels = function (self)
	local damage_levels = {}
	local i = 0
...
ObjectiveUnitDamage._create_game_object = function (self)
...
ObjectiveUnitDamage.cb_game_session_disconnect = function (self)
	self._frozen = true
	self._game_object_id = nil
	self._game = nil
end

ObjectiveUnitDamage.set_game_object_id = function (self, game_object_id, game)
	self._game_object_id = game_object_id
	self._game = game
	self._is_client = true
end

ObjectiveUnitDamage.remove_game_object_id = function (self)
	self._game_object_id = nil
	self._game = nil
	self._is_client = nil
end

ObjectiveUnitDamage.add_damage = function (self, attacker_player, attacker_unit, damage_type, damage, position, normal, actor, damage_range_type)
	if self._dead then
		return
	end
...
ObjectiveUnitDamage.die = function (self, damage)
	if self._dead then
		return
	end
...
ObjectiveUnitDamage._calculate_modified_damage = function (self, damage, attacker_player, damage_range_type)
...
ObjectiveUnitDamage._update_damage_level = function (self)
...
ObjectiveUnitDamage.update = function (self, unit, input, dt, context, t)
...
ObjectiveUnitDamage._client_update = function (self, t, dt)
...
ObjectiveUnitDamage.hot_join_synch = function (self, sender, player)
	RPC.rpc_synch_unit_damage_level(sender, self._game_object_id, self._current_damage_level, self._dead)
end

ObjectiveUnitDamage.rpc_synch_unit_damage_level = function (self, damage_level, dead)
