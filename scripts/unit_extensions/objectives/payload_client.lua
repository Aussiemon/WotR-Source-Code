...
PayloadClient.init = function (self, world, unit)
	self._world = world
	self._unit = unit
	self._blackboard = {
...
PayloadClient.event_start_round = function (self, params)
	self:_init_teams()
end

PayloadClient.event_round_started = function (self, params)
	return
end

PayloadClient.flow_cb_add_player_unit = function (self, unit)
	return
end

PayloadClient.flow_cb_remove_player_unit = function (self, unit)
	return
end

PayloadClient._init_teams = function (self)
...
PayloadClient._error_speed_calculation = function (self, dt, t, game, id, movement)
...
PayloadClient.update = function (self, unit, input, dt, context, t)
...
PayloadClient.debug_draw_collision = function (self)
...
PayloadClient.set_active = function (self, team_side, active)
...
PayloadClient.set_game_object_id = function (self, id, game)
	self._id = id
	self._game = game
...
PayloadClient.destroy = function (self)
	return
end

PayloadClient.set_owner = function (self, owner)
	Unit.set_flow_variable(self._unit, "owner", owner)

	self._blackboard.owner_team_side = owner
end

PayloadClient.active = function (self, side)
	return self._blackboard.active_team_sides[side]
end

PayloadClient.owned = function (self, side)
