...
ZoneCapturePointServer.init = function (self, world, unit)
...
ZoneCapturePointServer._init_teams = function (self)
...
ZoneCapturePointServer.update = function (self, unit, input, dt, context, t)
...
ZoneCapturePointServer._zone_captured = function (self, side)
...
ZoneCapturePointServer._largest_team = function (self)
...
ZoneCapturePointServer.flow_cb_set_zone_name = function (self, name)
...
ZoneCapturePointServer.flow_cb_set_owner = function (self, team)
	self._capture_scale = 0

	self:set_owner(team, true)
end

ZoneCapturePointServer.is_contributing = function (self, player)
...
ZoneCapturePointServer._update_units = function (self, dt, t)
...
ZoneCapturePointServer._create_game_object = function (self)
...
ZoneCapturePointServer.hot_join_synch = function (self, sender, player)
	local network_manager = Managers.state.network
