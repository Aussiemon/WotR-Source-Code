...
ArcheryTargetObjective.init = function (self, world, unit)
	self._world = world
	self._unit = unit
	self._active = {}
	self._blackboard = {
...
ArcheryTargetObjective.objective = function (self, side)
	return "", -math.huge
end

ArcheryTargetObjective.projectile_impact = function (self, player, actor, position, normal)
...
ArcheryTargetObjective.update = function (self, unit, input, dt, context)
	return
end

ArcheryTargetObjective.event_start_round = function (self, params)
	self:_init_teams()
end

ArcheryTargetObjective.destroy = function (self)
	return
end

ArcheryTargetObjective._init_teams = function (self)
...
ArcheryTargetObjective.active = function (self, team)
	return self._active[team]
end

ArcheryTargetObjective.flow_cb_set_active = function (self, team_side, active)
