...
ZoneCapturePointClient.init = function (self, world, unit)
...
ZoneCapturePointClient.set_zone_name = function (self, name)
	self._zone_name = name
end

ZoneCapturePointClient.update = function (self, ...)
