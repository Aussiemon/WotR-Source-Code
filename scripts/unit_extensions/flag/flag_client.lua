...
FlagClient.init = function (self, world, unit)
	self._world = world
	self._unit = unit
	self._team_name = nil
	self._id = nil
...
FlagClient.set_game_object_id = function (self, obj_id, game)
	self._id = obj_id
...
FlagClient.update = function (self, unit, input, dt, context)
...
FlagClient.can_be_picked_up = function (self, picker_unit)
...
FlagClient.pickup = function (self, carrier_unit)
	self._carried = true
...
FlagClient.can_be_dropped = function (self, dropper_unit)
	return self._carried and self._carrier_unit == dropper_unit
end

FlagClient.drop = function (self)
	self._carried = false
	self._carrier_unit = nil
...
FlagClient.destroy = function (self)
