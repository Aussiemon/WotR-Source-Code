...
FlagServer.init = function (self, world, unit, team_name, lifetime_on_drop)
	self._world = world
	self._unit = unit
...
FlagServer._create_game_object = function (self)
	local data_table = {
...
FlagServer.cb_game_session_disconnect = function (self)
	self._frozen = true
	self._id = nil
	self._game = nil
end

FlagServer.update = function (self, unit, input, dt, context)
...
FlagServer.can_be_picked_up = function (self, picker_unit)
...
FlagServer.pickup = function (self, carrier_unit)
...
FlagServer.can_be_dropped = function (self, carrier_unit)
	return self._carried and self._carrier_unit == carrier_unit
end

FlagServer.drop = function (self)
	self._carried = false
...
FlagServer.team_name = function (self)
	return self._team_name
end

FlagServer.destroy = function (self)
	return
end
