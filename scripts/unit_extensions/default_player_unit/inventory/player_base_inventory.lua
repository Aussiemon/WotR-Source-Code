...
PlayerBaseInventory.init = function (self, world, user_unit, player, tint_color, secondary_tint_color)
	self._world = world
...
PlayerBaseInventory.voice = function (self)
	return self._voice
end

PlayerBaseInventory.add_armour = function (self, armour, pattern_index)
...
PlayerBaseInventory._load_armour_data = function (self, armour, pattern_index)
...
PlayerBaseInventory.reload_armour_data = function (self)
	self:_load_armour_data(self._armour_name, self._pattern_index)
end

PlayerBaseInventory.armour_values = function (self, hit_zone, back)
...
PlayerBaseInventory._setup_slots = function (self)
...
PlayerBaseInventory.find_slot_by_unit = function (self, unit)
...
PlayerBaseInventory.slots = function (self)
	return self._slots
end

PlayerBaseInventory._gear = function (self, slot_name)
	return self._slots[slot_name].gear
end

PlayerBaseInventory._set_gear = function (self, slot_name, gear)
	self._slots[slot_name].gear = gear
end

PlayerBaseInventory.add_gear = function (self, gear_name, obj_id, ai_gear, attachments)
...
PlayerBaseInventory.remove_gear = function (self, slot_name)
	self:_set_gear(slot_name, nil)
end

PlayerBaseInventory.gear_dead = function (self, slot_name)
...
PlayerBaseInventory.player_unit_gear_anims = function (self, gear)
...
PlayerBaseInventory.gear_unit = function (self, slot_name)
	local gear = self:_gear(slot_name)
...
PlayerBaseInventory.gear_settings = function (self, slot_name)
	local gear = self:_gear(slot_name)

	return gear:settings()
end

PlayerBaseInventory.wielded_slots = function (self)
	local wielded = {}
...
PlayerBaseInventory.is_ranged_weapon = function (self, slot_name)
	local gear = self:_gear(slot_name)

	return gear and gear:is_ranged_weapon()
end

PlayerBaseInventory.wielded_ranged_weapon_slot = function (self)
	for slot_name, slot in pairs(self._slots) do
		local gear = slot.gear
...
PlayerBaseInventory.head = function (self)
	return self._head_unit
end

PlayerBaseInventory.add_head = function (self, head_name, head_material, voice)
...
PlayerBaseInventory.add_helmet = function (self, helmet_name, team_name)
...
PlayerBaseInventory.built_in_overlay = function (self)
	return self._built_in_overlay
end

PlayerBaseInventory.add_helmet_attachment = function (self, helmet_name, attachment_type, attachment_name, team_name)
...
PlayerBaseInventory.allow_decapitation = function (self)
	return self._decap_allowed
end

PlayerBaseInventory.add_helmet_crest = function (self, crest_name, team_name)
...
PlayerBaseInventory.add_coat_of_arms = function (self, settings, team_name)
...
PlayerBaseInventory._attachment_node_linking = function (self, source_unit, target_unit, linking_setup)
...
PlayerBaseInventory.set_eye_target = function (self, aim_target)
...
PlayerBaseInventory.visor_open = function (self)
	return self._visor_open
end

PlayerBaseInventory.visor_name = function (self)
	return self._visor_name
end

PlayerBaseInventory.helmet_name = function (self)
	return self._helmet_name
end

PlayerBaseInventory.helmet_unit = function (self)
	return self._helmet_unit
end

PlayerBaseInventory.helmet_attachment_unit = function (self, name)
	return self._helmet_attachment_units[name]
end

PlayerBaseInventory.set_visor_open = function (self, open, fast)
	if open then
		if fast then
...
PlayerBaseInventory.hot_join_synch = function (self, sender, player, player_object_id)
	for slot_name, slot in pairs(self._slots) do
		if slot.gear then
...
PlayerBaseInventory.destroy = function (self)
	for name, slot in pairs(self._slots) do
		if slot.gear then
			slot.gear:destroy()
		end
...
PlayerBaseInventory.set_kinematic_wielded_gear = function (self, kinematic)
	for slot_name, slot in pairs(self._slots) do
		local gear = slot.gear
...
PlayerBaseInventory.set_faux_unwielded = function (self, bool)
	for slot_name, slot in pairs(self._slots) do
		local gear = slot.gear
