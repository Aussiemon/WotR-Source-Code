...
PlayerGear.init = function (self, world, user_unit, player, name, obj_id, primary_tint, secondary_tint, ai_gear, has_ammo, attachments)
	self._world = world
	self._game = nil
	self._id = nil
	self._wielded = false
...
PlayerGear._create_game_object = function (self, game, unit, has_ammo, attachments)
...
PlayerGear._calculate_attachment_value = function (self, slot, attachments)
...
PlayerGear._multiple_attachments_network_value = function (self, attachment_items, misc_attachments)
...
PlayerGear.cb_game_session_disconnect = function (self)
	self._frozen = true
	self._id = nil
	self._game = nil
end

PlayerGear._spawn_unit = function (self, world)
	self._unit = World.spawn_unit(world, self._settings.unit)
end

PlayerGear.update = function (self, dt, t)
...
PlayerGear.is_melee_weapon = function (self)
...
PlayerGear.has_attachment = function (self, category, name)
...
PlayerGear.destroy = function (self, keep_unit)
