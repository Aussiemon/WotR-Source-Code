...
PlayerHuskInventory.init = function (self, world, user_unit, player, tint_color, secondary_tint_color)
...
PlayerHuskInventory.enter_ghost_mode = function (self)
...
PlayerHuskInventory.anim_cb_hide_wielded_weapons = function (self, hide)
...
PlayerHuskInventory.set_gear_wielded = function (self, slot_name, wielded, ignore_sound)
...
PlayerHuskInventory.exit_ghost_mode = function (self)
...
PlayerHuskInventory.add_gear = function (self, gear_name, obj_id, attachment_ids)
	local attachments = {}
...
PlayerHuskInventory._calculate_items = function (self, gear_name, index, attachment_ids)
...
PlayerHuskInventory._calculate_misc_items = function (self, attachment_items, value)
	local items = {}
...
PlayerHuskInventory.add_head = function (self, head_name, head_material, voice)
...
PlayerHuskInventory.add_helmet = function (self, helmet_name, team_name)
...
PlayerHuskInventory.add_helmet_attachment = function (self, helmet_name, attachment_type, attachment_name, team_name)
...
PlayerHuskInventory.add_helmet_crest = function (self, crest_name, team_name)
...
PlayerHuskInventory.helmet = function (self)
