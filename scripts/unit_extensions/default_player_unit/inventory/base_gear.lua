...
BaseGear.init = function (self, world, user_unit, player, name, primary_team_tint, secondary_team_tint, ai_gear, attachments, attachment_multipliers, properties)
...
BaseGear._calculate_attachment_multipliers = function (self, attachments)
...
BaseGear._calculate_properties = function (self, attachments)
	local properties = {}
...
BaseGear.attachment_multiplier = function (self, multiplier)
	return self._attachment_multipliers[multiplier]
end

BaseGear.has_property = function (self, weapon_property)
...
BaseGear.attachments = function (self)
	return self._attachments
end

BaseGear.attachment_multipliers = function (self)
	return self._attachment_multipliers
end

BaseGear.properties = function (self)
	return self._properties
end

BaseGear._setup_gear_extensions = function (self, ai_gear, player, attachments, properties, attachment_multipliers)
...
BaseGear.is_ranged_weapon = function (self)
...
BaseGear._set_team_material_variation = function (self)
	local unit = self._unit
...
BaseGear.settings = function (self)
	return self._settings
end

BaseGear._set_unit_data = function (self, attachment_multipliers)
	local unit = self._unit
...
BaseGear._link = function (self, attachment_node_linking)
	local unit = self._unit
	local user_unit = self._user_unit
...
BaseGear._spawn_quiver = function (self, quiver_settings)
...
BaseGear._link_units = function (self, attachment_node_linking, source, target, link_table)
...
BaseGear.wielded = function (self)
	return self._wielded
end

BaseGear.name = function (self)
	return self._name
end

BaseGear.unit = function (self)
	return self._unit
end

BaseGear.set_wielded = function (self, wielded)
	local unit = self._unit
	local settings = self._settings
...
BaseGear.set_faux_unwielded = function (self, unwielded)
	local unit = self._unit
	local settings = self._settings
...
BaseGear._restore_scene_graph = function (self)
...
BaseGear.extensions = function (self)
	return self._extensions
end

BaseGear.destroy = function (self, keep_unit)
	local unit = self._unit
...
BaseGear.enter_ghost_mode = function (self)
...
BaseGear._disable_collisions = function (self)
	local unit = self._unit
...
BaseGear._enable_collisions = function (self)
	local unit = self._unit
	local num_actors = Unit.num_actors(unit)
...
BaseGear.set_kinematic = function (self, kinematic)
	local unit = self._unit
...
BaseGear.exit_ghost_mode = function (self)
...
BaseGear.hide_gear = function (self, reason)
...
BaseGear.hide_quiver = function (self, reason)
...
BaseGear.unhide_quiver = function (self, reason)
	local quiver_data = self._quiver_data
...
BaseGear.unhide_gear = function (self, reason)
...
BaseGear.trigger_timpani_event = function (self, event_config)
...
BaseGear.set_coat_of_arms = function (self, settings, team_name)
