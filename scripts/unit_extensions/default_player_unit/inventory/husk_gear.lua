...
HuskGear.init = function (self, world, user_unit, player, name, obj_id, primary_tint, secondary_tint, ai_gear, has_ammo, attachments)
	self._world = world
...
HuskGear._spawn_unit = function (self, world)
