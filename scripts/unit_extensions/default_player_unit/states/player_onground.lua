...
PlayerOnground.update = function (self, dt, t)
...
PlayerOnground._calculate_speed = function (self, dt, current_speed, target_speed, encumbrance)
...
PlayerOnground.enter = function (self, old_state, movement_type)
...
PlayerOnground.exit = function (self, new_state)
...
PlayerOnground._check_jump = function (self, dt, t)
	local internal = self._internal
...
PlayerOnground._check_perks = function (self, dt, t)
	local internal = self._internal
...
PlayerOnground._check_interact = function (self, dt, t)
...
PlayerOnground._check_bandage = function (self, dt, t)
...
PlayerOnground._update_transition = function (self, dt, t)
...
PlayerOnground.cb_evaluate_inair_transition = function (self, actor_list)
...
PlayerOnground._update_crouch = function (self, dt, t)
...
PlayerOnground._crouch = function (self)
...
PlayerOnground.cb_teabag_overlap = function (self, actors)
	local internal = self._internal
...
PlayerOnground._calculate_move_speed_var_from_mps = function (self, move_speed)
	local speed_var
...
PlayerOnground._update_animation = function (self, dt, t)
	local internal = self._internal
...
PlayerOnground._update_movement = function (self, dt, t)
...
PlayerOnground._update_stamina = function (self, dt, t)
	local internal = self._internal
	local inventory = internal:inventory()
...
PlayerOnground._update_rotation = function (self, dt)
	local unit = self._unit
	local internal = self._internal
