...
PlayerClimbing.init = function (self, unit, internal, world)
...
PlayerClimbing.stun = function (self)
	return
end

PlayerClimbing.update = function (self, dt, t)
...
PlayerClimbing._calculate_move_dir = function (self, dt, t)
	local move = self._controller and self._controller:get("move") or Vector3(0, 0, 0)

	return move.y
end

PlayerClimbing.update_movement = function (self, dt, t)
...
ClimbHelper.ladder_anim_val = function (distance)
	return LADDER_STEP_TIME * ((distance + LADDER_BOTTOM_POS_OFFSET) % LADDER_STEP_LENGTH / LADDER_STEP_LENGTH)
end

PlayerClimbing.anim_cb_climb_exit_finished = function (self)
...
PlayerClimbing._enter_exiting = function (self)
	self._exiting = true
...
PlayerClimbing._update_movement_top_enter_exit = function (self, unit, dt)
...
PlayerClimbing._calculate_allowed_ladder_pose = function (self, wanted_ladder_anim_factor, dir)
	if dir > 0 then
...
PlayerClimbing._interaction_settings = function (self)
	return PlayerUnitMovementSettings.interaction.settings[self._interaction_type]
end

PlayerClimbing.enter = function (self, old_state, ladder_unit)
...
PlayerClimbing.synch_ladder_unit = function (self, peer)
	local internal = self._internal
...
PlayerClimbing._start_top_enter = function (self, ladder_bottom_rot)
...
PlayerClimbing._calculate_ladder_pos = function (self, player_pos)
	local ladder_unit = self._ladder_unit
...
PlayerClimbing.exit = function (self, new_state)
...
PlayerClimbing.destroy = function (self)
	return
end
