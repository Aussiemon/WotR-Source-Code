...
PlayerLanding.update = function (self, dt, t)
...
PlayerLanding.enter = function (self, old_state, landing_type)
...
PlayerLanding._halting_landing = function (self)
	local internal = self._internal
...
PlayerLanding.exit = function (self, new_state)
...
PlayerLanding.update_transition = function (self, dt)
...
PlayerLanding.cb_evaluate_inair_transition = function (self, actor_list)
...
PlayerLanding.anim_cb_landing_to_onground = function (self)
	self._transition = "onground"
end

PlayerLanding._update_movement = function (self, dt, t)
...
PlayerLanding.update_rotation = function (self, dt, t)
	local internal = self._internal
