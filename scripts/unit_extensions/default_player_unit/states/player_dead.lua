...
PlayerDead.init = function (self, unit, internal, world)
	self._unit = unit
	self._internal = internal
	self._world = world
end

PlayerDead.anim_event = function (self, event, force_local)
...
PlayerDead.update = function (self, dt, t, context)
	local unit = self._unit
...
PlayerDead.anim_cb_knockdown_finished = function (self)
	return
end

PlayerDead.update_movement = function (self, dt)
	return
end

PlayerDead.set_local_position = function (self, pos)
	local internal = self._internal
...
PlayerDead.set_local_rotation = function (self, rot)
	local internal = self._internal
...
PlayerDead.post_update = function (self, dt)
...
PlayerDead.enter = function (self, old_state, instakill, damage_type, hit_zone, impact_direction)
	local unit = self._unit
...
PlayerDead._add_instakill_push = function (self, hit_zone_name, impact_direction)
...
PlayerDead._apply_instakill_push = function (self, push_data)
...
PlayerDead.exit = function (self, new_state)
	return
end

PlayerDead.destroy = function (self)
	return
end

PlayerDead.change_state = function (self, new_state)
	return
end

PlayerDead.anim_cb_ready_arrow = function (self)
	local internal = self._internal
...
PlayerDead.anim_cb_wield = function (self)
	return
end

PlayerDead.anim_cb_wield_finished = function (self)
	return
end

PlayerDead.wielded_weapon_destroyed = function (self, slot_name)
	return
end

PlayerDead.anim_cb_bow_action_finished = function (self)
	return
end

PlayerDead.anim_cb_bow_draw_finished = function (self)
	return
end
