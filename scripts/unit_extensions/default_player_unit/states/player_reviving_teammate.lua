...
PlayerRevivingTeammate.enter = function (self, old_state, target_unit, t)
...
PlayerRevivingTeammate._exit_on_fail = function (self)
...
PlayerRevivingTeammate._exit_on_complete = function (self)
...
PlayerRevivingTeammate._interact_duration = function (self)
	local internal = self._internal
