...
PlayerPlantingFlag.init = function (self, unit, internal, world)
	PlayerPlantingFlag.super.init(self, unit, internal, world, "flag_plant")

	self._capture_point_unit = nil
end

PlayerPlantingFlag.enter = function (self, old_state, capture_point_unit, t)
...
PlayerPlantingFlag.exit = function (self, new_state)
	PlayerPlantingFlag.super.exit(self, new_state)

	self._capture_point_unit = nil
end

PlayerPlantingFlag._exit_on_fail = function (self)
...
PlayerPlantingFlag._exit_on_complete = function (self)
...
PlayerPlantingFlag._interact_duration = function (self)
	local internal = self._internal
