...
PlayerPushing.enter = function (self, old_state)
...
PlayerPushing.exit = function (self, new_state)
...
PlayerPushing.update_rotation = function (self, dt, t)
	self:update_aim_rotation(dt, t)
	self:update_lerped_rotation(dt, t)
end

PlayerPushing._swing_push = function (self, t)
	local internal = self._internal
...
PlayerPushing.anim_cb_push_damage_finished = function (self)
	local internal = self._internal
	local inventory = internal:inventory()
	local slot_name = inventory:wielded_block_slot()
	local gear = inventory:_gear(slot_name)
...
PlayerPushing.anim_cb_push_finished = function (self)
	self:anim_event("push_finished")
	self:change_state("onground")
end

PlayerPushing._align_to_camera = function (self)
	local internal = self._internal
...
PlayerRushing.update_movement = function (self, dt, t)
	local internal = self._internal
	local unit = self._unit
	local mover = Unit.mover(unit)
	local wanted_pose = Unit.animation_wanted_root_pose(unit)
...
PlayerRushing._speed = function (self, time_left)
...
PlayerRushing.enter = function (self, old_state)
...
PlayerRushing.update = function (self, dt, t)
...
PlayerRushing._update_sweep = function (self, dt, t)
...
PlayerRushing.exit = function (self, new_state)
...
PlayerRushing._rush_hit = function (self, hit_unit, actor, normal, position, impact_direction)
...
PlayerRushing._check_parry = function (self, victim_locomotion)
...
PlayerRushing._check_blocking = function (self, victim_locomotion)
...
PlayerRushing._rush_impact_character = function (self, hit_unit, position, normal, actor, impact_direction)
...
PlayerRushing.anim_cb_charge_finished = function (self)
	self:anim_event("charge_finished")
	self:change_state("onground")
end

PlayerRushing._swing_push = function (self, t)
	local internal = self._internal
...
PlayerRushing._sweep_position = function (self)
	local unit = self._unit
