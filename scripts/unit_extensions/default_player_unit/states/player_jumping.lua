...
PlayerJumping.update = function (self, dt, t)
...
PlayerJumping.update_transition = function (self, dt)
...
PlayerJumping.cb_evaluate_landing_transition = function (self, actor_list)
	local internal = self._internal
...
PlayerJumping.enter = function (self, old_state)
...
PlayerJumping.exit = function (self, new_state)
...
PlayerJumping.update_movement = function (self, dt)
	local internal = self._internal
...
PlayerJumping.update_rotation = function (self, dt, t)
