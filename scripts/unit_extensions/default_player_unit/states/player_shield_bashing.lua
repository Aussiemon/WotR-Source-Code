...
PlayerShieldBashing.update = function (self, dt, t)
...
PlayerShieldBashing._update_transition = function (self, dt, t)
...
PlayerShieldBashing.evaluate_inair_transition = function (self, actor_list)
...
PlayerShieldBashing._update_shield_bash = function (self, dt, t)
...
PlayerShieldBashing.update_movement = function (self, dt, t)
	local internal = self._internal
	local unit = self._unit
...
PlayerShieldBashing.enter = function (self, old_state)
...
PlayerShieldBashing.exit = function (self, new_state)
...
PlayerShieldBashing.update_rotation = function (self, dt, t)
	local internal = self._internal
...
PlayerShieldBashing._swing_shield_bash = function (self, t, charge_anim_time, attack_time)
	local internal = self._internal
...
PlayerShieldBashing.anim_cb_shield_bash_damage_finished = function (self)
	local internal = self._internal
...
PlayerShieldBashing.anim_cb_shield_bash_finished = function (self)
	self:anim_event("shield_bash_finished")
	self:change_state("onground")
end

PlayerShieldBashing._can_swing_shield_bash = function (self, t, charge_time)
	local internal = self._internal
...
PlayerShieldBashing._abort_shield_bash_pose = function (self)
	local internal = self._internal
...
PlayerShieldBashing._damp_velocity = function (self)
	local internal = self._internal
...
PlayerShieldBashing._align_to_camera = function (self)
	local internal = self._internal
