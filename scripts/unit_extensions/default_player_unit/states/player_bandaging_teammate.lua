...
PlayerBandagingTeammate.init = function (self, unit, internal, world)
	PlayerBandagingTeammate.super.init(self, unit, internal, world, "bandage")

	self._target_unit = nil
end

PlayerBandagingTeammate.enter = function (self, old_state, target_unit, t)
...
PlayerBandagingTeammate.update = function (self, dt, t)
...
PlayerBandagingTeammate.exit = function (self, new_state)
	PlayerBandagingTeammate.super.exit(self, new_state)

	self._target_unit = nil
end

PlayerBandagingTeammate._exit_on_fail = function (self)
...
PlayerBandagingTeammate._exit_on_complete = function (self)
...
PlayerBandagingTeammate._interact_duration = function (self)
	local internal = self._internal
