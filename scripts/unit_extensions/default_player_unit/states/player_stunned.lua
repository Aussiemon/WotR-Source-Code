...
PlayerStunned.update = function (self, dt, t)
...
PlayerStunned.update_movement = function (self, dt, t)
...
PlayerStunned.update_speed = function (self, dt, t)
...
PlayerStunned._calculate_speed = function (self, dt, current_speed, target_speed, encumbrance)
...
PlayerStunned.enter = function (self, old_state, hit_zone, impact_direction, impact_type)
...
PlayerStunned.exit = function (self, new_state)
...
PlayerStunned.update_transitions = function (self, dt, t)
	if t > self._stun_time then
		self:change_state("onground")
	end
end

PlayerStunned.destroy = function (self)
	return
end
