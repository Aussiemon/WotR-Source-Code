...
PlayerCallingHorse.init = function (self, unit, internal, world)
...
PlayerCallingHorse.update = function (self, dt, t)
...
PlayerCallingHorse.update_movement = function (self, dt)
	local internal = self._internal
...
PlayerCallingHorse.enter = function (self, old_state)
...
PlayerCallingHorse.exit = function (self, new_state)
...
PlayerCallingHorse.finish_calling_horse = function (self, reason)
...
PlayerCallingHorse.update_rotation = function (self, dt, t)
	self:update_aim_rotation(dt, t)
end

PlayerCallingHorse._spawn_overlap_check = function (self, dt, t)
...
PlayerCallingHorse.cb_cancel_call_horse = function (self, actors)
	self._call_overlap_check_passed = #actors == 0
end

PlayerCallingHorse._align_to_camera = function (self)
	local internal = self._internal
