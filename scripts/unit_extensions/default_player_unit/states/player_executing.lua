...
ExecutionHelper.pick_execution = function (attacker_unit, victim_unit, wielded_slots)
...
ExecutionHelper.play_execution_attacker_anims = function (attacker_unit, victim_unit, execution_definition)
...
ExecutionHelper.play_execution_victim_anims = function (victim_unit, attacker_unit, execution_definition)
...
ExecutionHelper.play_execution_abort_anim = function (victim_unit)
	Unit.animation_event(victim_unit, "execute_victim_interrupt")
	Unit.set_data(victim_unit, "execution_events", nil)
end

ExecutionHelper.attacker_event = function (attacker_unit, event_name)
...
ExecutionHelper.victim_event = function (victim_unit, event_name)
...
ExecutionHelper.play_effects = function (effect_unit, armour_unit, event, event_name)
...
PlayerExecuting.enter = function (self, old_state, target_unit, t)
...
PlayerExecuting.update = function (self, dt, t)
...
PlayerExecuting._update_position = function (self, dt, t)
	self:_set_execution_pose(self._target_unit, ExecutionDefinitions[self._execution], dt)
	self:update_lerped_rotation(dt)
end

PlayerExecuting._set_execution_pose = function (self, victim_unit, execution_definition, dt)
...
PlayerExecuting._update_execution = function (self, execution_t, dt)
...
PlayerExecuting.exit = function (self, ...)
...
PlayerExecuting._exit_on_fail = function (self)
...
PlayerExecuting.interaction_confirmed = function (self)
...
PlayerExecuting._begin_execution = function (self)
