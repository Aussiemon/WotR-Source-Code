...
AIWaveSpawner.init = function (self, world, unit)
	self._world = world
...
AIWaveSpawner.flow_cb_round_started = function (self)
	self:_parse_config()
end

AIWaveSpawner.cb_unit_died = function (self, unit)
...
AIWaveSpawner.on_activate = function (self)
...
AIWaveSpawner.next_wave = function (self, t)
...
AIWaveSpawner._next_wave_node = function (self, t, wave_data)
	if script_data.wave_spawn_debug then
...
AIWaveSpawner.update = function (self, unit, input, dt, context, t)
...
AIWaveSpawner._update_node = function (self, t, node, wave_data)
...
AIWaveSpawner._enter_node_delay = function (self, t, node, wave_data)
	return
end

AIWaveSpawner._enter_node_spawn = function (self, t, node, wave_data)
	wave_data.node_data = {
		spawns = 0
	}
end

AIWaveSpawner._update_spawn_node = function (self, t, node, wave_data)
...
AIWaveSpawner.on_deactivate = function (self)
	return
end

AIWaveSpawner._parse_config = function (self)
...
AIWaveSpawner._spawn_unit = function (self, profile_name)
...
AIWaveSpawner.despawn = function (self)
...
AIWaveSpawner.destroy = function (self)
	return
end
