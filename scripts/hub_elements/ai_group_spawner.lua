...
AIGroupSpawner.init = function (self, world, unit)
	self._world = world
...
AIGroupSpawner.flow_cb_round_started = function (self)
	return
end

AIGroupSpawner.cb_unit_in_group_died = function (self, unit)
...
AIGroupSpawner.on_activate = function (self)
	self._active = true

	self:_spawn_group()
end

AIGroupSpawner.on_deactivate = function (self)
	self._active = false
end

AIGroupSpawner._parse_config = function (self)
...
AIGroupSpawner._spawn_group = function (self)
...
AIGroupSpawner.update = function (self, unit, input, dt, context, t)
	return
end

AIGroupSpawner.destroy = function (self)
	return
end
