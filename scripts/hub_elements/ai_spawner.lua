...
AISpawner.flow_cb_round_started = function (self)
	self:_parse_config()
end

AISpawner.cb_unit_died = function (self, victim_unit, attacking_player)
...
AISpawner.on_activate = function (self)
...
AISpawner._parse_config = function (self)
...
AISpawner._spawn_unit = function (self)
	while true do
...
AISpawner.despawn = function (self)
...
AISpawner.set_deterministic = function (self, deterministic, seed)
