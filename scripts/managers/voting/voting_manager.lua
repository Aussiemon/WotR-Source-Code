...
VotingTypes.kick.text = function (game, id)
...
VotingTypes.kick.extra_game_object_fields = function (data_table, kicked_id)
...
VotingTypes.kick.voter_eligible = function (self, kicked_id, voter_id)
	return true
end

VotingTypes.kick.pass = function (self, peer_id)
	Managers.admin:ban_player(peer_id, "You were voted out.", 1800)
end

VotingTypes.kick.fail = function (self)
	return
end

VotingTypes.kick.valid = function (self, vote_player_id, peer_id)
...
VotingTypes.kick.cancel = function (self)
	return
end
...
VotingTypes.change_level.text = function (game, id)
...
VotingTypes.change_level.voter_eligible = function (self, ...)
	print("VotingTypes.change_level.voter_eligible", ...)

	return true
end

VotingTypes.change_level.pass = function (self, map_game_mode_pair)
	Commands:change_level(map_game_mode_pair)
end

VotingTypes.change_level.fail = function (self, ...)
	print("VotingTypes.change_level.fail")
end

VotingTypes.change_level.cancel = function (self, ...)
	print("VotingTypes.change_level.cancel")
end

VotingTypes.change_level.valid = function (self, voter_id, map_game_mode_pair)
	return true
end

VotingTypes.change_level.extra_game_object_fields = function (data_table, map_game_mode_pair)
...
VotingManager.init = function (self)
	self._current_vote = nil
end

VotingManager.destroy = function (self)
	return
end
...
VotingManager._server_update = function (self, dt, t)
...
VotingManager._end_vote = function (self, end_type)
	local current_vote = self._current_vote
...
VotingManager._is_enough_votes = function (self, current_vote)
...
VotingManager._remove_vote = function (self, vote, player_id)
	local current_vote = self._current_vote
...
VotingManager._add_vote = function (self, vote, player_id)
	local current_vote = self._current_vote
	local votes = current_vote.voted[vote]
...
VotingManager.start_vote = function (self, vote_type, vote_player, ...)
...
VotingManager.rpc_vote = function (self, vote_cast, voter, id)
	local current_vote = self._current_vote
...
VotingManager.client_vote_created = function (self, id)
	local current_vote = self._current_vote
...
VotingManager.client_vote_destroyed = function (self, id)
	local current_vote = self._current_vote
...
VotingManager._client_update = function (self, dt, t)
	local current_vote = self._current_vote
...
VotingManager.client_vote = function (self, vote, player)
	local network_manager = Managers.state.network
	local current_vote = self._current_vote
...
VotingManager.vote_in_progress = function (self)
