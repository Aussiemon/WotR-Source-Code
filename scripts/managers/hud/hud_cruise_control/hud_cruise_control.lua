...
HUDCruiseControl.init = function (self, world, player)
...
HUDCruiseControl._setup = function (self)
...
HUDCruiseControl.event_local_player_mounted = function (self, player, mount_locomotion, blackboard)
...
HUDCruiseControl.event_local_player_dismounted = function (self, player)
	if player == self._player then
		self._active = false
		self._mount_locomotion = nil
...
HUDCruiseControl.post_update = function (self, dt, t)
...
HUDCruiseControl.destroy = function (self)
