...
HUDCruiseControlIcon.init = function (self, config)
	HUDCruiseControlIcon.super.init(self, config)
end

HUDCruiseControlIcon.render = function (self, dt, t, gui, layout_settings)
...
HUDCruiseControlIcon.create_from_config = function (config)
