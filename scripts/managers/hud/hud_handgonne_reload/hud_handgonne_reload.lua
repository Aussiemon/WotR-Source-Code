...
HUDHandgonneReload.init = function (self, world, player)
...
HUDHandgonneReload._setup_handgonne_reload = function (self)
...
HUDHandgonneReload.event_handgonne_reload_activated = function (self, dt, t, player, blackboard)
...
HUDHandgonneReload.event_handgonne_reload_deactivated = function (self, player)
	if player == self._player then
		self._active = false
...
HUDHandgonneReload.post_update = function (self, dt, t)
...
HUDHandgonneReload.destroy = function (self)
