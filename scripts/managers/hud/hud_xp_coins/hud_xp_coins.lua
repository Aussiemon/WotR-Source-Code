...
HUDXPCoins.init = function (self, world, player)
...
HUDXPCoins.event_gained_xp_and_coins = function (self, reason, xp, coins)
...
HUDXPCoins.post_update = function (self, dt, t)
	self:_update_queued_awards(dt, t)
	self:_update_showing_awards(dt, t)
end

HUDXPCoins._update_queued_awards = function (self, dt, t)
...
HUDXPCoins._update_showing_awards = function (self, dt, t)
...
HUDXPCoins.destroy = function (self)
