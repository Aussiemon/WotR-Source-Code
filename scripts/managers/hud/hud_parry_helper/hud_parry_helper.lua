...
HUDParryHelper.init = function (self, world, player)
...
HUDParryHelper._setup_parry_helper = function (self)
...
HUDParryHelper.event_parry_helper_activated = function (self, player, blackboard)
...
HUDParryHelper.event_parry_helper_deactivated = function (self, player)
	if player == self._player then
		self._active = false
...
HUDParryHelper.post_update = function (self, dt, t)
...
HUDParryHelper.destroy = function (self)
