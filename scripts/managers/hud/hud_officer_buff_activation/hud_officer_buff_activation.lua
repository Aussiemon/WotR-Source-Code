...
HUDOfficerBuffActivation.init = function (self, world, player)
...
HUDOfficerBuffActivation._setup_buff = function (self)
...
HUDOfficerBuffActivation.event_hud_officer_buff_activation_register_blackboard = function (self, player, blackboard)
...
HUDOfficerBuffActivation.event_hud_officer_buff_activation_set_active = function (self, player)
	if player == self._player then
		self._player_is_corporal = true
	end
end

HUDOfficerBuffActivation.event_hud_officer_buff_activation_set_unactive = function (self, player)
	if player == self._player then
		self._player_is_corporal = false
	end
end

HUDOfficerBuffActivation.post_update = function (self, dt, t)
...
HUDOfficerBuffActivation.disabled_post_update = function (self, dt, t)
	for key, element_container in ipairs(self._officer_buff_element_containers:elements()) do
		for id, element in pairs(element_container:elements()) do
...
HUDOfficerBuffActivation.destroy = function (self)
