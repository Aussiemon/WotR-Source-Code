...
HUDOfficerBuffActivationText.init = function (self, config)
	HUDOfficerBuffActivationText.super.init(self, config)
end

HUDOfficerBuffActivationText.render = function (self, dt, t, gui, layout_settings)
...
HUDOfficerBuffActivationText.create_from_config = function (config)
