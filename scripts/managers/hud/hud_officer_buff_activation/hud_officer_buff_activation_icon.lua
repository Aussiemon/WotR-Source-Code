...
HUDOfficerBuffActivationIcon.init = function (self, config)
	HUDOfficerBuffActivationIcon.super.init(self, config)
end

HUDOfficerBuffActivationIcon.render = function (self, dt, t, gui, layout_settings)
...
HUDOfficerBuffActivationIcon.create_from_config = function (config)
