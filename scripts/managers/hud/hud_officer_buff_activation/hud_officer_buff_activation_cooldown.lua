...
HUDOfficerBuffActivationCooldown.init = function (self, config)
	HUDOfficerBuffActivationCooldown.super.init(self, config)
end

HUDOfficerBuffActivationCooldown.render = function (self, dt, t, gui, layout_settings)
...
HUDOfficerBuffActivationCooldown.create_from_config = function (config)
