...
ChatOutputWindow.init = function (self, world)
...
ChatOutputWindow._setup_window = function (self)
	local w, h = Application.resolution()
end

ChatOutputWindow._setup_variables = function (self)
	self._flood_control = {}
	self._texts = {}
	self._active = false
...
ChatOutputWindow._setup_gui = function (self, world)
...
ChatOutputWindow._register_events = function (self)
...
ChatOutputWindow.event_chat_activated = function (self)
	Window.set_show_cursor(true)

	self._active = true
end

ChatOutputWindow.event_chat_deactivated = function (self, shutdown_light)
...
ChatOutputWindow.post_update = function (self, dt, t, player)
...
ChatOutputWindow._update_scroll_input = function (self, player, dt)
...
ChatOutputWindow._update_scroll = function (self, dt)
	if self._active then
...
ChatOutputWindow._render_window = function (self)
	if self._active then
		local w, h = Application.resolution()
...
ChatOutputWindow._render_buttons = function (self)
...
ChatOutputWindow._calculate_offset = function (self, top, bottom)
...
ChatOutputWindow._render_texts = function (self, gui, texts, active, scroll_offset)
	if debug then
		local w, h = Application.resolution()
		local gui = self._gui
...
ChatOutputWindow._render_border = function (self, rect, thickness, color, layer)
...
ChatOutputWindow.post = function (self, channel_name, name, message, color)
...
ChatOutputWindow._post_allowed = function (self, name)
	if not name then
		return true
	end
...
ChatOutputWindow._format_message = function (self, message)
...
ChatOutputWindow.event_chat_message = function (self, channel_id, sender, message)
...
ChatOutputWindow.event_admin_chat_message = function (self, channel_id, sender, message)
	local channel = NetworkLookup.chat_channels[channel_id]
	local channel_name = L("chat_" .. channel)
...
ChatOutputWindow.event_rcon_chat_message = function (self, channel_id, sender, message)
	local channel = NetworkLookup.chat_channels[channel_id]
	local channel_name = L("chat_" .. channel)
...
ChatOutputWindow.output_console_text = function (self, text, color)
	self:post(nil, nil, text, color)
end

ChatOutputWindow.network_output_console_text = function (self, text_id, color, display_time)
...
ChatOutputWindow.get_button_bitmap = function (self, button_name)
...
ChatOutputWindow.on_activated = function (self, active)
	return
end

ChatOutputWindow.on_deactivated = function (self, active)
	return
end

ChatOutputWindow.set_enabled = function (self, enabled)
	return
end

ChatOutputWindow.disabled_post_update = function (self, dt, t)
	return
end

ChatOutputWindow.destroy = function (self)
	return
end

ChatOutputWindow.enabled = function (self)
	return true
end
