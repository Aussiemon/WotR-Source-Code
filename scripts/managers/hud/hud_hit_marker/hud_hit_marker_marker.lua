...
HUDHitMarkerMarker.init = function (self, config)
...
HUDHitMarkerMarker.update_size = function (self, dt, t, gui, layout_settings)
...
HUDHitMarkerMarker.update_position = function (self, dt, t, layout_settings, x, y, z)
	local config = self.config
...
HUDHitMarkerMarker._calculate_alpha = function (self, t)
	local alpha_value = 255 * (self._alpha_timer - t) / 5

	return alpha_value
end

HUDHitMarkerMarker.create_from_config = function (config)
