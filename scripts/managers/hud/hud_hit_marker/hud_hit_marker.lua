...
HUDHitMarker.init = function (self, world, player)
...
HUDHitMarker._setup_hit_marker = function (self)
...
HUDHitMarker.event_hit_marker_activated = function (self, player, hit_player)
...
HUDHitMarker.event_hit_marker_deactivated = function (self, player)
	if player == self._player then
		self._active = false
	end
end

HUDHitMarker.post_update = function (self, dt, t)
...
HUDHitMarker.destroy = function (self)
