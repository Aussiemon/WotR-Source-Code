...
HUDTextBuffElement.init = function (self, config)
	HUDTextBuffElement.super.init(self, config)
end

HUDTextBuffElement._split_pad_text = function (self, text)
...
HUDTextBuffElement.render = function (self, dt, t, gui, layout_settings)
...
HUDTextBuffElement.create_from_config = function (config)
