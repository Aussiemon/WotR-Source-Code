...
HUDTextInputElement.init = function (self, config)
	self._width = nil
	self._height = nil
...
HUDTextInputElement.width = function (self)
	return self._width
end

HUDTextInputElement.height = function (self)
	return self._height
end

HUDTextInputElement.update_size = function (self, dt, t, gui, layout_settings)
...
HUDTextInputElement.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

HUDTextInputElement.render = function (self, dt, t, gui, layout_settings)
	local x = self._x
	local y = self._y
	local z = self._z
	local w = self._width
...
HUDTextInputElement.create_from_config = function (config)
