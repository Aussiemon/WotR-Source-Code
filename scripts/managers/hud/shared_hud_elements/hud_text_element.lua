...
HUDTextElement.init = function (self, config)
	self._width = nil
	self._height = nil
	self.config = config
end

HUDTextElement.width = function (self)
	return self._width
end

HUDTextElement.height = function (self)
	return self._height
end

HUDTextElement.update_size = function (self, dt, t, gui, layout_settings)
...
HUDTextElement.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x - self._min_x
	self._y = y
	self._z = z
end

HUDTextElement.render = function (self, dt, t, gui, layout_settings)
	local config = self.config
...
HUDTextElement.create_from_config = function (config)
