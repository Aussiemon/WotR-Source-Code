...
HUDHitIndicator.update_position = function (self, dt, t, layout_settings, x, y, z)
...
HUDHitIndicator.create_from_config = function (config, viewport_name, impact_direction)
...
HUDHitIndicator.render = function (self, dt, t, gui, layout_settings)
	local config = self.config
