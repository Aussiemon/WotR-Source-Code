...
HUDBarElement.init = function (self, config)
	self._width = nil
	self._height = nil
	self.config = config
	self._progress = 0
...
HUDBarElement.width = function (self)
	return self._width
end

HUDBarElement.height = function (self)
	return self._height
end

HUDBarElement.set_progress = function (self, progress)
	self._progress = progress
end

HUDBarElement.update_size = function (self, dt, t, gui, layout_settings)
	self._width = layout_settings.bar_width
	self._height = layout_settings.bar_height
end

HUDBarElement.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

HUDBarElement.render = function (self, dt, t, gui, layout_settings)
...
HUDBarElement.create_from_config = function (config)
