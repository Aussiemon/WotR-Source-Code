...
HUDRotatingMarker.init = function (self, config)
	HUDRotatingMarker.super.init(self, config)

	self._circle_radius = config.circle_radius
end

HUDRotatingMarker.update_position = function (self, dt, t, layout_settings, x, y, z)
...
HUDRotatingMarker.create_from_config = function (config)
