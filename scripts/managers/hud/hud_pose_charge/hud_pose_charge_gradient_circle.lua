...
HUDPoseChargeGradientCircle.init = function (self, config)
	HUDPoseChargeGradientCircle.super.init(self, config)

	self._fade_timer = 0
end

HUDPoseChargeGradientCircle.update_position = function (self, dt, t, layout_settings, x, y, z)
...
HUDPoseChargeGradientCircle.render = function (self, dt, t, gui, layout_settings)
	local config = self.config
...
HUDPoseChargeGradientCircle.create_from_config = function (config)
