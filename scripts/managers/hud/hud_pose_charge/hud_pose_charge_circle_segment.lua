...
HUDPoseChargeCircleSegment.init = function (self, config)
	HUDPoseChargeCircleSegment.super.init(self, config)

	self._circle_radius = config.circle_radius
end

HUDPoseChargeCircleSegment.update_position = function (self, dt, t, layout_settings, x, y, z)
...
HUDPoseChargeCircleSegment.create_from_config = function (config)
