...
HUDPoseCharge.init = function (self, world, player)
...
HUDPoseCharge._setup_pose_charge = function (self)
...
HUDPoseCharge.event_pose_charge_activated = function (self, player, blackboard)
...
HUDPoseCharge.event_pose_charge_fade = function (self, t, player)
	if player == self._player then
		self._fading = true
...
HUDPoseCharge._deactivate = function (self, player)
	if player == self._player then
		self._active = false
...
HUDPoseCharge.post_update = function (self, dt, t)
...
HUDPoseCharge.destroy = function (self)
