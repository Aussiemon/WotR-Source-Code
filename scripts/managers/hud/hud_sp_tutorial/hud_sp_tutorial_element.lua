...
HUDSPTutorialtElement.init = function (self, config)
	self._width = nil
	self._height = nil
	self.config = config
end

HUDSPTutorialtElement.width = function (self)
	return self._width
end

HUDSPTutorialtElement.height = function (self)
	return self._height
end

HUDSPTutorialtElement.update_size = function (self, dt, t, gui, layout_settings)
...
HUDSPTutorialtElement.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

HUDSPTutorialtElement.render = function (self, dt, t, gui, layout_settings)
	local config = self.config
...
HUDSPTutorialtElement.create_from_config = function (config)
