...
HUDTaggingActivation.init = function (self, world, player)
...
HUDTaggingActivation.event_player_became_corporal = function (self, player)
...
HUDTaggingActivation.event_player_no_longer_corporal = function (self, player)
	if player == self._player then
		self._is_corporal = false
	end
end

HUDTaggingActivation.event_player_spawned = function (self, player)
	if player == self._player then
		self._active = true
	end
end

HUDTaggingActivation.event_player_unit_dead = function (self, player)
	if player == self._player then
		self._active = false
	end
end

HUDTaggingActivation._setup = function (self)
...
HUDTaggingActivation.post_update = function (self, dt, t)
...
HUDTaggingActivation.destroy = function (self)
