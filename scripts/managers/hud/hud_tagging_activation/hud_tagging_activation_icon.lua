...
HUDTaggingActivationIcon.init = function (self, config)
	HUDTaggingActivationIcon.super.init(self, config)
end

HUDTaggingActivationIcon.render = function (self, dt, t, gui, layout_settings)
...
HUDTaggingActivationIcon.create_from_config = function (config)
