...
HUDSpawn.init = function (self, world, player)
...
HUDSpawn.event_ingame_menu_set_active = function (self, active)
	self._ingame_menu_active = active
end

HUDSpawn._setup = function (self)
...
HUDSpawn.event_ghost_mode_activated = function (self)
	self._ghost_mode = true
end

HUDSpawn.event_ghost_mode_deactivated = function (self)
	self._ghost_mode = false
end

HUDSpawn.post_update = function (self, dt, t)
...
HUDSpawn.destroy = function (self)
