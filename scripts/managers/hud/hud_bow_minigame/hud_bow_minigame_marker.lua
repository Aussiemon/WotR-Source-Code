...
HUDBowMinigameMarker.init = function (self, config)
...
HUDBowMinigameMarker.update_position = function (self, dt, t, layout_settings, x, y, z)
...
HUDBowMinigameMarker.create_from_config = function (config)
