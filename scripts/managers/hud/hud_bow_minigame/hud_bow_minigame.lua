...
HUDBowMinigame.init = function (self, world, player)
...
HUDBowMinigame._setup_bow_minigame = function (self)
...
HUDBowMinigame.event_bow_minigame_activated = function (self, player, blackboard)
...
HUDBowMinigame.event_bow_minigame_deactivated = function (self, player)
	if player == self._player then
		self._active = false
...
HUDBowMinigame.post_update = function (self, dt, t)
...
HUDBowMinigame.destroy = function (self)
