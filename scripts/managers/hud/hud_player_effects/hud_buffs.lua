...
HUDBuffs.init = function (self, world, player)
...
HUDBuffs._setup_buff = function (self)
...
HUDBuffs.event_hud_buffs_activated = function (self, player, blackboard)
...
HUDBuffs.event_hud_buffs_deactivated = function (self, player)
	if player == self._player then
		self._active = false
...
HUDBuffs.post_update = function (self, dt, t)
...
HUDBuffs.destroy = function (self)
