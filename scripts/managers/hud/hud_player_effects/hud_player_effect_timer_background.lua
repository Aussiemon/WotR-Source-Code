...
HUDPlayerEffectTimerBackground.init = function (self, config)
	HUDPlayerEffectTimerBackground.super.init(self, config)
end

HUDPlayerEffectTimerBackground.render = function (self, dt, t, gui, layout_settings)
...
HUDPlayerEffectTimerBackground.create_from_config = function (config)
