...
HUDPlayerEffectContainerElement.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
...
HUDPlayerEffectContainerElement.create_from_config = function (config)
