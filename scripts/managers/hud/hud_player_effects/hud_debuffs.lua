...
HUDDebuffs.init = function (self, world, player)
...
HUDDebuffs._setup_debuff = function (self)
...
HUDDebuffs.event_hud_debuffs_activated = function (self, player, blackboard)
...
HUDDebuffs.event_hud_debuffs_deactivated = function (self, player)
	if player == self._player then
		self._active = true
		self._blackboard = blackboard
...
HUDDebuffs.post_update = function (self, dt, t)
...
HUDDebuffs.destroy = function (self)
