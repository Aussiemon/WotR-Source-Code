...
HUDPlayerEffectIcon.init = function (self, config)
	HUDPlayerEffectIcon.super.init(self, config)

	self._alpha_modifier = 0
end

HUDPlayerEffectIcon.render = function (self, dt, t, gui, layout_settings)
...
HUDPlayerEffectIcon.update_alpha = function (self, dt, t, gui, layout_settings)
...
HUDPlayerEffectIcon.create_from_config = function (config)
