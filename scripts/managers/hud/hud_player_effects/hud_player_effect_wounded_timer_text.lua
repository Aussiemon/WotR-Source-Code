...
HUDPlayerEffectWoundedTimerText.init = function (self, config)
	HUDPlayerEffectWoundedTimerText.super.init(self, config)
end

HUDPlayerEffectWoundedTimerText.render = function (self, dt, t, gui, layout_settings)
...
HUDPlayerEffectWoundedTimerText.create_from_config = function (config)
