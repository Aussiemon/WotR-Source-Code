...
HUDPlayerEffectTimer.init = function (self, config)
	HUDPlayerEffectTimer.super.init(self, config)
end

HUDPlayerEffectTimer.render = function (self, dt, t, gui, layout_settings)
...
HUDPlayerEffectTimer.create_from_config = function (config)
