...
HUDGameModeStatus.init = function (self, world, player)
...
HUDGameModeStatus._setup = function (self)
...
HUDGameModeStatus.event_refresh_objective = function (self)
...
HUDGameModeStatus.event_set_objective_text = function (self, objective)
	local param1, param2 = GameModeHelper:objective_parameters(objective, self._player, self._world)

	self:_set_objective_texts(self._player, objective, param1, param2)
end

HUDGameModeStatus.event_show_game_mode_status = function (self, show)
	self._show_game_mode_status = show
end

HUDGameModeStatus._update_objective = function (self, player)
...
HUDGameModeStatus._set_objective_texts = function (self, player, objective, param1, param2)
	if objective == "" then
		self._objective_text = ""
	else
...
HUDGameModeStatus.disabled_post_update = function (self, dt, t)
...
HUDGameModeStatus.post_update = function (self, dt, t)
	local player = self._player
...
HUDGameModeStatus.destroy = function (self)
