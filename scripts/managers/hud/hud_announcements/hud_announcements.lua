...
HUDAnnouncements.init = function (self, world, player)
...
HUDAnnouncements.event_local_player_stats_context_created = function (self, player)
...
HUDAnnouncements.cb_headshot = function (self)
...
HUDAnnouncements.cb_longshot = function (self, range)
...
HUDAnnouncements.cb_killstreak = function (self)
...
HUDAnnouncements.cb_multi_killstreak = function (self)
...
HUDAnnouncements.cb_mega_killstreak = function (self)
...
HUDAnnouncements.event_game_mode_side_announcement = function (self, side, announcement, param1, param2)
	if self._player.team.side == side then
		self:event_game_mode_announcement(announcement, param1, param2)
	end
end

HUDAnnouncements.event_game_mode_announcement = function (self, announcement, param1, param2)
...
HUDAnnouncements.event_player_wounded = function (self, player)
	if player == self._player then
...
HUDAnnouncements._update_game_mode_announcements = function (self, player)
...
HUDAnnouncements._add = function (self, announcement, param1, param2)
...
HUDAnnouncements._next_queue_index = function (self)
	return #self._queue + 1
end

HUDAnnouncements._update_queue = function (self, dt, t)
...
HUDAnnouncements._update_elements = function (self, dt, t)
...
HUDAnnouncements._add_element = function (self, dt, t, config)
	if config.text then
...
HUDAnnouncements.post_update = function (self, dt, t)
...
HUDAnnouncements.disabled_post_update = function (self, dt, t)
	self:_update_game_mode_announcements(self._player)
end

HUDAnnouncements.destroy = function (self)
