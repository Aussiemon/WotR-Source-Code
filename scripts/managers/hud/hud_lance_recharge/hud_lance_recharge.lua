...
HUDLanceRecharge.init = function (self, world, player)
...
HUDLanceRecharge._setup_lance_recharge = function (self)
...
HUDLanceRecharge.event_lance_recharge_activated = function (self, dt, t, player, blackboard)
...
HUDLanceRecharge.event_lance_recharge_deactivated = function (self, player)
	if player == self._player then
		self._active = false
...
HUDLanceRecharge.post_update = function (self, dt, t)
...
HUDLanceRecharge.destroy = function (self)
