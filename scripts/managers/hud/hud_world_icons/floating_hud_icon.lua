...
FloatingHUDIcon.init = function (self, blackboard, gui, unit, camera, world, config, player, player_unit, node_name)
...
FloatingHUDIcon.post_update = function (self, dt, t, layout_settings, layout_settings_2)
...
FloatingHUDIcon._draw_floating_icon = function (self, layout_settings, screen_x, screen_y, screen_z, inside_attention_zone, dt, t, state_table)
...
FloatingHUDIcon._draw_clamped_icon = function (self, layout_settings, screen_x, screen_y, screen_z, dt, t)
	local blackboard = self._blackboard
