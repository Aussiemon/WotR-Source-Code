...
HUDWorldIcons.init = function (self, world, player)
...
HUDWorldIcons.event_update_hud_objective_icons = function (self, unit, icon_name, icon_name_2)
...
HUDWorldIcons.event_objective_activated = function (self, blackboard, unit)
	if not self._floating_icons[unit] then
		self:_create_icon(blackboard, unit)
	end
end

HUDWorldIcons._create_icon = function (self, blackboard, unit)
...
HUDWorldIcons.event_objective_deactivated = function (self, unit)
	self:_destroy_icon(unit)
end

HUDWorldIcons.event_flag_spawned = function (self, blackboard, unit)
	local icon_name = Unit.get_data(unit, "hud", "icon_name")
	local layout_settings = HUDSettings.world_icons[icon_name]
...
HUDWorldIcons.event_flag_destroyed = function (self, unit)
	self:_destroy_icon(unit)
end

HUDWorldIcons.event_player_spawned = function (self, player, unit)
	if not self._floating_icons[unit] then
		local icon_name = Unit.get_data(unit, "hud", "icon_name")
		local layout_settings = HUDSettings.world_icons[icon_name]
...
HUDWorldIcons._destroy_icon = function (self, unit)
...
HUDWorldIcons.event_player_destroyed = function (self, unit)
	self:_destroy_icon(unit)
end

HUDWorldIcons.event_own_horse_spawned = function (self, player, blackboard)
...
HUDWorldIcons.event_horse_destroyed = function (self, mount_unit)
	self:_destroy_icon(mount_unit)
end

HUDWorldIcons.event_recieved_help_request = function (self, unit)
...
HUDWorldIcons.event_completed_revive = function (self, unit)
	self._floating_icons[unit].help_request_tag = nil
end

HUDWorldIcons.post_update = function (self, dt, t)
...
HUDWorldIcons._update_raycast_queue = function (self)
...
HUDWorldIcons.destroy = function (self)
