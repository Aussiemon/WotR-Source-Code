...
FloatingObjectiveHUDIcon._draw_floating_icon = function (self, layout_settings, screen_x, screen_y, screen_z, inside_attention_zone, dt, t, state_table)
...
FloatingObjectiveHUDIcon._draw_clamped_icon = function (self, layout_settings, screen_x, screen_y, screen_z, dt, t)
	local blackboard = self._blackboard
...
FloatingObjectiveHUDIcon._draw_progress_bar = function (self, position, width, height, blackboard)
