...
FloatingPlayerHUDIcon.init = function (self, gui, local_player, player_unit, camera, world, config)
	self._gui = gui
...
FloatingPlayerHUDIcon.destroy = function (self)
	self._raycast = nil
end

FloatingPlayerHUDIcon.unit = function (self)
	return self._player_unit
end

FloatingPlayerHUDIcon._init_raycast = function (self)
...
FloatingPlayerHUDIcon.post_update = function (self, dt, t, layout_settings)
...
FloatingPlayerHUDIcon._icon_screen_pos = function (self, player_unit, local_player_unit)
...
FloatingPlayerHUDIcon._player_visible_check = function (self, local_player, other_player, distance, aimed, local_player_unit, other_player_unit)
	if local_player.team == other_player.team then
...
FloatingPlayerHUDIcon.wants_line_of_sight_check = function (self)
	return self._wants_line_of_sight_check, self._player_unit
end

FloatingPlayerHUDIcon.check_line_of_sight = function (self)
	local local_player = self._local_player
	local other_player_unit = self._player_unit
...
FloatingPlayerHUDIcon._raycast_result = function (self, hit, position, distance, normal, actor)
	self._line_of_sight_check_result = not hit
end

FloatingPlayerHUDIcon._render_floating_icon = function (self, layout_settings, screen_x, screen_y, screen_z, inside_attention_zone, t, distance)
	local gui = self._gui
