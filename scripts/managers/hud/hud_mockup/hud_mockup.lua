...
HUDMockup.init = function (self, world, player, menu_world)
...
HUDMockup.event_show_profile = function (self, profile, name, death_type)
...
HUDMockup.event_hide_profile = function (self)
	self._profile_info:set_active(false)

	self._show_profile = false
end

HUDMockup.event_projectile_hit_afro = function (self, player, projectile_unit)
...
HUDMockup._update_hit_indicator = function (self, dt, t, resolution_width, resolution_height)
...
HUDMockup.post_update = function (self, dt, t)
	local resolution_width, resolution_height = Gui.resolution()
...
HUDMockup._update_interaction = function (self, dt, t, resolution_width, resolution_height)
...
HUDMockup._handle_pad_interaction_text = function (self, text)
...
HUDMockup._update_map_dump_mode = function (self, dt, t, resolution_width, resolution_height)
...
HUDMockup._update_profile_info = function (self, dt, t, resolution_width, resolution_height)
	local gui = self._gui
...
HUDMockup._update_damage_indicator = function (self, dt, t, resolution_width, resolution_height)
	local state_data = self._player.state_data
...
HUDMockup._clear_damage_indicator = function (self, key)
	local id = self[key]
...
HUDMockup._update_rush_cooldown = function (self, dt, t, resolution_width, resolution_height)
	local state_data = self._player.state_data
	local text
...
HUDMockup._update_interaction_progress = function (self, dt, t, resolution_width, resolution_height)
	local state_data = self._player.state_data
	local text
...
HUDMockup._update_reticule = function (self, dt, t, resolution_width, resolution_height)
...
HUDMockup._update_visor_overlay = function (self, dt, t, resolution_width, resolution_height)
	local state_data = self._player.state_data
...
HUDMockup.destroy = function (self)
