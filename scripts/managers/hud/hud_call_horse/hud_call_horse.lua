...
HUDCallHorse.init = function (self, world, player)
...
HUDCallHorse._setup_buff = function (self)
...
HUDCallHorse.event_hud_call_horse_activated = function (self, player, blackboard)
...
HUDCallHorse.event_hud_call_horse_deactivated = function (self, player)
...
HUDCallHorse._update_pad360 = function (self, pad_active)
	if pad_active then
...
HUDCallHorse._set_key = function (self, element, pad_active)
...
HUDCallHorse.post_update = function (self, dt, t)
...
HUDCallHorse.destroy = function (self)
