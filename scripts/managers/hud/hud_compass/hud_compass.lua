...
HUDCompass.init = function (self, world, player)
...
HUDCompass._setup_compass = function (self)
...
HUDCompass.event_objective_activated = function (self, blackboard, unit)
	if not self._compass_container:has_element(unit) then
		self:_add_unit_icon(blackboard, unit)
	end
end

HUDCompass.event_objective_deactivated = function (self, unit)
	if self._compass_container:has_element(unit) then
		self._compass_container:remove_element(unit)
	end
end

HUDCompass.event_flag_spawned = function (self, blackboard, unit)
	self:_add_unit_icon(blackboard, unit)
end

HUDCompass.event_flag_destroyed = function (self, unit)
	self._compass_container:remove_element(unit)
end

HUDCompass._add_unit_icon = function (self, blackboard, unit)
	local config = {
...
HUDCompass.post_update = function (self, dt, t)
...
HUDCompass.destroy = function (self)
