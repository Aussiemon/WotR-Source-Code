...
HUDMountChargeIcon.init = function (self, config)
	HUDMountChargeIcon.super.init(self, config)
end

HUDMountChargeIcon.render = function (self, dt, t, gui, layout_settings)
...
HUDMountChargeIcon.create_from_config = function (config)
