...
HUDMountCharge.init = function (self, world, player)
...
HUDMountCharge._setup = function (self)
...
HUDMountCharge.event_local_player_mounted = function (self, player, mount_locomotion, blackboard)
...
HUDMountCharge.event_local_player_dismounted = function (self, player)
	if player == self._player then
		self._active = false
...
HUDMountCharge._set_key = function (self, element, pad_active)
...
HUDMountCharge.post_update = function (self, dt, t)
...
HUDMountCharge.destroy = function (self)
