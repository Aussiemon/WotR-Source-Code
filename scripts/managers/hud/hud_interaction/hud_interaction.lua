...
HUDInteraction.init = function (self, world, player)
...
HUDInteraction._setup = function (self)
...
HUDInteraction.post_update = function (self, dt, t)
...
HUDInteraction._stop_looping_sounds = function (self)
...
HUDInteraction.on_deactivated = function (self)
	self:_stop_looping_sounds()
end

HUDInteraction.set_enabled = function (self, enabled)
...
HUDInteraction.destroy = function (self)
