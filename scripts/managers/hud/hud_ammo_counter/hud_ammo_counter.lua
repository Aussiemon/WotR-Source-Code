...
HUDAmmoCounter.init = function (self, world, player)
...
HUDAmmoCounter._setup_ammo_counter = function (self)
...
HUDAmmoCounter.event_hud_ammo_counter_activated = function (self, player, blackboard)
...
HUDAmmoCounter.event_hud_ammo_counter_deactivated = function (self, player)
	if player == self._player then
		self._active = false
...
HUDAmmoCounter.post_update = function (self, dt, t)
...
HUDAmmoCounter.destroy = function (self)
