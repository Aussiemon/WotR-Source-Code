...
HUDCrossbowMinigameCross.init = function (self, config)
	HUDCrossbowMinigameCross.super.init(self, config)

	self._circle_radius = 93
end

HUDCrossbowMinigameCross.update_position = function (self, dt, t, layout_settings, x, y, z)
...
HUDCrossbowMinigameCross.render = function (self, dt, t, gui, layout_settings)
...
HUDCrossbowMinigameCross.create_from_config = function (config)
