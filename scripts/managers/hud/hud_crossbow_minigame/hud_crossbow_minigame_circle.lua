...
HUDCrossbowMinigameCircle.init = function (self, config)
	HUDCrossbowMinigameCircle.super.init(self, config)
end

HUDCrossbowMinigameCircle.update_position = function (self, dt, t, layout_settings, x, y, z)
...
HUDCrossbowMinigameCircle._random_circle_shake = function (self)
	local num = 0.75
...
HUDCrossbowMinigameCircle.create_from_config = function (config)
