...
HUDCrossbowMinigame.init = function (self, world, player)
...
HUDCrossbowMinigame._setup_crossbow_minigame = function (self)
...
HUDCrossbowMinigame.event_crossbow_minigame_activated = function (self, dt, t, player, blackboard)
...
HUDCrossbowMinigame.event_crossbow_minigame_deactivated = function (self, player)
	if player == self._player then
		self._active = false
...
HUDCrossbowMinigame.post_update = function (self, dt, t)
...
HUDCrossbowMinigame.destroy = function (self)
