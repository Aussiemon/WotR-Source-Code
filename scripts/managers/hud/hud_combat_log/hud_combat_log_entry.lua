...
HUDCombatLogEntry.init = function (self, config)
	self.config = config
...
HUDCombatLogEntry.set_entry_data = function (self, attacking_player, victim_player, gear_name)
...
HUDCombatLogEntry.width = function (self)
	return self._width
end

HUDCombatLogEntry.height = function (self)
	return self._height
end

HUDCombatLogEntry.update_size = function (self, dt, t, gui, layout_settings)
	self._width = layout_settings.width
	self._height = layout_settings.height
end

HUDCombatLogEntry.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

HUDCombatLogEntry.render = function (self, dt, t, gui, layout_settings)
...
HUDCombatLogEntry.create_from_config = function (config)
