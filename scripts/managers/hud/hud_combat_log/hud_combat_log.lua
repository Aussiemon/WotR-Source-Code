...
HUDCombatLog.init = function (self, world, player)
...
HUDCombatLog._setup = function (self)
...
HUDCombatLog.event_update_combat_log = function (self, attacking_player, victim_player, gear_name)
	self:add_entry(attacking_player, victim_player, gear_name)
end

HUDCombatLog.add_entry = function (self, attacking_player, victim_player, gear_name)
...
HUDCombatLog.post_update = function (self, dt, t)
...
HUDCombatLog.destroy = function (self)
