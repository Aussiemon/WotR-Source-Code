...
SynchedShot.init = function (self, target)
	self._target = Vector3Box(target)
end

SynchedShot.cb_fire_result = function (self, unit, aim_x, aim_y, aim_z, hit, position, distance, normal, actor)
...
SynchedShot.exec = function (self, group, units)
