...
GroupManager.init = function (self, world)
	self._world = world
	self._groups = {}
...
GroupManager.flow_cb_create_group = function (self, player_name, group_name, formation_definition)
...
GroupManager.flow_cb_ai_move_group = function (self, player_name, group_name, target_unit, on_arrived_event_name)
	fassert(player_name, "Player name can't be nil")
	fassert(group_name, "Group name can't be nil")
...
GroupManager.create = function (self, player_index, name, formation, pos, rot)
...
GroupManager.exists = function (self, player_index, name)
...
GroupManager.group = function (self, player_index, name)
...
GroupManager.update = function (self, dt, t)
