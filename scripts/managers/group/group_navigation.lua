...
GroupNavigation.init = function (self, world, locomotion)
...
GroupNavigation.move_to = function (self, wanted_pos, flow_event_name)
...
GroupNavigation._arrived = function (self)
