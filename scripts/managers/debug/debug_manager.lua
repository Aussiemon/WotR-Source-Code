...
DebugManager.update = function (self, dt)
...
DebugManager.enable_actor_draw = function (self, actor, color)
...
DebugManager.disable_actor_draw = function (self, actor)
	local actors = self._actors
...
DebugManager.enable_overlap_actor_draw = function (self, collision_filter, color, range)
	self._actor_drawer = self:drawer({
		mode = "immediate",
		name = "_actor_drawer"
	})
