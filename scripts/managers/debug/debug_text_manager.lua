...
DebugTextManager.init = function (self, world)
	self._world = world
...
DebugTextManager.network_output_unit_text = function (self, text_id, text_size, unit, node_index, offset, time, category, color, viewport_name)
...
DebugTextManager.output_unit_text = function (self, text, text_size, unit, node_index, offset, time, category, color, viewport_name)
...
DebugTextManager.network_output_world_text = function (self, text_id, text_size, position, time, category, color)
	local network_manager = Managers.state.network
...
DebugTextManager.output_world_text = function (self, text, text_size, position, time, category, color)
...
DebugTextManager.network_output_screen_text = function (self, text_id, text_size, time, color)
	local network_manager = Managers.state.network
