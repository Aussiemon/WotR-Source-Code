...
ProjectileManager.init = function (self, world)
	self._world = world
...
ProjectileManager.destroy = function (self)
...
ProjectileManager.update = function (self, dt, t)
	return
end

ProjectileManager.remove_linked_projectile = function (self, unit)
	self:_remove_projectile(unit)
end

ProjectileManager.remove_projectiles = function (self, owner)
...
ProjectileManager.spawn_projectile = function (self, player_index, user_unit, weapon_unit, projectile_name_id, gear_name_id, position, exit_velocity, gravity_multiplier, damage_multiplier, properties_id)
...
ProjectileManager.link_projectile = function (self, hit_unit, node_index, position, rotation, damage, penetrated, target_type, projectile_unit, local_projectile, hit_zone, impact_direction, normal)
	local network_manager = Managers.state.network
...
ProjectileManager.clear_projectiles = function (self, from_unit)
...
ProjectileManager._remove_projectile = function (self, unit)
	World.destroy_unit(self._world, unit)
end

ProjectileManager.drop_projectile = function (self, hit_unit, position, rotation, damage, penetrated, target_type, projectile_unit, local_projectile, hit_zone, impact_direction, normal)
	local network_manager = Managers.state.network
