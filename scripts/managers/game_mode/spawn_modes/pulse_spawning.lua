...
PulseSpawning.init = function (self, settings, game_mode)
	PulseSpawning.super.init(self, settings, game_mode)

	self._round_started = false
end

PulseSpawning.round_started = function (self)
...
PulseSpawning.next_spawn_time = function (self, player)
...
PulseSpawning.update = function (self)
