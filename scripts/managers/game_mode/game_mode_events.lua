...
GameModeEvents.init = function (self, world, player)
	self._world = world
	self._player = player
...
GameModeEvents.event_flag_planted = function (self, planter_player, interactable_unit)
...
GameModeEvents.event_objective_captured = function (self, capuring_player, captured_unit)
...
GameModeEvents._trigger_timpani_event = function (self, gm_event)
