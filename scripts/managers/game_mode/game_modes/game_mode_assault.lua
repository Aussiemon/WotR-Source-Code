...
GameModeAssault.init = function (self, settings, world, ...)
...
GameModeAssault.evaluate_end_conditions = function (self)
...
GameModeAssault.gm_event_time_extended = function (self, side, seconds)
...
GameModeAssault.gm_event_assault_announcement = function (self, side, announcement)
	Managers.state.event:trigger("game_mode_side_announcement", side, announcement)
end

GameModeAssault.gm_event_flag_planted = function (self, planter_player, interactable_unit)
...
GameModeAssault.gm_event_objective_captured = function (self, capuring_player, captured_unit)
...
GameModeAssault.objective = function (self, local_player)
...
GameModeAssault.hud_score_text = function (self, team_name)
	return ""
end

GameModeAssault.hud_progress = function (self, local_player)
	local team_manager = Managers.state.team
...
GameModeAssault.hot_join_synch = function (self, sender, player)
