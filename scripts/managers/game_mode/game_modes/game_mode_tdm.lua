...
GameModeTDM.init = function (self, settings, world, ...)
	GameModeTDM.super.init(self, settings, world, ...)
end

GameModeTDM.evaluate_end_conditions = function (self)
...
GameModeTDM.objective = function (self, local_player)
...
GameModeTDM.own_score_announcement = function (self, local_player)
	local announcement = ""
...
GameModeTDM.enemy_score_announcement = function (self, local_player)
...
GameModeTDM.hud_score_text = function (self, team_name)
	return Managers.state.team:team_by_name(team_name).score
end

GameModeTDM.hud_progress = function (self, local_player)
