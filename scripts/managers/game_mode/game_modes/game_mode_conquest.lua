...
GameModeConquest.init = function (self, settings, world, ...)
...
GameModeConquest.evaluate_end_conditions = function (self)
...
GameModeConquest.gm_event_flag_planted = function (self, planter_player, interactable_unit)
...
GameModeConquest.gm_event_objective_captured = function (self, capuring_player, captured_unit)
...
GameModeConquest.objective = function (self, local_player)
...
GameModeConquest.own_score_announcement = function (self, local_player)
	local announcement = ""
...
GameModeConquest.enemy_score_announcement = function (self, local_player)
...
GameModeConquest.own_capture_point_announcement = function (self, local_player)
...
GameModeConquest.enemy_capture_point_announcement = function (self, local_player)
	local enemy_team_name = local_player.team.name == "red" and "white" or "red"
...
GameModeConquest.hud_score_text = function (self, team_name)
	return Managers.state.game_mode:num_owned_objectives(team_name)
end

GameModeConquest.hud_progress = function (self, local_player)
