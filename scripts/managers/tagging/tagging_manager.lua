...
TaggingManager.init = function (self, world)
	self._world = world
	self._tags = {}
...
TaggingManager.event_remote_player_destroyed = function (self, player)
	self:_remove_tag(player, "player_disconect")
end

TaggingManager.event_player_no_longer_corporal = function (self, player)
	self:_remove_tag(player, "player_no_longer_corporal")
end

TaggingManager.event_player_unit_dead = function (self, player)
	self:_remove_tag(player, "player_unit_dead")
end

TaggingManager.update = function (self, dt, t)
...
TaggingManager.can_tag_player_unit = function (self, player, tagged_unit)
...
TaggingManager.can_tag_objective = function (self, player, tagged_unit)
	local tagger_unit = player.player_unit
...
TaggingManager.add_player_unit_tag = function (self, tagging_player, tagged_unit, end_time)
...
TaggingManager.add_objective_tag = function (self, tagging_player, tagged_unit, end_time)
	local tags = self._tags
...
TaggingManager._remove_tag = function (self, player, reason)
...
TaggingManager.tagger_by_tagged_unit = function (self, tagged_unit)
