...
AutoRules.init = function (self, settings)
	self._auto_rules = {}
...
AutoRules.event_player_joined = function (self, player)
...
AutoRules.update = function (self, dt, t)
	for _, rule in pairs(self._auto_rules) do
