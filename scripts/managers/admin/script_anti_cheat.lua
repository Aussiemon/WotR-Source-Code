...
ScriptAntiCheat.init = function (self, settings)
...
ScriptAntiCheat.cb_peer_status_changed = function (self, peer, status)
...
ScriptAntiCheat._set_authorized = function (self, peer, authorized)
	if authorized then
...
ScriptAntiCheat.register_peer = function (self, peer, key)
...
ScriptAntiCheat.unregister_peer = function (self, peer)
	if not self._enforce then
		return
	end
...
ScriptAntiCheat.update = function (self, dt, t)
