...
AreaBuffManager.init = function (self, world)
	self._world = world
	self._buff_sources = {}
	self._eligible_targets = {}
end

AreaBuffManager.update = function (self, dt, t)
...
AreaBuffManager._remove_source = function (self, source_name)
	local eligible_targets = self._eligible_targets
	local buff_sources = self._buff_sources
...
AreaBuffManager.create_area_buff = function (self, unit, buff_type, level_calculation_function, eligible_targets_function, duration, shape, radius, source_name)
	local buff_sources = self._buff_sources
...
AreaBuffManager.affected_targets = function (self, source_name)
	return self._buff_sources[source_name].directly_affected_targets
end

AreaBuffManager._clear_eligible_target = function (self, eligible_target, buff_type, source_name)
	local eligible_targets = self._eligible_targets
...
AreaBuffManager.destroy = function (self)
	return
end
