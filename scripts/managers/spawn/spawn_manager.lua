...
SpawnManager.init = function (self, world)
	self._world = world
	self._spawn_areas = {}
...
SpawnManager.event_team_set = function (self, player)
	if player.team and (Managers.lobby.server or not Managers.lobby.lobby) then
		self:set_spawn_timer(player)
	end
end

SpawnManager.event_player_knocked_down = function (self, knocked_down_player, attacking_player, gear_name, damagers, damage_type)
	if Managers.lobby.server or not Managers.lobby.lobby then
		self:set_spawn_timer(knocked_down_player)
	end
end

SpawnManager.event_player_instakilled = function (self, instakilled_player, attacking_player, gear_name, damagers, damage_type)
	if Managers.lobby.server or not Managers.lobby.lobby then
		self:set_spawn_timer(instakilled_player)
	end
end

SpawnManager.event_player_unit_dead = function (self, player)
...
SpawnManager.set_spawn_timer = function (self, player)
...
SpawnManager.activate_editor_spawnpoint = function (self, unit)
	self._editor_spawn_point = unit
end

SpawnManager.create_spawn_area = function (self, name, volumes)
...
SpawnManager.activate_spawn_area = function (self, name, team_name, spawn_direction)
...
SpawnManager.deactivate_spawn_area = function (self, name, team_name)
...
SpawnManager.activate_sp_spawn_area = function (self, name, team_name, spawn_direction, spawn_profile)
	if self._active_spawn_areas_per_team[team_name][name] then
		printf("Trying to activate spawn area %s for side %s that is already activated.", name, team_name)
	end
...
SpawnManager.deactivate_sp_spawn_area = function (self, name, team_name)
	if not self._active_spawn_areas_per_team[team_name][name] then
		printf("Trying to deactivate spawn area %s for side %s that is already deactivated.", name, team_name)
	end
...
SpawnManager.set_spawn_area_priority = function (self, name, team_name, priority)
	fassert(self._spawn_areas[name], "Trying to activate spawn area %s that doesn't exist.", name)
...
SpawnManager.spawn_area_with_highest_priority = function (self, team_name)
	local active_areas = {}
...
SpawnManager.random_area_name = function (self, team_name)
	local active_areas = {}
...
SpawnManager.activate_spawning = function (self)
	self._spawning = true
end

SpawnManager.deactivate_spawning = function (self)
	self._spawning = false
end

SpawnManager.spawn_areas = function (self)
	return self._spawn_areas
end

SpawnManager.active_spawn_areas = function (self, team_name)
	return self._active_spawn_areas_per_team[team_name]
end

SpawnManager.set_unconfirmed_squad_spawn_target = function (self, player, squad_unit)
	if Managers.lobby.server or not Managers.lobby.lobby then
...
SpawnManager.rpc_request_unconf_squad_spawn = function (self, player, squad_unit)
	self:set_unconfirmed_squad_spawn_target(player, squad_unit)
end

SpawnManager.rpc_unconf_sq_spawn_target_set = function (self, player, squad_unit)
	player.spawn_data.mode = "unconfirmed_squad_member"
	player.spawn_data.squad_unit = squad_unit
end

SpawnManager.set_squad_spawn_target = function (self, player, squad_unit)
	if Managers.lobby.server or not Managers.lobby.lobby then
...
SpawnManager.rpc_request_squad_spawn_target = function (self, player, squad_unit)
	self:set_squad_spawn_target(player, squad_unit)
end

SpawnManager.rpc_squad_spawn_target_set = function (self, player, squad_unit)
	player.spawn_data.mode = "squad_member"
	player.spawn_data.squad_unit = squad_unit
end

SpawnManager.set_area_spawn_target = function (self, player, area_name)
	if Managers.lobby.server or not Managers.lobby.lobby then
...
SpawnManager.rpc_request_area_spawn_target = function (self, player, area_name_network_lookup)
	local area_name = self:network_lookup_to_area_name(area_name_network_lookup)

	self:set_area_spawn_target(player, area_name)
end

SpawnManager.network_lookup_to_area_name = function (self, network_lookup)
...
SpawnManager._update_spawn = function (self, dt, t)
...
SpawnManager.force_spawn = function (self)
	local network_game = Managers.state.network:game()
...
SpawnManager._update_sp_spawn = function (self, spawn_data)
...
SpawnManager.spawn_timer = function (self, player)
...
SpawnManager.allowed_to_leave_ghost_mode = function (self, player)
...
SpawnManager.request_leave_ghost_mode = function (self, player, ghost_player_unit)
	if Managers.lobby.server or not Managers.lobby.lobby then
...
SpawnManager._leave_ghost_mode = function (self, player, ghost_player_unit)
...
SpawnManager._force_leave_ghost_mode = function (self, player)
...
SpawnManager.rpc_request_leave_ghost_mode = function (self, sender, player, ghost_player_unit)
...
SpawnManager.rpc_leave_ghost_mode = function (self, player, player_unit)
	self:_leave_ghost_mode(player, player_unit)
end

SpawnManager._check_spawn = function (self, player, spawn_data)
...
SpawnManager.valid_squad_spawn_target = function (self, player, squad_unit, verbose)
...
SpawnManager.valid_area_spawn_target = function (self, player, area_name)
...
SpawnManager.valid_spawn_areas_per_team = function (self, team_name)
	return self._active_spawn_areas_per_team[team_name]
end

SpawnManager.valid_squad_spawn_targets_per_team = function (self, team_name)
...
SpawnManager._spawn_player_unit_in_area = function (self, player, area_name)
...
SpawnManager._spawn_player_unit_at_unit = function (self, player, squad_unit, override_combat_check)
...
SpawnManager._squad_spawn_sanity_check = function (self, pos, squad_unit_pos)
	local world = self._world
	local physics_world = World.physics_world(world)
	local drawer = Managers.state.debug:drawer({
		mode = "retained",
...
SpawnManager.calculate_valid_squad_spawn_point = function (self, player, squad_unit, override_combat_check)
...
SpawnManager.spawn_mount = function (self, mount_profile, pos, rot, player_unit, ghost_mode)
...
SpawnManager.rpc_spawn_player_unit = function (self, player, pos, rot, ghost_mode, profile_index)
	self:_spawn_player_unit(player, pos, rot, ghost_mode, profile_index)
end

SpawnManager._spawn_player_unit = function (self, player, pos, rot, ghost_mode, profile_index)
	local spawn_data = player.spawn_data
...
SpawnManager.rpc_player_unit_despawned = function (self, player)
	self:despawn_player_unit(player)
end

SpawnManager.despawn_player_unit = function (self, player)
...
SpawnManager._update_spawn_editor_simulation = function (self, dt, t)
	local player_manager = Managers.player
...
SpawnManager.hot_join_synch = function (self, sender, player)
