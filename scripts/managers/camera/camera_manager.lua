...
CameraManager.shading_callback = function (self, world, shading_env)
...
CameraManager.change_environment = function (self, name, time)
	if time == 0 then
...
CameraManager._update_environment_transitions = function (self, dt)
...
CameraManager._apply_environment_transitions = function (self, dt, transition, shading_settings, weight)
...
CameraManager.aim_raycast_position = function (self, viewport_name)
...
CameraManager.add_aim_raycast = function (self, world, viewport_name)
...
CameraManager.remove_aim_raycast = function (self, viewport_name)
...
CameraManager.update = function (self, dt, viewport_name)
...
CameraManager.post_update = function (self, dt, viewport_name)
...
CameraManager._update_aim_raycast_position = function (self, viewport_name)
...
CameraManager.aim_raycast_result = function (self, hit, pos, distance, normal, actor, viewport_name)
	if hit then
...
CameraManager._set_default_aim_position = function (self, viewport_name)
	local camera_position = self:camera_position(viewport_name)
	local camera_rotation = self:camera_rotation(viewport_name)
...
CameraManager.camera_effect_shake_event = function (self, event, start_time)
	local data = {}
...
CameraManager._update_camera = function (self, dt, viewport_name)
...
CameraManager._update_camera_properties = function (self, camera, current_node, camera_data, viewport_name)
