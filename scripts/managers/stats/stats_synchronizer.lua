...
StatsSynchronizer.init = function (self, stats_collection)
...
StatsSynchronizer.update = function (self, dt, t, network_game)
...
StatsSynchronizer.event_player_stats_object_created = function (self, network_game, player, stat_game_object_id)
...
StatsSynchronizer._client_update = function (self, network_game)
...
StatsSynchronizer._server_update = function (self, network_game)
	for _, player in pairs(self._players) do
		local network_id = player:network_id()
		local game_object_id = player.stat_game_object_id
