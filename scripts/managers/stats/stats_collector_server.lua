...
StatsCollectorServer.init = function (self, stats_collection)
...
StatsCollectorServer.event_anti_cheat_status_changed = function (self, peer_id, status)
...
StatsCollectorServer.event_anti_cheat_connect = function (self, peer_id)
	self._stats:increment(peer_id, "anti_cheat_connects", 1)
end

StatsCollectorServer.event_anti_cheat_kick = function (self, peer_id)
	self._stats:increment(peer_id, "anti_cheat_kicks", 1)
end

StatsCollectorServer.event_player_self_kd = function (self, player)
...
StatsCollectorServer.event_player_team_kd = function (self, victim, attacker, gear_name, damage_type)
...
StatsCollectorServer.event_player_enemy_kd = function (self, victim, attacker, gear_name, damagers)
	local victim_id, attacker_id = victim:network_id(), attacker:network_id()
...
StatsCollectorServer.event_enemy_kill_within_objective = function (self, attacker)
...
StatsCollectorServer.event_player_self_kill = function (self, player, damage_type)
	local player_id = player:network_id()
...
StatsCollectorServer.event_player_team_kill = function (self, victim, attacker, gear_name, is_instakill)
...
StatsCollectorServer.event_player_enemy_kill = function (self, victim, attacker, gear_name, is_instakill, damagers)
	local victim_id, attacker_id = victim:network_id(), attacker:network_id()
...
StatsCollectorServer._player_killed = function (self, victim, attacker, gear_name, damagers, is_instakill)
	local victim_id, attacker_id = victim:network_id(), attacker:network_id()
...
StatsCollectorServer.event_player_parried = function (self, hit_gear_unit, gear_unit)
...
StatsCollectorServer.player_revived = function (self, revivee, reviver)
...
StatsCollectorServer.player_self_bandage = function (self, player)
	return
end

StatsCollectorServer.player_team_bandage = function (self, bandagee, bandager)
...
StatsCollectorServer.player_self_damage = function (self, player, damage, gear_name, hit_zone, damage_range_type, mirrored)
	if mirrored then
		self:player_team_damage(player, player, damage, gear_name, hit_zone)
	end
end

StatsCollectorServer.player_team_damage = function (self, damagee, damager, damage, gear_name, hit_zone)
...
StatsCollectorServer.player_enemy_damage = function (self, damagee, damager, damage, gear_name, hit_zone, damage_range_type, range)
...
StatsCollectorServer.mount_stray_kill = function (self, attacker)
	return
end

StatsCollectorServer.mount_team_kill = function (self, attacker, rider)
	return
end

StatsCollectorServer.mount_enemy_kill = function (self, attacker, rider)
	self._stats:increment(attacker:network_id(), "enemy_mount_kills", 1)
end

StatsCollectorServer.player_self_dotted = function (self, victim, attacker, damage_type)
	return
end

StatsCollectorServer.player_team_dotted = function (self, victim, attacker, damage_type)
	return
end

StatsCollectorServer.player_enemy_dotted = function (self, victim, attacker, damage_type)
	return
end

StatsCollectorServer.event_player_spawned_at_unit = function (self, player, squad_player)
...
StatsCollectorServer.weapon_missed = function (self, player, gear_name)
	self._stats:increment(player:network_id(), "weapon_stats", gear_name, "misses", 1)
end

StatsCollectorServer.objective_captured = function (self, capturing_player)
...
StatsCollectorServer.objective_captured_assist = function (self, assist_player)
...
StatsCollectorServer.section_cleared_payload = function (self, assist_player)
	local player_id = assist_player:network_id()
...
StatsCollectorServer._gain_xp_and_coins = function (self, player, reason, xp_amount, coin_amount)
...
StatsCollectorServer._penalty = function (self, player, reason, amount)
...
StatsCollectorServer.round_finished = function (self, game_mode_key, winning_team)
	local scores = {
		red = {},
		white = {},
		all = {}
