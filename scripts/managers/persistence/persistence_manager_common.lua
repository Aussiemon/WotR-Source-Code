...
PersistenceManagerCommon.init = function (self)
	self._entity_types = {}
end

PersistenceManagerCommon.is_unlock_owned = function (self, unlock)
	return IsUnlockOwned[unlock.category](unlock)
end

PersistenceManagerCommon.process_unlocks = function (self, player_backend_profile_id, unlocks, cb)
	local entities = {}
...
PersistenceManagerCommon.cb_unlocks_processed = function (self, player_backend_profile_id, cb, unlocked_entities, response)
...
PersistenceManagerCommon._parse_profile_attributes = function (self, attributes)
...
PersistenceManagerCommon._parse_profile_entities = function (self, entities)
...
PersistenceManagerCommon._parse_entity_types = function (self, entity_types)
...
PersistenceManagerCommon.update = function (self, t, dt)
	return
end
