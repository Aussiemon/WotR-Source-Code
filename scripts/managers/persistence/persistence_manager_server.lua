...
PersistenceManagerServer.init = function (self, settings)
...
PersistenceManagerServer.post_init = function (self)
...
PersistenceManagerServer.connect = function (self)
...
PersistenceManagerServer.cb_connected = function (self, response)
...
PersistenceManagerServer.cb_authenticated = function (self, response)
	if response.error == nil then
...
PersistenceManagerServer.cb_profile_created = function (self, response)
	if response.error == nil then
...
PersistenceManagerServer.cb_profile_selected = function (self, response)
	if response.error == nil then
		cprint("[Backend]", "Fetching entity types...")
...
PersistenceManagerServer.cb_entity_types_fetched = function (self, response)
	if response.error == nil then
...
PersistenceManagerServer.set_save_progress = function (self, flag)
	self._settings.save_progress = flag
end

PersistenceManagerServer.setup = function (self, stats_collection)
...
PersistenceManagerServer.event_player_joined = function (self, player)
...
PersistenceManagerServer.cb_profile_attributes_received = function (self, profile_id, player, response)
	if response.error == nil then
...
PersistenceManagerServer.cb_profile_entities_received = function (self, profile_id, player, response)
	if response.error == nil then
...
PersistenceManagerServer.save = function (self, callback)
...
PersistenceManagerServer._check_requirements = function (self)
...
PersistenceManagerServer._save_profiles = function (self)
...
PersistenceManagerServer._save_telemetry = function (self)
	for profile_id, profile_data in pairs(self._profiles) do
		self._telemetry:save_round(profile_data.player)
	end
end

PersistenceManagerServer.cb_stats_saved = function (self, response)
	if response.error == nil then
		printf("Stats saved")
	else
...
PersistenceManagerServer.cb_attributes_saved = function (self, player, response)
	if response.error == nil then
...
PersistenceManagerServer.update = function (self, t, dt)
...
PersistenceManagerServer.destroy = function (self)
