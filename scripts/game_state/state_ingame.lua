...
StateIngame.event_apply_max_fps_cap = function (self, max_fps)
	if max_fps == 0 then
...
StateIngame.shading_callback = function (self, world, shading_env)
...
StateIngame.spawn_unit = function (self, world, unit, ...)
	Managers.state.entity:register_unit(world, unit, ...)
end

StateIngame.unspawn_unit = function (self, u)
	Managers.state.entity:unregister_unit(u)
end

StateIngame._setup_input = function (self)
	local input = Managers.input
...
StateIngame._release_input = function (self)
	local input = Managers.input
...
StateIngame.update = function (self, dt)
...
StateIngame._check_game_licenses = function (self, dt, t)
...
StateIngame.game_start_countdown = function (self)
	return self._game_start_countdown
end

StateIngame.event_level_ended = function (self, end_of_round_only)
...
StateIngame._save_reload_level_loading_context = function (self)
...
StateIngame.on_exit = function (self)
	for _, machine in pairs(self.machines) do
		machine:destroy()
	end
...
StateIngame._clear_players = function (self)
	local input = Managers.input
	local player_manager = Managers.player
...
StateIngame._release_level_resources = function (self)
	local level_key = self._level_key
...
StateIngame.setup_state_context = function (self, reload_level_context)
...
StateIngame._teardown_state_context = function (self)
...
StateIngame.event_start_round = function (self)
	self._start_round = true
end

StateIngame.spawn_allowed = function (self)
	return self._spawning
end

StateIngame.event_player_created = function (self, player)
...
StateIngame.event_next_level = function (self)
	self.load_next_level = true
end

StateIngame.event_reload_level = function (self)
	self.reload_level = true
end

StateIngame.event_change_level = function (self, level_key, map_settings)
	self.change_level = {
		countdown = 3,
		name = level_key,
...
StateIngame.event_kicked_from_game = function (self, msg)
	self.parent.loading_context.leave_reason = "You were kicked (" .. msg .. ")."
end

StateIngame.event_daily_win_bonus_awarded = function (self, amount)
	Managers.sale_popup:create_daily_award_item(amount)
end

StateIngame.event_round_win_bonus_awarded = function (self, amount)
