...
StateMenuMain.on_enter = function (self, params)
...
StateMenuMain.on_exit = function (self)
	self._menu:destroy()
...
StateMenuMain.update = function (self, dt, t)
...
StateMenuMain.event_restart_game = function (self)
...
StateMenuMain._stop_all_sounds = function (self)
...
StateMenuMain.exit_game = function (self)
	self.parent.parent.quit_game = not EDITOR_LAUNCH
end

StateMenuMain.single_player_start = function (self, level_key)
...
StateMenuMain.menu_cancel_to = function (self, page_id)
