...
StateInviteJoin.on_enter = function (self)
	self._failed = false
	self._fail_reason = ""
...
StateInviteJoin.setup_state_context = function (self)
	Managers.state.network = MenuNetworkManager:new(self, Managers.lobby.lobby)
end

StateInviteJoin.update = function (self, dt)
...
StateInviteJoin.event_denied_to_enter_game = function (self, reason)
	self._failed = true
	self._fail_reason = reason and L("menu_reason_" .. reason) or ""
end

StateInviteJoin.on_exit = function (self)
