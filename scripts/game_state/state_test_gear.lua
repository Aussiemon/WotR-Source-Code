...
StateTestGear.on_enter = function (self)
...
StateTestGear._setup_world = function (self)
...
StateTestGear._load_level = function (self)
...
StateTestGear._setup_profile_viewer = function (self)
...
StateTestGear._setup_state_context = function (self)
...
StateTestGear._setup_variables = function (self)
...
StateTestGear.shading_callback = function (self, world, shading_env)
	Managers.state.camera:shading_callback(world, shading_env)
end

StateTestGear.update = function (self, dt, t)
...
StateTestGear._index_items = function (self, in_table)
	local items = {}
...
StateTestGear._get_gear_attachments = function (self, attachments)
	local temp = 3
...
StateTestGear._stringify_attachment_table = function (self, attachment_table)
	local str = ""
...
StateTestGear._update_gear = function (self)
...
StateTestGear._verify_item_list = function (self)
...
StateTestGear.post_update = function (self, dt)
	Managers.state.camera:post_update(dt, self._viewport_name)
end

StateTestGear._update_managers = function (self, dt)
	Managers.state.camera:update(dt, self._viewport_name)
end

StateTestGear._render = function (self, dt, t, layout_settings)
	self._profile_viewer:render(dt, t, nil, layout_settings)
end

StateTestGear._update_input = function (self)
...
StateTestGear._update_size = function (self, dt, t, layout_settings)
	self._profile_viewer:update_size(dt, t, self._gui, layout_settings.profile_viewer)
end

StateTestGear._update_position = function (self, dt, t, layout_settings)
...
StateTestGear.on_exit = function (self)
	World.destroy_gui(self._world, self._gui)
	Managers.world:destroy_world(self._world)
end

StateTestGear._setup_default_profile = function (self)
