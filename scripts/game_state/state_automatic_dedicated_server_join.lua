...
StateAutomaticDedicatedServerJoin.on_enter = function (self)
...
StateAutomaticDedicatedServerJoin.update = function (self, dt)
...
StateAutomaticDedicatedServerJoin.on_exit = function (self)
	Managers.state:destroy()
end

StateAutomaticDedicatedServerJoin.setup_state_context = function (self)
