...
StateSplashScreen.event_menu_camera_dummy_spawned = function (self, name, unit)
	self._camera_dummy_units[name] = unit
end

StateSplashScreen.event_menu_alignment_dummy_spawned = function (self, name, unit)
	self._alignment_dummy_units[name] = unit
end

StateSplashScreen._setup_state_context = function (self)
	Managers.state.event = EventManager:new()
end

StateSplashScreen._setup_splash_screen_menu = function (self)
...
StateSplashScreen._setup_input = function (self)
...
StateSplashScreen._release_input = function (self)
	local im = Managers.input
...
StateSplashScreen._setup_menu = function (self)
...
StateSplashScreen._destroy_menu = function (self)
...
StateSplashScreen._next_state = function (self)
...
StateSplashScreen._check_dependencies = function (self)
...
StateSplashScreen._load_finished = function (self)
...
StateSplashScreen._unload_packages = function (self)
...
StateSplashScreen._load_packages = function (self)
	for i, name in ipairs(StateSplashScreen.packages_to_load) do
		if PackageManager:has_loaded(name) then
...
StateSplashScreen.cb_package_loaded = function (self, package_num)
...
StateSplashScreen._load_save_data = function (self)
	Managers.save:auto_load(SaveFileName, callback(self, "cb_save_data_loaded"))
end

StateSplashScreen.cb_save_data_loaded = function (self, info)
	if info.error then
...
StateSplashScreen.cb_backend_setup = function (self, error_code)
...
StateSplashScreen.cb_profile_loaded = function (self, profile_data)
...
StateSplashScreen.cb_market_loaded = function (self, market)
	if market == nil then
		self._is_fatal = true
...
StateSplashScreen.cb_store_loaded = function (self, store)
	if store == nil then
...
StateSplashScreen._load_menu_level = function (self)
...
StateSplashScreen.cb_menu_level_package_loaded = function (self)
...
StateSplashScreen._load_changelog = function (self)
...
StateSplashScreen.cb_changelog_loaded = function (self, info)
	self._changelog_loaded = true
...
StateSplashScreen.cb_error_popup_enter = function (self, args)
...
StateSplashScreen.cb_error_popup_item_selected = function (self, args)
...
StateSplashScreen._show_changelog = function (self)
...
StateSplashScreen.cb_changelog_popup_enter = function (self, args)
	Window.set_show_cursor(true)
...
StateSplashScreen.cb_changelog_popup_item_selected = function (self, args)
...
StateSplashScreen.cb_goto = function (self, id)
	self._splash_screen_menu:cb_goto(id)
end

StateSplashScreen.cb_goto_next_splash_screen = function (self)
	self._splash_screen_menu:current_page():goto_first_items_page()
end

StateSplashScreen.cb_goto_main_menu = function (self)
	self._wanted_state = self:_get_wanted_state()
end

StateSplashScreen._get_wanted_state = function (self)
	return self.parent.loading_context.invite_type and StateInviteJoin or StateMenu
end

StateSplashScreen.on_exit = function (self)
...
StateSplashScreen.event_coin_dlc_purchased = function (self, coins)
