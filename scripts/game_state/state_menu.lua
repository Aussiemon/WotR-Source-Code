...
StateMenu.on_enter = function (self)
...
StateMenu._setup_input = function (self, param_block)
...
StateMenu._release_input = function (self)
	local im = Managers.input
...
StateMenu.update = function (self, dt)
...
StateMenu.post_update = function (self, dt)
	Managers.state.camera:post_update(dt, "menu_level_viewport")
end

StateMenu.cb_transition_fade_in_done = function (self, new_state)
	self._new_state = new_state
end

StateMenu.set_new_state = function (self, new_state)
	self._new_state = new_state
end

StateMenu.on_exit = function (self)
...
StateMenu.setup_state_context = function (self)
