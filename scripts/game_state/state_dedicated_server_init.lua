...
StateDedicatedServerInit.on_enter = function (self)
...
StateDedicatedServerInit.update = function (self, dt)
	local lobby_manager = Managers.lobby
...
StateDedicatedServerInit.setup_state_context = function (self)
