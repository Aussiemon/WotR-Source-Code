...
StateLoading.game_start_countdown = function (self)
...
StateLoading._update_loading_state = function (self, dt, t)
...
StateLoading._update_game_start_countdown_tick = function (self)
...
StateLoading._update_time_in_loading_screen = function (self, dt)
...
StateLoading._check_enter_game = function (self)
...
StateLoading._async_package_loaded_callback = function (self, package_name)
...
StateLoading._setup_package_loading = function (self)
...
StateLoading._setup_menu = function (self)
	self:_setup_input()
...
StateLoading._destroy_menu = function (self)
	self._menu:destroy()
...
StateLoading._setup_input = function (self, param_block)
...
StateLoading._release_input = function (self)
	local im = Managers.input
...
StateLoading._on_exit_loading_screen = function (self)
	if self._menu then
		self:_destroy_menu()
	end
...
StateLoading.cb_transition_fade_in_done = function (self, new_state)
...
StateLoading.setup_state_context = function (self)
