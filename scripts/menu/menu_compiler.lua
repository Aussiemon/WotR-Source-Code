...
MenuCompiler.init = function (self, data)
	self._data = data
end

MenuCompiler.compile = function (self, menu_def)
	local shortcut_table = {}

	return self:_compile_page(table.clone(menu_def.page), nil, shortcut_table), shortcut_table
end

MenuCompiler._compile_page = function (self, page_config, parent_page, shortcut_table, ...)
	local page
	local item_groups = {}
...
MenuCompiler._compile_item = function (self, item_config, parent_page, shortcut_table, ...)
