...
IngameMenu.init = function (self, game_state, world, menu_data)
...
IngameMenu.event_menu_camera_dummy_spawned = function (self, name, unit)
	self._camera_dummy_units[name] = unit
end

IngameMenu._load_camera = function (self)
...
IngameMenu.cb_on_enter_page = function (self, page)
	self._teleport_camera = true
	self._current_camera = page:camera()
end

IngameMenu.update = function (self, dt, t)
...
IngameMenu._update_camera_position = function (self, dt)
	local viewport_name = self._local_player.viewport_name
...
IngameMenu.set_active = function (self, flag)
