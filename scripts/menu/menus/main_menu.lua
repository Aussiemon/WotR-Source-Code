...
MainMenu.init = function (self, state, world, controller_settings, menu_settings, menu_definition, menu_callbacks, menu_data)
...
MainMenu._load_camera = function (self)
...
MainMenu.update = function (self, dt, t)
...
MainMenu._update_camera_position = function (self, dt)
...
MainMenu.load_started = function (self, text_loading, text_loaded)
	self._loading_indicator:load_started(text_loading, text_loaded)
end

MainMenu.load_finished = function (self)
	self._loading_indicator:load_finished()
end

MainMenu.save_started = function (self, text_saving, text_saved)
	self._loading_indicator:save_started(text_saving, text_saved)
end

MainMenu.save_finished = function (self)
	self._loading_indicator:save_finished()
end

MainMenu.cb_on_enter_page = function (self, page)
...
MainMenu.destroy = function (self)
