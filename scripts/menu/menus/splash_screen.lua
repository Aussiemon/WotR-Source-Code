...
SplashScreen.init = function (self, state, world, controller_settings, menu_settings, menu_definition, menu_callbacks, menu_data)
...
SplashScreen._create_gui = function (self)
...
SplashScreen.event_load_started = function (self, text_loading, text_loaded)
	self._loading_indicator:load_started(text_loading, text_loaded)
end

SplashScreen.event_load_finished = function (self)
	self._loading_indicator:load_finished()
end

SplashScreen.update = function (self, dt, t)
...
SplashScreen.set_active = function (self, active)
