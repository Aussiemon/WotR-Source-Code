...
MainMenuCallbacks.init = function (self, menu_state)
	self._menu_state = menu_state
end

MainMenuCallbacks.cb_exit_game = function (self)
	self._menu_state:exit_game()
end

MainMenuCallbacks.cb_is_not_demo = function (self)
	return not IS_DEMO
end

MainMenuCallbacks.cb_single_player_start = function (self)
	self._menu_state:single_player_start(self._selected_single_player_level)
end

MainMenuCallbacks.cb_start_single_player_game_disabled = function (self)
...
MainMenuCallbacks.cb_on_enter_single_player_ddl_text = function (self)
...
MainMenuCallbacks.cb_single_player_ddl_options = function (self)
	local levels = MenuHelper.single_player_levels_sorted()
	local saved_level_key = Application.win32_user_setting("single_player_level")
...
MainMenuCallbacks.cb_single_player_ddl_option_changed = function (self, option)
...
MainMenuCallbacks.cb_show_hud_options = function (self)
	local options = {
		{
			key = true,
...
MainMenuCallbacks.cb_show_hud_option_changed = function (self, option)
...
MainMenuCallbacks.cb_show_reticule_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_show_reticule_option_changed = function (self, option)
...
MainMenuCallbacks.cb_show_damage_numbers_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_show_damage_numbers_option_changed = function (self, option)
...
MainMenuCallbacks.cb_show_xp_awards = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_show_xp_awards_option_changed = function (self, option)
...
MainMenuCallbacks.cb_show_parry_helper = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_show_parry_helper_option_changed = function (self, option)
...
MainMenuCallbacks.cb_show_pose_charge_helper = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_show_pose_charge_helper_option_changed = function (self, option)
...
MainMenuCallbacks.cb_show_announcements = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_show_announcements_option_changed = function (self, option)
...
MainMenuCallbacks.cb_invert_pose_control_x_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_invert_pose_control_x_option_changed = function (self, option)
...
MainMenuCallbacks.cb_invert_pose_control_y_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_invert_pose_control_y_option_changed = function (self, option)
...
MainMenuCallbacks.cb_invert_parry_control_x_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_invert_parry_control_x_option_changed = function (self, option)
...
MainMenuCallbacks.cb_invert_parry_control_y_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_invert_parry_control_y_option_changed = function (self, option)
...
MainMenuCallbacks._set_sensitivity_options = function (self, option_name)
...
MainMenuCallbacks.cb_mouse_sensitivity_options = function (self)
	local options, selected_index = self:_set_sensitivity_options("sensitivity")

	return options, selected_index
end

MainMenuCallbacks.cb_mouse_sensitivity_option_changed = function (self, option)
...
MainMenuCallbacks.cb_pad_sensitivity_x_options = function (self)
	local options, selected_index = self:_set_sensitivity_options("pad_sensitivity_x")

	return options, selected_index
end

MainMenuCallbacks.cb_pad_sensitivity_x_option_changed = function (self, option)
...
MainMenuCallbacks.cb_pad_sensitivity_y_options = function (self)
	local options, selected_index = self:_set_sensitivity_options("pad_sensitivity_y")

	return options, selected_index
end

MainMenuCallbacks.cb_pad_sensitivity_y_option_changed = function (self, option)
...
MainMenuCallbacks.cb_keyboard_parry_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_keyboard_parry_option_changed = function (self, option)
...
MainMenuCallbacks.cb_keyboard_pose_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_keyboard_pose_option_changed = function (self, option)
...
MainMenuCallbacks.cb_voice_over_changed = function (self, option)
...
MainMenuCallbacks.cb_steam_server_browser_disabled = function (self)
	return GameSettingsDevelopment.network_mode ~= "steam"
end

MainMenuCallbacks.cb_look_invert_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_look_invert_changed = function (self, option)
...
MainMenuCallbacks.cb_look_invert_options_pad360 = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_look_invert_changed_pad360 = function (self, option)
	local invert = option.key
...
MainMenuCallbacks.cb_disable_controller_options = function (self)
	local options = {
		{
			key = true,
			value = L("main_menu_yes")
...
MainMenuCallbacks.cb_disable_controller_changed = function (self, option)
...
MainMenuCallbacks.cb_profile_viewer_world_name = function (self)
	return "menu_level_world"
end

MainMenuCallbacks.cb_profile_viewer_viewport_name = function (self)
	return "menu_level_viewport"
end

MainMenuCallbacks.cb_alignment_dummy_units = function (self)
	return self._menu_state.parent.alignment_dummy_units
end

MainMenuCallbacks.cb_open_link = function (self, url)
	if url then
...
MainMenuCallbacks.cb_controller_enabled = function (self)
	return Managers.input:pad_active(1)
end

MainMenuCallbacks.cb_controller_disabled = function (self)
