...
OutfitsEditorGearAttachmentsMenuPage.init = function (self, config, item_groups, world)
...
OutfitsEditorGearAttachmentsMenuPage._highlight_item = function (self, index, ignore_sound)
...
OutfitsEditorGearAttachmentsMenuPage.set_profile = function (self, player_profile)
	self._current_profile = player_profile
end

OutfitsEditorGearAttachmentsMenuPage.set_gear = function (self, gear_name, attachments_table)
...
OutfitsEditorGearAttachmentsMenuPage.destroy = function (self)
...
OutfitsEditorGearAttachmentsMenuPage._create_gear_attachment_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitsEditorGearAttachmentsMenuPage._add_gear_attachment_items = function (self, gear_name, attachment_config)
...
OutfitsEditorGearAttachmentsMenuPage._update_container_size = function (self, dt, t)
...
OutfitsEditorGearAttachmentsMenuPage._update_container_position = function (self, dt, t)
...
OutfitsEditorGearAttachmentsMenuPage.render = function (self, dt, t)
...
OutfitsEditorGearAttachmentsMenuPage.cb_attachment_highlighted = function (self, gear_name, attachment_category, attachment_name)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	self._attachment_info:load_gear_attachment(gear_name, attachment_category, attachment_name)
end

OutfitsEditorGearAttachmentsMenuPage.cb_text_selected = function (self, category, attachment_name)
...
OutfitsEditorGearAttachmentsMenuPage.cb_checkbox_done_selected = function (self, category)
...
OutfitsEditorGearAttachmentsMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
