...
OutfitsEditorItemMenuPage.init = function (self, config, item_groups, world)
...
OutfitsEditorItemMenuPage.on_enter = function (self)
...
OutfitsEditorItemMenuPage._find_specialization_perks = function (self)
...
OutfitsEditorItemMenuPage.on_exit = function (self)
	OutfitsEditorItemMenuPage.super.on_exit(self)
	self._outfit_info:set_active(false)
	self._perk_info:set_active(false)
end

OutfitsEditorItemMenuPage._highlight_item = function (self, index, ignore_sound)
...
OutfitsEditorItemMenuPage.set_outfit_category = function (self, slot_name, ui_header, category)
...
OutfitsEditorItemMenuPage._set_camera = function (self, slot_name)
...
OutfitsEditorItemMenuPage.set_profile = function (self, player_profile)
	self._current_profile = player_profile
end

OutfitsEditorItemMenuPage._add_outfit_items = function (self, slot_name, ui_header, category)
...
OutfitsEditorItemMenuPage._create_armour_attachments_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitsEditorItemMenuPage._create_helmet_attachments_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitsEditorItemMenuPage._create_specialized_perk_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitsEditorItemMenuPage._create_gear_attachment_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitsEditorItemMenuPage.cb_armour_highlighted = function (self, armour_name)
	self._outfit_info:load_armour(armour_name)
end

OutfitsEditorItemMenuPage.cb_helmet_highlighted = function (self, helmet_name)
	self._outfit_info:load_helmet(helmet_name)
end

OutfitsEditorItemMenuPage.cb_mount_highlighted = function (self, mount_name)
	self._outfit_info:load_mount(mount_name)
end

OutfitsEditorItemMenuPage.cb_basic_perk_highlighted = function (self, perk_name)
	self._perk_info:set_basic_perk(perk_name)
end

OutfitsEditorItemMenuPage.cb_gear_highlighted = function (self, gear_name, slot_name)
	self._outfit_info:load_gear(slot_name, gear_name)
end

OutfitsEditorItemMenuPage.cb_armour_selected = function (self, armour_name)
...
OutfitsEditorItemMenuPage.cb_helmet_selected = function (self, helmet_name)
...
OutfitsEditorItemMenuPage.cb_mount_selected = function (self, mount_name)
	Managers.state.event:trigger("event_outfit_editor_mount_selected", mount_name)
	Managers.state.event:trigger("event_outfit_editor_save_profile")
	self:_try_callback(self.config.callback_object, "cb_cancel_to", "select_outfit_slot")
end

OutfitsEditorItemMenuPage.cb_basic_perk_selected = function (self, perk_name, perk_type)
...
OutfitsEditorItemMenuPage.cb_basic_perk_selected2 = function (self, perk_name, perk_type)
	Managers.state.event:trigger("event_outfit_editor_basic_perk_selected", perk_type, perk_name)
end

OutfitsEditorItemMenuPage._goto_gear_attachment_page = function (self, gear_name)
...
OutfitsEditorItemMenuPage.cb_gear_selected = function (self, gear_name, slot_name)
...
OutfitsEditorItemMenuPage._update_container_size = function (self, dt, t)
...
OutfitsEditorItemMenuPage._update_container_position = function (self, dt, t)
...
OutfitsEditorItemMenuPage.render = function (self, dt, t)
...
OutfitsEditorItemMenuPage.destroy = function (self)
...
OutfitsEditorItemMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
