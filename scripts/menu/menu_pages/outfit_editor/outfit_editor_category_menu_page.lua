...
OutfitEditorCategoryMenuPage.init = function (self, config, item_groups, world)
...
OutfitEditorCategoryMenuPage.on_exit = function (self, on_cancel)
...
OutfitEditorCategoryMenuPage.set_profile = function (self, player_profile)
	self._current_profile = player_profile
end

OutfitEditorCategoryMenuPage.set_slot = function (self, slot_name, ui_slot_name)
	self:_add_category_items(slot_name, ui_slot_name)
	self:_set_camera(slot_name)
end

OutfitEditorCategoryMenuPage._set_camera = function (self, slot_name)
...
OutfitEditorCategoryMenuPage._add_category_items = function (self, slot_name, ui_slot_name)
...
OutfitEditorCategoryMenuPage._create_item_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitEditorCategoryMenuPage.cb_outfit_category_selected = function (self, slot_name, ui_slot_name, category)
...
OutfitEditorCategoryMenuPage._update_container_size = function (self, dt, t)
...
OutfitEditorCategoryMenuPage.destroy = function (self)
...
OutfitEditorCategoryMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
