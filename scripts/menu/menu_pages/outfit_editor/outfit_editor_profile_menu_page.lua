...
OutfitEditorProfileMenuPage.init = function (self, config, item_groups, world)
...
OutfitEditorProfileMenuPage.event_purchase_complete = function (self)
	self:_load_xp_and_coins()
end

OutfitEditorProfileMenuPage.event_profile_gold_reloaded = function (self)
	self:_load_xp_and_coins()
end

OutfitEditorProfileMenuPage.add_menu_alignment_dummy = function (self, name, unit)
...
OutfitEditorProfileMenuPage.set_input = function (self, input)
...
OutfitEditorProfileMenuPage._update_input = function (self, input)
...
OutfitEditorProfileMenuPage.on_enter = function (self, on_cancel)
...
OutfitEditorProfileMenuPage.menu_deactivated = function (self, tab)
	OutfitEditorProfileMenuPage.super.menu_deactivated(self, tab)
	self._profile_info:set_active(false)
	self._profile_viewer:clear()
end

OutfitEditorProfileMenuPage.cb_deactivate_outfit_editor = function (self)
	self._profile_info:set_active(false)
	self._profile_viewer:clear()
end

OutfitEditorProfileMenuPage._highlight_first_avalible_profile = function (self)
...
OutfitEditorProfileMenuPage.cb_backend_setup = function (self, error_code)
...
OutfitEditorProfileMenuPage.cb_profile_loaded = function (self, data)
	Managers.state.event:trigger("event_load_finished")
...
OutfitEditorProfileMenuPage._load_xp_and_coins = function (self)
...
OutfitEditorProfileMenuPage._add_items = function (self)
...
OutfitEditorProfileMenuPage._create_slots_page = function (self)
	local compiler_data = {
		world = self._world,
		menu_data = {
...
OutfitEditorProfileMenuPage.cb_profile_highlighted = function (self, profile_name)
...
OutfitEditorProfileMenuPage.cb_profile_selected = function (self, profile_name)
	return
end

OutfitEditorProfileMenuPage._update_container_size = function (self, dt, t)
...
OutfitEditorProfileMenuPage._update_container_position = function (self, dt, t)
...
OutfitEditorProfileMenuPage.render = function (self, dt, t)
...
OutfitEditorProfileMenuPage.armour_selected = function (self, armour_name)
...
OutfitEditorProfileMenuPage.helmet_selected = function (self, helmet_name)
...
OutfitEditorProfileMenuPage.head_selected = function (self, selections)
...
OutfitEditorProfileMenuPage.save_head = function (self)
...
OutfitEditorProfileMenuPage.reset_head = function (self)
...
OutfitEditorProfileMenuPage.helmet_attachments_selected = function (self, helmet_name, attachments, show_crest)
...
OutfitEditorProfileMenuPage.reset_helmet_attachments = function (self, helmet_name)
...
OutfitEditorProfileMenuPage.save_helmet_attachments = function (self)
...
OutfitEditorProfileMenuPage.gear_attachments_selected = function (self, gear_name, category, attachments)
...
OutfitEditorProfileMenuPage.armour_attachments_selected = function (self, armour, category, attachments)
	self._current_profile_copy.armour_attachments[category] = attachments

	self:_profile_updated("armour_attachments")
end

OutfitEditorProfileMenuPage.mount_selected = function (self, mount_name)
...
OutfitEditorProfileMenuPage.gear_selected = function (self, gear_name, slot_name)
...
OutfitEditorProfileMenuPage.basic_perk_selected = function (self, perk_type, perk_name)
	self._current_profile_copy.perks[perk_type .. "_basic"] = perk_name
end

OutfitEditorProfileMenuPage.specialized_perks_selected = function (self, perk_type, perk_names)
...
OutfitEditorProfileMenuPage._resolve_perk_conflicts = function (self, profile_table)
...
OutfitEditorProfileMenuPage._profile_updated = function (self, updated_outfit)
...
OutfitEditorProfileMenuPage.reload_current_profile = function (self)
	self._current_profile_copy = table.clone(PlayerProfiles[self._current_profile_name])

	self:_profile_updated("profile")
end

OutfitEditorProfileMenuPage.reset_current_profile = function (self)
	PlayerProfiles[self._current_profile_name] = table.clone(PlayerProfilesDefault[self._current_profile_name])

	self:reload_current_profile()
end

OutfitEditorProfileMenuPage.profile_name_updated = function (self)
	self._profile_info:set_active(true)
	self._profile_info:load(self._current_profile_copy)
...
OutfitEditorProfileMenuPage.save_profile = function (self)
...
OutfitEditorProfileMenuPage.cb_profiles_saved = function (self, info)
	if info.error then
...
OutfitEditorProfileMenuPage._update_wielded_gear = function (self, profile_table)
...
OutfitEditorProfileMenuPage._unwield_slots_on_wield = function (self, profile_table, wielded_gear_name)
...
OutfitEditorProfileMenuPage._check_has_wielded_gear = function (self, profile_table)
...
OutfitEditorProfileMenuPage._check_complementing_wielded_gear = function (self, profile_table)
...
OutfitEditorProfileMenuPage.render_from_child_page = function (self, dt, t, leef)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
OutfitEditorProfileMenuPage.destroy = function (self)
...
OutfitEditorProfileMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
