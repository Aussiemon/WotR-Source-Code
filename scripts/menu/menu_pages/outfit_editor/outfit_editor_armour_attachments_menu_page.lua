...
OutfitsEditorArmourAttachmentsMenuPage.init = function (self, config, item_groups, world)
...
OutfitsEditorArmourAttachmentsMenuPage.set_profile = function (self, player_profile)
	self._current_profile = player_profile
end

OutfitsEditorArmourAttachmentsMenuPage.set_armour = function (self, armour_name, attachments_table)
...
OutfitsEditorArmourAttachmentsMenuPage._set_camera = function (self, attachment_config)
	if attachment_config.category == "patterns" then
		self.config.camera = "character_editor_armour_patterns"
	end
end

OutfitsEditorArmourAttachmentsMenuPage.destroy = function (self)
...
OutfitsEditorArmourAttachmentsMenuPage._create_armour_attachment_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitsEditorArmourAttachmentsMenuPage._add_armour_attachment_items = function (self, armour_name, attachment_config)
...
OutfitsEditorArmourAttachmentsMenuPage.cb_text_highlighted = function (self, category, attachment_index)
	Managers.state.event:trigger("event_outfit_editor_armour_attachments_selected", self._armour_name, category, attachment_index)
end

OutfitsEditorArmourAttachmentsMenuPage.cb_text_selected = function (self, category, attachment_index)
	Managers.state.event:trigger("event_outfit_editor_armour_attachments_selected", self._armour_name, category, attachment_index)
...
OutfitsEditorArmourAttachmentsMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
