...
OutfitsEditorHeadMenuPage.init = function (self, config, item_groups, world)
...
OutfitsEditorHeadMenuPage.set_profile = function (self, player_profile)
	self._current_profile = player_profile
end

OutfitsEditorHeadMenuPage._create_head_ddl_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitsEditorHeadMenuPage._add_head_items = function (self)
...
OutfitsEditorHeadMenuPage._create_head_ddl_item = function (self, category, layout_settings)
...
OutfitsEditorHeadMenuPage.cb_head_ddl_text = function (self, category)
	local ui_name
...
OutfitsEditorHeadMenuPage.cb_head_highlighted = function (self, item)
	if item then
...
OutfitsEditorHeadMenuPage.cb_head_options = function (self, category)
...
OutfitsEditorHeadMenuPage.cb_selection_done = function (self)
...
OutfitsEditorHeadMenuPage.cb_head_option_changed = function (self, option)
...
OutfitsEditorHeadMenuPage.cb_reset_selection = function (self)
...
OutfitsEditorHeadMenuPage.on_exit = function (self, on_cancel)
...
OutfitsEditorHeadMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
