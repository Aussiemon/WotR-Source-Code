...
OutfitsEditorHelmetAttachmentsMenuPage.init = function (self, config, item_groups, world)
...
OutfitsEditorHelmetAttachmentsMenuPage.set_profile = function (self, player_profile)
	self._current_profile = player_profile
end

OutfitsEditorHelmetAttachmentsMenuPage._create_helmet_attachment_ddl_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitsEditorHelmetAttachmentsMenuPage.set_helmet = function (self, helmet_name)
...
OutfitsEditorHelmetAttachmentsMenuPage._add_helmet_attachment_items = function (self, helmet_name)
...
OutfitsEditorHelmetAttachmentsMenuPage._create_helmet_attachment_ddl_item = function (self, attachment_type, helmet_name, layout_settings)
...
OutfitsEditorHelmetAttachmentsMenuPage.cb_helmet_attachment_ddl_text = function (self, attachment_type)
...
OutfitsEditorHelmetAttachmentsMenuPage.cb_helmet_attachment_highlighted = function (self, item)
...
OutfitsEditorHelmetAttachmentsMenuPage.cb_helmet_attachment_options = function (self, helmet_name, attachment_type)
	local sorted_table = {}
...
OutfitsEditorHelmetAttachmentsMenuPage.cb_helmet_attachment_option_changed = function (self, option)
...
OutfitsEditorHelmetAttachmentsMenuPage.cb_reset_selection = function (self)
...
OutfitsEditorHelmetAttachmentsMenuPage.cb_show_crest_selected = function (self)
	Managers.state.event:trigger("event_outfit_editor_helmet_attachments_selected", self._helmet_name, self._ddl_selected_options, self:_show_crest_selected())
end

OutfitsEditorHelmetAttachmentsMenuPage.cb_selection_done = function (self)
	Managers.state.event:trigger("event_outfit_editor_helmet_attachments_selected", self._helmet_name, self._ddl_selected_options, self:_show_crest_selected())
...
OutfitsEditorHelmetAttachmentsMenuPage._show_crest_selected = function (self)
...
OutfitsEditorHelmetAttachmentsMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
