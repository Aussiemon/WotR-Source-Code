...
OutfitEditorSlotMenuPage.init = function (self, config, item_groups, world, viewport)
	OutfitEditorSlotMenuPage.super.init(self, config, item_groups, world)

	self._current_profile = nil
end

OutfitEditorSlotMenuPage.on_enter = function (self, on_cancel)
	OutfitEditorSlotMenuPage.super.on_enter(self, on_cancel)
	self:remove_items("item_list")
	self:_add_items()
end

OutfitEditorSlotMenuPage._add_items = function (self)
...
OutfitEditorSlotMenuPage.cb_name_popup_enter = function (self, args)
	local input_text = self._current_profile.display_name

	args.popup_page:find_item_by_name("text_input"):set_text(input_text)
end

OutfitEditorSlotMenuPage.cb_name_popup_item_selected = function (self, args)
...
OutfitEditorSlotMenuPage.cb_set_profile_name = function (self, name)
...
OutfitEditorSlotMenuPage.cb_name_popup_save_button_disabled = function (self, args)
...
OutfitEditorSlotMenuPage.cb_reset_popup_enter = function (self, args)
...
OutfitEditorSlotMenuPage.cb_reset_popup_item_selected = function (self, args)
...
OutfitEditorSlotMenuPage._create_category_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitEditorSlotMenuPage._create_head_page = function (self)
	local compiler_data = {
		world = self._world
	}
	local page_config = {
...
OutfitEditorSlotMenuPage._try_cancel = function (self)
	MenuPage._try_cancel(self)
end

OutfitEditorSlotMenuPage.set_profile = function (self, player_profile)
	self._current_profile = player_profile
end

OutfitEditorSlotMenuPage.cb_head_slot_selected = function (self, slot_name, ui_slot_name)
	self._head_page:set_profile(self._current_profile)
	self._head_page:set_parent_item(self:_highlighted_item())
end

OutfitEditorSlotMenuPage.cb_slot_selected = function (self, slot_name, ui_slot_name)
...
OutfitEditorSlotMenuPage.render_from_child_page = function (self, dt, t, leef)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
OutfitEditorSlotMenuPage.destroy = function (self)
...
OutfitEditorSlotMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
