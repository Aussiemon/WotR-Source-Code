...
OutfitsEditorSpecializedPerkMenuPage.init = function (self, config, item_groups, world)
...
OutfitsEditorSpecializedPerkMenuPage._highlight_item = function (self, index, ignore_sound)
...
OutfitsEditorSpecializedPerkMenuPage.set_profile = function (self, player_profile)
	self._current_profile = player_profile
end

OutfitsEditorSpecializedPerkMenuPage.set_basic_perk = function (self, basic_perk, perk_type)
...
OutfitsEditorSpecializedPerkMenuPage._add_specialized_perk_items = function (self, basic_perk)
...
OutfitsEditorSpecializedPerkMenuPage.cb_selection_done = function (self)
...
OutfitsEditorSpecializedPerkMenuPage._update_container_size = function (self, dt, t)
...
OutfitsEditorSpecializedPerkMenuPage._update_container_position = function (self, dt, t)
...
OutfitsEditorSpecializedPerkMenuPage.render = function (self, dt, t)
...
OutfitsEditorSpecializedPerkMenuPage.cb_specialized_perk_selected = function (self, perk_name)
	local num_selected = #self:_selected_perk_items()
...
OutfitsEditorSpecializedPerkMenuPage._enable_disable_items = function (self)
	local items = self:items_in_group("item_list")
...
OutfitsEditorSpecializedPerkMenuPage._selected_perk_items = function (self)
	local items = self:items_in_group("item_list")
...
OutfitsEditorSpecializedPerkMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
