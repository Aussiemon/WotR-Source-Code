...
CoatOfArmsMenuPage.init = function (self, config, item_groups, world)
...
CoatOfArmsMenuPage.add_menu_alignment_dummy = function (self, name, unit)
	if name == "coat_of_arms" then
		self._coat_of_arms_viewer:add_alignment_unit("coat_of_arms", unit)
	end
end

CoatOfArmsMenuPage._auto_highlight_first_item = function (self)
	return
end

CoatOfArmsMenuPage._find_closest_item_in_division = function (self)
...
CoatOfArmsMenuPage._move_in_division_left = function (self)
	local highlighted_item = self._items[self._current_highlight]
	local x, y = highlighted_item._x, highlighted_item._y
...
CoatOfArmsMenuPage._move_in_division_right = function (self)
	local highlighted_item = self._items[self._current_highlight]
	local x, y = highlighted_item._x, highlighted_item._y
	local min_x = math.huge
	local potential_item
...
CoatOfArmsMenuPage._move_in_division_up = function (self)
	local highlighted_item = self._items[self._current_highlight]
	local x, y = highlighted_item._x, highlighted_item._y
...
CoatOfArmsMenuPage._move_in_division_down = function (self)
	local highlighted_item = self._items[self._current_highlight]
	local x, y = highlighted_item._x, highlighted_item._y
	local min_diff = math.huge
	local min_y = math.huge
...
CoatOfArmsMenuPage.move_left = function (self)
...
CoatOfArmsMenuPage.move_right = function (self)
	if self._division_selected then
...
CoatOfArmsMenuPage.move_up = function (self)
...
CoatOfArmsMenuPage.move_down = function (self)
	local controller_active = Managers.input:pad_active(1)
...
CoatOfArmsMenuPage.on_enter = function (self)
...
CoatOfArmsMenuPage._select_first_division = function (self)
	local items = self:find_items_of_type("division")
...
CoatOfArmsMenuPage._create_division_groups = function (self)
	local division = {}
...
CoatOfArmsMenuPage.on_exit = function (self)
...
CoatOfArmsMenuPage._save_coat_of_arms = function (self)
...
CoatOfArmsMenuPage.cb_coat_of_arms_saved = function (self, info)
	if info.error then
...
CoatOfArmsMenuPage._set_item_group_selection = function (self, group_name, selection_name)
...
CoatOfArmsMenuPage._update_ui_team_name = function (self, group_name, selection_name)
...
CoatOfArmsMenuPage._update_container_size = function (self, dt, t)
...
CoatOfArmsMenuPage._update_container_position = function (self, dt, t)
...
CoatOfArmsMenuPage.render = function (self, dt, t)
...
CoatOfArmsMenuPage._render_division_buttons = function (self, layout_settings)
...
CoatOfArmsMenuPage._render_charge_buttons = function (self, layout_settings)
	local items = self:find_items_of_type("division")
	local dimensions
...
CoatOfArmsMenuPage._render_button_info = function (self, layout_settings)
...
CoatOfArmsMenuPage._update_input = function (self, input)
...
CoatOfArmsMenuPage.cb_scroll_up_charge_type_picker = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	self._containers.charge_type_picker:scroll_up(layout_settings.charge_type_picker)
end

CoatOfArmsMenuPage.cb_scroll_down_charge_type_picker = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	self._containers.charge_type_picker:scroll_down(layout_settings.charge_type_picker)
end

CoatOfArmsMenuPage.cb_field_color_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_division_color_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_field_variation_color_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_division_variation_color_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_division_variation_type_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_field_variation_type_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_division_type_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_ordinary_color_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_ordinary_type_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_charge_color_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_charge_type_selected = function (self, name)
...
CoatOfArmsMenuPage.cb_crest_selected = function (self, name)
...
CoatOfArmsMenuPage._find_top_left_item = function (self, items)
...
CoatOfArmsMenuPage.cb_division_selected = function (self, division)
...
CoatOfArmsMenuPage._cancel = function (self)
	local controller_active = Managers.input:pad_active(1)
...
CoatOfArmsMenuPage.destroy = function (self)
...
CoatOfArmsMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
