...
OutfitDropDownListMenuPage.init = function (self, config, item_groups, world)
	OutfitDropDownListMenuPage.super.init(self, config, item_groups, world)
end

OutfitDropDownListMenuPage._select_item = function (self, change_page_delay, ignore_sound)
...
OutfitDropDownListMenuPage.on_enter = function (self)
...
OutfitDropDownListMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
