...
DemoPopupMenuPage.init = function (self, config, item_groups, world)
...
DemoPopupMenuPage._update_container_size = function (self, dt, t)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
DemoPopupMenuPage._update_container_position = function (self, dt, t)
...
DemoPopupMenuPage.render = function (self, dt, t)
...
DemoPopupMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
