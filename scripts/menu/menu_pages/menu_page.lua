...
MenuPage.init = function (self, config, item_groups, world)
	self.config = config
...
MenuPage._try_play_music_events = function (self, page_event)
...
MenuPage._setup_button_gui = function (self, gui)
	self._button_gui = gui
end

MenuPage.update = function (self, dt, t)
...
MenuPage.update_from_child_page = function (self, dt, t)
	self:update(dt, t)
end

MenuPage.set_input = function (self, input)
	self:_update_input(input)
	self:_update_mouse_hover(input)
end

MenuPage._update_input = function (self, input)
	if not input then
		return
	end
...
MenuPage._try_cancel = function (self)
...
MenuPage._auto_highlight_first_item = function (self)
	for index, item in ipairs(self._items) do
...
MenuPage._update_mouse_hover = function (self, input)
	if not input then
...
MenuPage._set_item_mouse_position = function (self, x, y)
...
MenuPage.render = function (self, dt, t)
	if self.config.render_parent_page then
...
MenuPage._render_button_info = function (self, layout_settings, button_info_name)
...
MenuPage.render_from_child_page = function (self, dt, t)
	self:render(dt, t, true)
end

MenuPage._try_callback = function (self, callback_object, callback_name, ...)
...
MenuPage._select_item = function (self, change_page_delay, ignore_sound)
...
MenuPage.cb_is_demo = function (self)
	return IS_DEMO
end

MenuPage.cb_is_not_demo = function (self)
	return not IS_DEMO
end

MenuPage.cb_buy_game = function (self, args)
...
MenuPage._on_left_click = function (self, change_page_delay, ignore_sound)
	local highlighted_item = self:_highlighted_item()
...
MenuPage._on_right_click = function (self, change_page_delay, ignore_sound)
	local highlighted_item = self:_highlighted_item()
...
MenuPage._select_item_down = function (self, mouse_pos)
	local highlighted_item = self:_highlighted_item()
...
MenuPage._cancel = function (self)
	self._menu_logic:cancel_to_parent()
end

MenuPage.parent_page = function (self)
	return self.config.parent_page
end

MenuPage.environment = function (self)
	return self.config.environment
end

MenuPage.camera = function (self)
	return self.config.camera
end

MenuPage.items = function (self)
	return self._items
end

MenuPage.visible_items = function (self)
	return self._items
end

MenuPage.items_in_group = function (self, group)
	return self._item_groups[group]
end

MenuPage.add_item_group = function (self, group)
	self._item_groups[group] = {}
end

MenuPage.add_item = function (self, item, group)
...
MenuPage.is_in_group = function (self, item, group)
...
MenuPage.remove_items = function (self, group)
...
MenuPage.remove_item_from_group = function (self, group, item)
...
MenuPage.num_items = function (self)
	return #self._items
end

MenuPage.set_parent_item = function (self, item)
	self._parent_item = item
end

MenuPage.cb_controller_enabled = function (self)
	return Managers.input:pad_active(1)
end

MenuPage.cb_controller_disabled = function (self)
	return Managers.input:active_mapping(1) == "keyboard_mouse"
end

MenuPage.on_enter = function (self, on_cancel)
	local controller_active = Managers.input:pad_active(1)
...
MenuPage._on_enter_highlight_item = function (self)
	local callback_object = self.config.callback_object
...
MenuPage.on_exit = function (self, on_cancel)
	for index, item in ipairs(self._items) do
...
MenuPage._first_highlightable_index = function (self)
	for index, item in ipairs(self._items) do
...
MenuPage._last_highlightable_index = function (self)
...
MenuPage._item_index = function (self, item)
	return table.find(self._items, item)
end

MenuPage._highlighted_item = function (self)
	return self._items[self._current_highlight]
end

MenuPage._highlight_item = function (self, index, ignore_sound)
...
MenuPage.destroy = function (self)
...
MenuPage.move_up = function (self)
	local index
...
MenuPage.move_down = function (self)
	local index
...
MenuPage.move_left = function (self)
	if self:_highlighted_item() then
		self:_highlighted_item():on_move_left()
	end
end

MenuPage.move_right = function (self)
	if self:_highlighted_item() then
		self:_highlighted_item():on_move_right()
	end
end

MenuPage.set_menu_logic = function (self, menu_logic)
	self._menu_logic = menu_logic
end

MenuPage.cb_cancel = function (self)
	self:_cancel()
end

MenuPage.find_item_by_name = function (self, name)
...
MenuPage.find_item_by_name_in_group = function (self, group, name)
...
MenuPage.find_items_by_type_in_group = function (self, group, type)
	local items = {}
...
MenuPage.find_items_of_type = function (self, type)
	local items = {}
...
MenuPage.menu_activated = function (self)
	for index, item in pairs(self._items) do
...
MenuPage.menu_deactivated = function (self, tab)
	tab = tab or {}
...
MenuPage.get_button_bitmap = function (self, button_name)
...
MenuPage.open_sale_popup = function (self, sale_items)
