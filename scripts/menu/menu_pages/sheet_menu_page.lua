...
SheetMenuPage.init = function (self, config, item_groups, world)
...
SheetMenuPage._update_container_position = function (self, dt, t)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
SheetMenuPage.render = function (self, dt, t)
