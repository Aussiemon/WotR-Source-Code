...
ScoreboardMenuPage.init = function (self, config, item_groups, world)
...
ScoreboardMenuPage._highlight_item = function (self, index, ignore_sound)
...
ScoreboardMenuPage._update_container_size = function (self, dt, t)
...
ScoreboardMenuPage._update_players = function (self, team, side)
...
ScoreboardMenuPage._add_player_item = function (self, side, player_index, player)
...
ScoreboardMenuPage._update_container_position = function (self, dt, t)
...
ScoreboardMenuPage.render = function (self, dt, t)
	local local_player = self._local_player
...
ScoreboardMenuPage._update_player_details = function (self, player)
...
ScoreboardMenuPage.cb_left_team_players_scroll_select_down = function (self, row)
	self._left_team_players:set_top_visible_row(row)
end

ScoreboardMenuPage.cb_right_team_players_scroll_select_down = function (self, row)
	self._right_team_players:set_top_visible_row(row)
end

ScoreboardMenuPage.cb_left_team_players_scroll_disabled = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	return not self._left_team_players:can_scroll(layout_settings.left_team_players)
end

ScoreboardMenuPage.cb_right_team_players_scroll_disabled = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	return not self._right_team_players:can_scroll(layout_settings.right_team_players)
end

ScoreboardMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
		type = "scoreboard",
