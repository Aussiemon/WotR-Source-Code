...
SelectCharacterMenuPage.init = function (self, config, item_groups, world)
...
SelectCharacterMenuPage.event_menu_alignment_dummy_spawned = function (self, name, unit)
...
SelectCharacterMenuPage._add_items = function (self)
...
SelectCharacterMenuPage.on_enter = function (self)
...
SelectCharacterMenuPage._set_selected_profile = function (self, profile_name)
...
SelectCharacterMenuPage._show_profile = function (self, profile_name)
...
SelectCharacterMenuPage.on_exit = function (self, on_cancel)
	SelectCharacterMenuPage.super.on_exit(self, on_cancel)
	self._profile_info:set_active(false)
	self._profile_viewer:clear()
end

SelectCharacterMenuPage._highlight_item = function (self, index, ignore_sound)
...
SelectCharacterMenuPage.cb_profile_highlighted = function (self, profile_name)
	self:_show_profile(profile_name)
end

SelectCharacterMenuPage.cb_profile_selected = function (self, profile_name)
...
SelectCharacterMenuPage.update = function (self, dt, t, input)
...
SelectCharacterMenuPage._update_pad_index = function (self)
...
SelectCharacterMenuPage._update_game_start_timer = function (self)
...
SelectCharacterMenuPage._update_coat_of_arms = function (self)
...
SelectCharacterMenuPage._update_container_size = function (self, dt, t)
...
SelectCharacterMenuPage._update_container_position = function (self, dt, t)
...
SelectCharacterMenuPage.render = function (self, dt, t)
...
SelectCharacterMenuPage._update_input = function (self, input)
	if not input then
		return
	end
...
SelectCharacterMenuPage.destroy = function (self)
...
SelectCharacterMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
