...
Level4MenuPage.init = function (self, config, item_groups, world)
...
Level4MenuPage._create_scroll_items = function (self)
...
Level4MenuPage.cb_scroll_up_item_list = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	self._item_list:scroll_up(layout_settings.item_list)
end

Level4MenuPage.cb_scroll_down_item_list = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	self._item_list:scroll_down(layout_settings.item_list)
end

Level4MenuPage._update_container_size = function (self, dt, t)
...
Level4MenuPage._update_container_position = function (self, dt, t)
...
Level4MenuPage.render_from_child_page = function (self, dt, t, leef)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
Level4MenuPage.render = function (self, dt, t)
...
Level4MenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
