...
CharacterSheetMenuPage.init = function (self, config, item_groups, world)
...
CharacterSheetMenuPage.set_input = function (self, input)
...
CharacterSheetMenuPage._set_active = function (self, active)
	if active then
...
CharacterSheetMenuPage.on_enter = function (self, on_cancel)
...
CharacterSheetMenuPage.on_exit = function (self, on_cancel)
...
CharacterSheetMenuPage._load_selected_profile = function (self)
...
CharacterSheetMenuPage._load_perks = function (self, profile)
...
CharacterSheetMenuPage._clear_item_texts = function (self, item_group)
...
CharacterSheetMenuPage._load_weapon_stats = function (self, profile)
...
CharacterSheetMenuPage._load_armour_stats = function (self, profile)
...
CharacterSheetMenuPage._load_modifications = function (self, profile)
...
CharacterSheetMenuPage.cb_profile_loaded = function (self, data)
...
CharacterSheetMenuPage._update_container_size = function (self, dt, t)
...
CharacterSheetMenuPage._update_container_position = function (self, dt, t)
...
CharacterSheetMenuPage.render = function (self, dt, t)
...
CharacterSheetMenuPage.destroy = function (self)
...
CharacterSheetMenuPage._user_name = function (self)
...
CharacterSheetMenuPage._save_title = function (self)
...
CharacterSheetMenuPage._save_horse_name = function (self)
...
CharacterSheetMenuPage.cb_title_saved = function (self, info)
	if info.error then
...
CharacterSheetMenuPage.cb_horse_name_saved = function (self, info)
	if info.error then
		Application.warning("Save error %q", info.error)
	end
...
CharacterSheetMenuPage.cb_user_name_with_title = function (self)
...
CharacterSheetMenuPage.cb_profile_drop_down_list_text = function (self)
	return "", PlayerProfiles[self._selected_profile].display_name
end

CharacterSheetMenuPage.cb_profile_options = function (self)
	local options = {}
...
CharacterSheetMenuPage.cb_profile_option_changed = function (self, option)
	self._selected_profile = option.key

	self:_load_selected_profile()
end

CharacterSheetMenuPage.cb_title_drop_down_list_text = function (self)
	for index, title in ipairs(PlayerTitles) do
		if title.name == PlayerCoatOfArms.title then
...
CharacterSheetMenuPage.cb_title_options = function (self, option)
	local options = {}
...
CharacterSheetMenuPage.cb_title_option_changed = function (self, option)
	PlayerCoatOfArms.title = option.key

	self:_save_title()
end

CharacterSheetMenuPage.cb_horse_name = function (self)
	return PlayerProfiles[self._selected_profile].mount_name or L("menu_horse_name")
end

CharacterSheetMenuPage.cb_horse_name_popup_enter = function (self, args)
...
CharacterSheetMenuPage.cb_horse_name_popup_item_selected = function (self, args)
...
CharacterSheetMenuPage.cb_horse_name_popup_save_disabled = function (self, args)
...
CharacterSheetMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
