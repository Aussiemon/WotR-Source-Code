...
PopupMenuPage.init = function (self, config, item_groups, world)
...
PopupMenuPage.on_enter = function (self)
...
PopupMenuPage.update = function (self, dt, t)
...
PopupMenuPage._update_container_size = function (self, dt, t)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
PopupMenuPage._update_container_position = function (self, dt, t)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
PopupMenuPage.cb_item_selected = function (self, popup_action, parent_page_action)
...
PopupMenuPage.cb_item_disabled = function (self, disabled_func)
	local parent_page_args = {
		popup_page = self
	}
...
PopupMenuPage.move_left = function (self)
	PopupMenuPage.super.move_down(self)
end

PopupMenuPage.move_right = function (self)
	PopupMenuPage.super.move_up(self)
end

PopupMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
