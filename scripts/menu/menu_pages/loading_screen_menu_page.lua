...
LoadingScreenMenuPage.init = function (self, config, item_groups, world)
...
LoadingScreenMenuPage.event_game_start_countdown_tick = function (self, t)
	self._game_start_countdown = t
end

LoadingScreenMenuPage.on_enter = function (self, on_cancel)
...
LoadingScreenMenuPage._randomize_tip = function (self, level, game_mode)
...
LoadingScreenMenuPage.update = function (self, dt, t, input)
...
LoadingScreenMenuPage._update_container_size = function (self, dt, t)
...
LoadingScreenMenuPage._update_container_position = function (self, dt, t)
...
LoadingScreenMenuPage.render = function (self, dt, t)
...
LoadingScreenMenuPage.destroy = function (self)
	LoadingScreenMenuPage.super.destroy(self)
	self._tip_of_the_day:destroy()
end

LoadingScreenMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
