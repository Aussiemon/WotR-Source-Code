...
FinalScoreboardMenuPage.init = function (self, config, item_groups, world)
...
FinalScoreboardMenuPage.render = function (self, dt, t)
...
FinalScoreboardMenuPage.gm_event_end_conditions_met = function (self, winning_team_name, red_team_score, white_team_score, only_end_of_round)
	if not self._local_player.team or self._local_player.team.name == "unassigned" then
		return
	end
...
FinalScoreboardMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
