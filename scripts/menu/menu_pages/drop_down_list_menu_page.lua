...
DropDownListMenuPage.init = function (self, config, item_groups, world)
...
DropDownListMenuPage._highlight_item = function (self, index, ignore_sound)
...
DropDownListMenuPage.on_enter = function (self)
...
DropDownListMenuPage._select_item = function (self, change_page_delay, ignore_sound)
	local highlighted_item = self:_highlighted_item()
...
DropDownListMenuPage._update_container_size = function (self, dt, t)
...
DropDownListMenuPage._update_container_position = function (self, dt, t)
...
DropDownListMenuPage.render = function (self, dt, t)
...
DropDownListMenuPage._update_input = function (self, input)
...
DropDownListMenuPage._auto_highlight_first_item = function (self)
...
DropDownListMenuPage.move_down = function (self)
	local controller_active = Managers.input:pad_active(1)
...
DropDownListMenuPage.move_up = function (self)
	local controller_active = Managers.input:pad_active(1)
...
DropDownListMenuPage.cb_scroll_bar_select_down = function (self, row)
	self._drop_down_list:set_top_visible_row(row)
end

DropDownListMenuPage.cb_scroll_bar_disabled = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	return not self._drop_down_list:can_scroll(layout_settings.drop_down_list)
end

DropDownListMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
