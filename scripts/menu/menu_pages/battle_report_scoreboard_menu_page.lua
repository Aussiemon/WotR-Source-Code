...
BattleReportScoreboardMenuPage.init = function (self, config, item_groups, world)
...
BattleReportScoreboardMenuPage.load_scoreboard = function (self, stats_collection, players, local_player_index)
...
BattleReportScoreboardMenuPage._highlight_item = function (self, index, ignore_sound)
...
BattleReportScoreboardMenuPage._update_container_size = function (self, dt, t)
...
BattleReportScoreboardMenuPage._update_container_position = function (self, dt, t)
...
BattleReportScoreboardMenuPage.update = function (self, dt, t)
...
BattleReportScoreboardMenuPage._update_input = function (self, input)
...
BattleReportScoreboardMenuPage.render = function (self, dt, t)
...
BattleReportScoreboardMenuPage.move_up = function (self)
	local controller_active = Managers.input:pad_active(1)
...
BattleReportScoreboardMenuPage.move_down = function (self)
	local controller_active = Managers.input:pad_active(1)
...
BattleReportScoreboardMenuPage._render_button_info = function (self, layout_settings)
...
BattleReportScoreboardMenuPage._update_player_details = function (self, player_index)
...
BattleReportScoreboardMenuPage.cb_scoreboard_scroll_select_down = function (self, row)
	self._scoreboard:set_top_visible_row(row)
end

BattleReportScoreboardMenuPage.cb_scoreboard_scroll_disabled = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	return not self._scoreboard:can_scroll(layout_settings.scoreboard)
end

BattleReportScoreboardMenuPage.cb_goto_menu_page = function (self, id)
	self._menu_logic:goto(id)
end

BattleReportScoreboardMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
