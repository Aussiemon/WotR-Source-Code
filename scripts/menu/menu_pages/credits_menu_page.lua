...
CreditsMenuPage.init = function (self, config, item_groups, world)
...
CreditsMenuPage._update_input = function (self, input)
...
CreditsMenuPage.on_enter = function (self, on_cancel)
...
CreditsMenuPage.update = function (self, dt, t)
...
CreditsMenuPage._update_container_size = function (self, dt, t)
...
CreditsMenuPage._update_container_position = function (self, dt, t)
...
CreditsMenuPage.render = function (self, dt, t)
...
CreditsMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
		type = "credits",
