...
Level1MenuPage.init = function (self, config, item_groups, world)
...
Level1MenuPage._update_container_size = function (self, dt, t)
...
Level1MenuPage._update_container_position = function (self, dt, t)
...
Level1MenuPage.render_from_child_page = function (self, dt, t, leef)
...
Level1MenuPage.render = function (self, dt, t)
	if script_data.hide_title_screen then
		return
	end
...
Level1MenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
		type = "level_1",
