...
ServerBrowserMenuPage.init = function (self, config, item_groups, world)
...
ServerBrowserMenuPage.event_denied_to_enter_game = function (self, reason)
	self._error_reason = reason
end

ServerBrowserMenuPage._setup_popups = function (self)
...
ServerBrowserMenuPage.on_enter = function (self, on_cancel)
...
ServerBrowserMenuPage._create_debug_players = function (self)
	local players = {}
...
ServerBrowserMenuPage.on_exit = function (self, on_cancel)
...
ServerBrowserMenuPage._refresh_all_servers = function (self)
	self._selected_server_num = nil
...
ServerBrowserMenuPage._refresh_selected_server = function (self)
	Managers.lobby:refresh_server(self._selected_server_num)
	self:_request_players(self._selected_server_num)
	self:_refresh_friends()
end

ServerBrowserMenuPage._refresh_friends = function (self)
...
ServerBrowserMenuPage.update = function (self, dt, t)
...
ServerBrowserMenuPage._update_server_items = function (self)
	local lobby_manager = Managers.lobby
...
ServerBrowserMenuPage._update_player_items = function (self, server_num)
	local lobby_manager = Managers.lobby
	local players
...
ServerBrowserMenuPage._update_server_info = function (self, server_num)
...
ServerBrowserMenuPage._sort_server_items = function (self, column, sort_order)
...
ServerBrowserMenuPage._deselect_server_items = function (self, except_server_num)
	local items = self:items_in_group("browser_items")
...
ServerBrowserMenuPage._deselect_header_items = function (self, except_column)
...
ServerBrowserMenuPage._add_server = function (self, server)
...
ServerBrowserMenuPage._matches_local_server_filters = function (self, server)
...
ServerBrowserMenuPage._local_server_filters_updated = function (self)
	self._selected_server_num = nil
	self._render_info = false
...
ServerBrowserMenuPage._insert_server_item = function (self, server)
...
ServerBrowserMenuPage._insert_player_item = function (self, player)
...
ServerBrowserMenuPage._request_players = function (self, server_num)
	self:remove_items("player_info_items")
...
ServerBrowserMenuPage._update_server_type_tabs = function (self, server_type)
...
ServerBrowserMenuPage._update_container_size = function (self, dt, t)
...
ServerBrowserMenuPage._update_container_position = function (self, dt, t)
...
ServerBrowserMenuPage.render = function (self, dt, t)
...
ServerBrowserMenuPage._render_button_info = function (self, layout_settings)
...
ServerBrowserMenuPage._update_server_highlight = function (self, direction)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
ServerBrowserMenuPage._find_first_server_item = function (self)
	local server_item, server_index
...
ServerBrowserMenuPage._highlight_next_server_item_index = function (self)
...
ServerBrowserMenuPage._highlight_prev_server_item_index = function (self)
	local current_index = self._server_item_highlighted_index or 1
	local items = self._browser:items()
	local server_item, server_index
...
ServerBrowserMenuPage.move_up = function (self)
	local controller_active = Managers.input:pad_active(1)
...
ServerBrowserMenuPage.move_down = function (self)
	local controller_active = Managers.input:pad_active(1)
...
ServerBrowserMenuPage._update_input = function (self, input)
...
ServerBrowserMenuPage._find_selected_item = function (self, items)
...
ServerBrowserMenuPage._connect = function (self, password)
...
ServerBrowserMenuPage.cb_set_server_type = function (self, server_type)
	Managers.lobby:set_server_browse_mode(server_type)
	self:_refresh_all_servers()
	self:_update_server_type_tabs()
end

ServerBrowserMenuPage.cb_server_type_lan_visible = function (self)
	return not GameSettingsDevelopment.hide_lan_tab
end

ServerBrowserMenuPage.cb_sort_browser = function (self, column, default_order)
...
ServerBrowserMenuPage._cancel = function (self)
	if self._render_info then
...
ServerBrowserMenuPage.cb_server_item_selected = function (self, server_num)
...
ServerBrowserMenuPage.cb_favorite_item_selected = function (self, server)
...
ServerBrowserMenuPage.mark_server_as_favorite = function (self)
	local current_index = self._server_item_highlighted_index or 1
	local items = self._browser:items()
...
ServerBrowserMenuPage.cb_server_item_disabled = function (self, server)
	return not server.valid
end

ServerBrowserMenuPage.cb_quick_refresh = function (self)
	self:_refresh_selected_server()
end

ServerBrowserMenuPage.cb_refresh_all = function (self)
	self:_refresh_all_servers()
end

ServerBrowserMenuPage.cb_connect = function (self)
	self:_connect(nil)
end

ServerBrowserMenuPage.cb_quick_refresh_button_disabled = function (self)
	return not self._selected_server_num
end

ServerBrowserMenuPage.cb_connect_button_disabled = function (self)
	return not self._selected_server_num
end

ServerBrowserMenuPage.cb_browser_scroll_select_down = function (self, row)
	self._browser:set_top_visible_row(row)
end

ServerBrowserMenuPage.cb_player_info_scroll_select_down = function (self, row)
	self._player_info:set_top_visible_row(row)
end

ServerBrowserMenuPage.cb_browser_scroll_disabled = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
ServerBrowserMenuPage.cb_player_info_scroll_disabled = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
ServerBrowserMenuPage.cb_close_server_info = function (self)
...
ServerBrowserMenuPage.cb_demo_checkbox_remove = function (self)
	return not IS_DEMO
end

ServerBrowserMenuPage.cb_on_enter_query_filter_not_full = function (self)
...
ServerBrowserMenuPage.cb_on_select_query_filter_not_full_popup = function (self)
...
ServerBrowserMenuPage.cb_on_select_query_filter_not_full = function (self)
...
ServerBrowserMenuPage.cb_on_enter_query_filter_has_players = function (self)
...
ServerBrowserMenuPage.cb_on_select_query_filter_has_players_popup = function (self)
...
ServerBrowserMenuPage.cb_on_select_query_filter_has_players = function (self)
...
ServerBrowserMenuPage.cb_on_enter_text_query_filter_level = function (self)
...
ServerBrowserMenuPage.cb_on_enter_options_query_filter_level = function (self)
	local saved_option = Application.win32_user_setting("server_browser_filter_settings", "level")
	local options = {}
...
ServerBrowserMenuPage.cb_on_option_changed_query_filter_level_popup = function (self, option)
...
ServerBrowserMenuPage.cb_on_option_changed_query_filter_level = function (self, option)
	if option.key ~= "" and LevelSettings[option.key] then
		self._query_filters.map = LevelSettings[option.key].game_server_map_name
	else
		self._query_filters.map = nil
...
ServerBrowserMenuPage.cb_on_enter_local_filter_password = function (self)
...
ServerBrowserMenuPage.cb_on_select_local_filter_password_popup = function (self)
...
ServerBrowserMenuPage.cb_on_select_local_filter_password = function (self)
...
ServerBrowserMenuPage.cb_on_enter_local_filter_demo = function (self)
...
ServerBrowserMenuPage.cb_on_select_local_filter_demo_popup = function (self)
...
ServerBrowserMenuPage.cb_on_select_local_filter_demo = function (self)
...
ServerBrowserMenuPage.cb_on_enter_local_filter_only_available = function (self)
...
ServerBrowserMenuPage.cb_on_select_local_filter_only_available_popup = function (self)
...
ServerBrowserMenuPage.cb_on_select_local_filter_only_available = function (self)
...
ServerBrowserMenuPage.cb_on_enter_text_local_filter_game_mode = function (self)
...
ServerBrowserMenuPage.cb_on_enter_options_local_filter_game_mode = function (self)
	local saved_option = Application.win32_user_setting("server_browser_filter_settings", "game_mode")
	local options = {}
	local selected_index = 1
	local levels = {}
...
ServerBrowserMenuPage.cb_on_option_changed_local_filter_game_mode = function (self, option)
...
ServerBrowserMenuPage.cb_password_popup_enter = function (self, args)
	args.popup_page:find_item_by_name("password_input"):set_text(self._password_text or "")
end

ServerBrowserMenuPage.cb_password_popup_item_selected = function (self, args)
...
ServerBrowserMenuPage.cb_password_entered_from_controller_input = function (self, password_text)
	self._controller_password_text = password_text
end

ServerBrowserMenuPage.cb_password_popup_continue_disabled = function (self, args)
...
ServerBrowserMenuPage.cb_connecting_popup_enter = function (self, args)
...
ServerBrowserMenuPage.cb_connecting_popup_item_selected = function (self, args)
	self._connecting_popup_text = nil
	self._connecting_popup_texture.config.visible = false
	self._connecting_popup_close_button.config.visible = false
end

ServerBrowserMenuPage.cb_connecting_popup_cancel = function (self, args)
	self._connecting_popup_text = nil
	self._connecting_popup_texture.config.visible = false
	self._connecting_popup_close_button.config.visible = false
...
ServerBrowserMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
		type = "server_browser",
