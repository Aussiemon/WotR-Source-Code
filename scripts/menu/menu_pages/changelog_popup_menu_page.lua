...
ChangelogPopupMenuPage.init = function (self, config, item_groups, world)
	ChangelogPopupMenuPage.super.init(self, config, item_groups, world)
end

ChangelogPopupMenuPage._update_input = function (self, input)
...
ChangelogPopupMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
