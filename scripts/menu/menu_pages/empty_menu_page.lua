...
EmptyMenuPage.init = function (self, config, item_groups, world)
	EmptyMenuPage.super.init(self, config, item_groups, world)
end

EmptyMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
		type = "empty",
