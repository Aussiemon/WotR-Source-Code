...
VideoSettingsMenuPage.init = function (self, config, item_groups, world)
...
VideoSettingsMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups)
	local config = {
...
VideoSettingsMenuPage.on_enter = function (self, on_cancel)
...
VideoSettingsMenuPage.cb_apply_changes_disabled = function (self)
	return not self:_changes_made()
end

VideoSettingsMenuPage._changes_made = function (self)
	return table.size(self._changed_user_settings) > 0 or table.size(self._changed_render_settings) > 0
end

VideoSettingsMenuPage._cancel = function (self)
...
VideoSettingsMenuPage.cb_unapplied_changes_popup_item_selected = function (self, args)
...
VideoSettingsMenuPage.cb_apply_changes = function (self)
...
VideoSettingsMenuPage.cb_keep_changes_popup_item_selected = function (self, args)
...
VideoSettingsMenuPage.cb_restart_popup_item_selected = function (self, args)
	if args.action == "restart" then
		Managers.state.event:trigger("restart_game")
	end
end

VideoSettingsMenuPage.cb_fullscreen_options = function (self)
	local options = {
		{
			key = true,
			value = L("menu_yes")
...
VideoSettingsMenuPage.cb_fullscreen_option_changed = function (self, option)
	self._changed_user_settings.fullscreen = option.key
end

VideoSettingsMenuPage.cb_fullscreen_output_options = function (self)
	local screens = {}
...
VideoSettingsMenuPage.cb_fullscreen_output_option_changed = function (self, option)
...
VideoSettingsMenuPage.cb_resolution_drop_down_list_text = function (self)
...
VideoSettingsMenuPage.cb_resolution_options = function (self)
	local saved_resolution = T(self._changed_user_settings.screen_resolution, self._original_user_settings.screen_resolution)
	local saved_fullscreen_output = T(self._changed_user_settings.fullscreen_output, self._original_user_settings.fullscreen_output)
	local options = {}
	local selected_index = 1
...
VideoSettingsMenuPage.cb_resolution_option_changed = function (self, option)
	self._changed_user_settings.screen_resolution = option.key
end

VideoSettingsMenuPage.cb_graphics_quality_options = function (self)
	local options = {
		{
			key = "low",
			value = L("menu_low")
...
VideoSettingsMenuPage.cb_graphics_quality_option_changed = function (self, option)
...
VideoSettingsMenuPage.cb_vertical_sync_options = function (self)
	local options = {
		{
			key = false,
			value = L("menu_no")
...
VideoSettingsMenuPage.cb_vertical_sync_option_changed = function (self, option)
	self._changed_user_settings.vsync = option.key
end

VideoSettingsMenuPage.cb_shadow_quality_options = function (self)
	local options = {
		{
			key = "off",
			value = L("menu_off")
...
VideoSettingsMenuPage.cb_shadow_quality_option_changed = function (self, option, called_from_graphics_quality)
	local choice = option.key
...
VideoSettingsMenuPage.cb_texture_quality_characters_options = function (self)
	local options = {
		{
			key = "low",
			value = L("menu_low")
...
VideoSettingsMenuPage.cb_texture_quality_characters_option_changed = function (self, option, called_from_graphics_quality)
	local choice = option.key
...
VideoSettingsMenuPage.cb_texture_quality_environment_options = function (self)
	local options = {
		{
			key = "low",
			value = L("menu_low")
...
VideoSettingsMenuPage.cb_texture_quality_environment_option_changed = function (self, option, called_from_graphics_quality)
	local choice = option.key
...
VideoSettingsMenuPage.cb_texture_quality_coat_of_arms_options = function (self)
	local options = {
		{
			key = "low",
			value = L("menu_low")
...
VideoSettingsMenuPage.cb_texture_quality_coat_of_arms_option_changed = function (self, option, called_from_graphics_quality)
	local choice = option.key
...
VideoSettingsMenuPage.cb_anti_aliasing_options = function (self)
	local options = {
		{
			key = false,
			value = L("menu_no")
...
VideoSettingsMenuPage.cb_anti_aliasing_option_changed = function (self, option, called_from_graphics_quality)
...
VideoSettingsMenuPage.cb_ssao_options = function (self)
	local options = {
		{
			key = false,
			value = L("menu_no")
...
VideoSettingsMenuPage.cb_ssao_option_changed = function (self, option, called_from_graphics_quality)
...
VideoSettingsMenuPage.cb_lod_options = function (self)
	local options = {
		{
			key = 0.6,
			value = L("menu_low")
...
VideoSettingsMenuPage.cb_lod_option_changed = function (self, option, called_from_graphics_quality)
...
VideoSettingsMenuPage.cb_landscape_decoration_options = function (self)
	local options = {
		{
			key = 0.1,
			value = L("menu_low")
...
VideoSettingsMenuPage.cb_landscape_decoration_option_changed = function (self, option, called_from_graphics_quality)
...
VideoSettingsMenuPage.cb_scatter_options = function (self)
	local options = {
		{
			key = 0,
			value = L("menu_low")
...
VideoSettingsMenuPage.cb_scatter_option_changed = function (self, option, called_from_graphics_quality)
...
VideoSettingsMenuPage.cb_particles_quality_options = function (self)
	local options = {
		{
			key = "low",
			value = L("menu_low")
...
VideoSettingsMenuPage.cb_particles_quality_option_changed = function (self, option, called_from_graphics_quality)
...
VideoSettingsMenuPage.cb_max_stacking_frames_options = function (self)
	local options = {
		{
			key = -1,
			value = L("menu_auto")
...
VideoSettingsMenuPage.cb_max_stacking_frames_option_changed = function (self, option)
	self._changed_user_settings.max_stacking_frames = option.key
end

VideoSettingsMenuPage.cb_light_casts_shadows_options = function (self)
	local options = {
		{
			key = false,
			value = L("menu_no")
...
VideoSettingsMenuPage.cb_light_casts_shadows_option_changed = function (self, option, called_from_graphics_quality)
...
VideoSettingsMenuPage.cb_gamma_options = function (self)
...
VideoSettingsMenuPage.cb_gamma_option_changed = function (self, option)
	self._changed_user_settings.gamma = option.key

	Application.set_user_setting("gamma", option.key)
end

VideoSettingsMenuPage.cb_max_fps_options = function (self)
	local options = {
		{
			key = 0,
			value = L("menu_no")
...
VideoSettingsMenuPage.cb_max_fps_option_changed = function (self, option)
