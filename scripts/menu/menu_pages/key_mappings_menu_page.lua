...
KeyMappingsMenuPage.init = function (self, config, item_groups, world)
	KeyMappingsMenuPage.super.init(self, config, item_groups, world)

	DirtyPlayerControllerSettings = {}
end

KeyMappingsMenuPage.on_exit = function (self, on_cancel)
...
KeyMappingsMenuPage.move_left = function (self)
...
KeyMappingsMenuPage.move_right = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
	local columns = layout_settings.item_list.number_of_columns
	local index
...
KeyMappingsMenuPage.first_item_in_column = function (self, current_item)
...
KeyMappingsMenuPage.last_item_in_column = function (self, current_item)
	local col = current_item.config.column
	local highest = -1
...
KeyMappingsMenuPage.move_up = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
	local columns = layout_settings.item_list.number_of_columns
	local index
...
KeyMappingsMenuPage.move_down = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
	local columns = layout_settings.item_list.number_of_columns
	local index
...
KeyMappingsMenuPage.set_key_mapping = function (self, key, new_key, controller)
...
KeyMappingsMenuPage.cb_reset = function (self)
...
KeyMappingsMenuPage.cb_apply_key_mappings = function (self)
...
KeyMappingsMenuPage.cb_save_done = function (self, info)
	if info.error then
...
KeyMappingsMenuPage.cb_apply_changes_disabled = function (self)
	return table.size(DirtyPlayerControllerSettings) == 0
end

KeyMappingsMenuPage._handle_input_switch = function (self)
...
KeyMappingsMenuPage._update_identical_keybindings = function (self, highlighted_item)
...
KeyMappingsMenuPage._update_input = function (self, input)
...
KeyMappingsMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups)
	local config = {
