...
ExpandablePopupMenuPage.init = function (self, config, item_groups, world)
...
ExpandablePopupMenuPage.on_enter = function (self)
...
ExpandablePopupMenuPage.update = function (self, dt, t)
	ExpandablePopupMenuPage.super.update(self, dt, t)
	self:_update_container_size(dt, t)
	self:_update_container_position(dt, t)
end

ExpandablePopupMenuPage._update_container_size = function (self, dt, t)
...
ExpandablePopupMenuPage._update_container_position = function (self, dt, t)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
ExpandablePopupMenuPage.render = function (self, dt, t)
...
ExpandablePopupMenuPage.cb_item_selected = function (self, popup_action, parent_page_action)
...
ExpandablePopupMenuPage.cb_item_disabled = function (self, disabled_func)
	local parent_page_args = {
		popup_page = self
	}
...
ExpandablePopupMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
