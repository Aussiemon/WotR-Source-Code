...
MainMenuPage.init = function (self, config, item_groups, world)
...
MainMenuPage._on_left_click = function (self, change_page_delay, ignore_sound)
...
MainMenuPage.cb_gold_purchase_done = function (self, success, data)
...
MainMenuPage._highlight_item = function (self, index, ignore_sound)
	local highlighted_item = self:_highlighted_item()
...
MainMenuPage.cb_return_to_main = function (self)
	self._menu_logic:change_page(self:parent_page())
end

MainMenuPage.cb_buy_game = function (self, args)
...
MainMenuPage._update_container_position = function (self, dt, t)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
MainMenuPage.render = function (self, dt, t)
...
MainMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
