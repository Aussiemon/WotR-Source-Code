...
BattleReportSummaryMenuPage.init = function (self, config, item_groups, world)
...
BattleReportSummaryMenuPage.on_enter = function (self)
...
BattleReportSummaryMenuPage._update_xp_and_coins = function (self, xp, coins)
	local rank
...
BattleReportSummaryMenuPage.on_exit = function (self)
	BattleReportSummaryMenuPage.super.on_exit(self)

	self._first_enter = false
end

BattleReportSummaryMenuPage._add_award_items = function (self)
...
BattleReportSummaryMenuPage._add_award_item = function (self, award_name, award_amount, award_textures, tooltip_header, tooltip_text)
...
BattleReportSummaryMenuPage._update_container_size = function (self, dt, t)
...
BattleReportSummaryMenuPage._update_container_position = function (self, dt, t)
...
BattleReportSummaryMenuPage._select_item = function (self, change_page_delay, ignore_sound)
...
BattleReportSummaryMenuPage._update_input = function (self, input)
...
BattleReportSummaryMenuPage.render = function (self, dt, t)
...
BattleReportSummaryMenuPage.cb_start_next_summary_item = function (self, item)
...
BattleReportSummaryMenuPage.cb_increment_subtotal = function (self, xp, coins)
...
BattleReportSummaryMenuPage.cb_increment_total = function (self, xp, coins)
...
BattleReportSummaryMenuPage.cb_decrement_total = function (self, xp, coins)
	local item = self:find_item_by_name("total")
...
BattleReportSummaryMenuPage.cb_total_finished = function (self)
	if self._bar_xp then
...
BattleReportSummaryMenuPage.cb_start_next_award_item = function (self, item)
	local item_index = self:_item_index(item)
	local next_item_index = item_index + 1
	local next_item = self._items[next_item_index]
...
BattleReportSummaryMenuPage.cb_awards_scroll_select_down = function (self, row)
	self._award_list:set_top_visible_row(row)
end

BattleReportSummaryMenuPage.cb_awards_scroll_disabled = function (self)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)

	return not self._award_list:can_scroll(layout_settings.award_list)
end

BattleReportSummaryMenuPage.cb_goto_menu_page = function (self, id)
	self._menu_logic:goto(id)
end

BattleReportSummaryMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
