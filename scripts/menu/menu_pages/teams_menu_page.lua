...
TeamsMenuPage.init = function (self, config, item_groups, world)
...
TeamsMenuPage._update_container_position = function (self, dt, t)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
TeamsMenuPage.render = function (self, dt, t)
...
TeamsMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
		type = "teams",
