...
BattleReportBaseMenuPage.init = function (self, config, item_groups, world)
...
BattleReportBaseMenuPage.event_game_start_countdown_tick = function (self, t)
	self._game_start_countdown = t
end

BattleReportBaseMenuPage.update = function (self, dt, t, input)
...
BattleReportBaseMenuPage._update_container_size = function (self, dt, t)
...
BattleReportBaseMenuPage._update_container_position = function (self, dt, t)
...
BattleReportBaseMenuPage.render = function (self, dt, t)
