...
TeamSelectionMenuPage.init = function (self, config, item_groups, world)
...
TeamSelectionMenuPage.event_join_team_confirmed = function (self)
...
TeamSelectionMenuPage.event_join_team_denied = function (self)
	self._joining_team = false
end

TeamSelectionMenuPage.on_enter = function (self)
...
TeamSelectionMenuPage.move_left = function (self)
...
TeamSelectionMenuPage.move_right = function (self)
...
TeamSelectionMenuPage.move_up = function (self)
...
TeamSelectionMenuPage.move_down = function (self)
	local controller_active = Managers.input:pad_active(1)
...
TeamSelectionMenuPage.update = function (self, dt, t)
...
TeamSelectionMenuPage._update_input = function (self, input)
...
TeamSelectionMenuPage._update_container_size = function (self, dt, t)
...
TeamSelectionMenuPage._update_container_position = function (self, dt, t)
...
TeamSelectionMenuPage.render = function (self, dt, t, rendered_from_child_page)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
TeamSelectionMenuPage._render_button_info = function (self, layout_settings)
	if not self._rendered_from_child_page then
		self.super._render_button_info(self, layout_settings)
	end
end

TeamSelectionMenuPage.cb_quote_text = function (self)
	return L("team_selection_quote")
end

TeamSelectionMenuPage.cb_join_team_selected = function (self, team_name)
	Managers.state.team:request_join_team(self._local_player, team_name)

	self._joining_team = true
end

TeamSelectionMenuPage.cb_join_team_selection_disabled = function (self, team_name)
	return self._joining_team or not Managers.state.team:verify_join_team(self._local_player, team_name)
end

TeamSelectionMenuPage.cb_auto_join_team = function (self)
...
TeamSelectionMenuPage._auto_highlight_first_item = function (self)
	return
end

TeamSelectionMenuPage.cb_auto_join_team_disabled = function (self)
	return self._joining_team
end

TeamSelectionMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
		type = "team_selection",
