...
Level2MenuPage.init = function (self, config, item_groups, world)
...
Level2MenuPage._update_container_size = function (self, dt, t)
...
Level2MenuPage._update_container_position = function (self, dt, t)
...
Level2MenuPage.render_from_child_page = function (self, dt, t, leef)
	local layout_settings = MenuHelper:layout_settings(self.config.layout_settings)
...
Level2MenuPage.render = function (self, dt, t)
...
Level2MenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
