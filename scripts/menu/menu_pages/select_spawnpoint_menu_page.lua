...
SelectSpawnpointMenuPage.init = function (self, config, item_groups, world)
...
SelectSpawnpointMenuPage._add_map_item = function (self)
...
SelectSpawnpointMenuPage.update = function (self, dt, t, input)
...
SelectSpawnpointMenuPage._update_game_start_timer = function (self)
...
SelectSpawnpointMenuPage.on_enter = function (self)
...
SelectSpawnpointMenuPage._update_map_markers = function (self, dt, t)
...
SelectSpawnpointMenuPage._update_area_markers = function (self)
...
SelectSpawnpointMenuPage._update_squad_markers = function (self)
	local spawn_manager = Managers.state.spawn
	local local_player = self._local_player
...
SelectSpawnpointMenuPage._update_objective_markers = function (self)
	local local_player = self._local_player
...
SelectSpawnpointMenuPage._update_local_player_markers = function (self)
	local local_player = self._local_player
...
SelectSpawnpointMenuPage._disabled_squad_marker = function (self, member)
...
SelectSpawnpointMenuPage._valid_local_player_marker = function (self)
	local local_player = self._local_player
...
SelectSpawnpointMenuPage._valid_objective_marker = function (self, unit)
	local objective_units = Managers.state.game_mode:objective_units()

	return table.find(objective_units, unit)
end

SelectSpawnpointMenuPage._in_own_squad = function (self, member)
...
SelectSpawnpointMenuPage._in_other_squad_same_team = function (self, member)
	return member.squad_index and member.squad_index ~= self._local_player.squad_index and self._local_player.team and member.team == self._local_player.team and member ~= self._local_player
end

SelectSpawnpointMenuPage._select_next_spawn_target = function (self)
	for _, item in ipairs(self:items_in_group("squad_markers")) do
...
SelectSpawnpointMenuPage.event_player_joined_squad = function (self, player, squad_index)
...
SelectSpawnpointMenuPage.event_player_left_squad = function (self, player, squad_index)
	if self._local_player.team ~= player.team then
		return
	end
...
SelectSpawnpointMenuPage.event_player_joined_team = function (self, player)
	if self._local_player.team == player.team then
...
SelectSpawnpointMenuPage.cb_select_spawn_area = function (self, spawn_area_name)
	local local_player = self._local_player
...
SelectSpawnpointMenuPage.cb_select_squad_member = function (self, squad_member)
	local local_player = self._local_player
...
SelectSpawnpointMenuPage.cb_request_spawn_target = function (self)
	local spawn_marker = self:find_item_by_name(self._selected_spawn_target)
...
SelectSpawnpointMenuPage.cb_request_spawn_disabled = function (self)
	return not self._selected_spawn_target
end

SelectSpawnpointMenuPage.cb_join_squad = function (self, squad_index)
	if self._local_player.team then
		self._local_player.team.squads[squad_index]:request_to_join(self._local_player)
	end
end

SelectSpawnpointMenuPage.cb_leave_squad = function (self, squad_index)
	if self._local_player.team then
		self._local_player.team.squads[squad_index]:request_to_leave(self._local_player)
	end
end

SelectSpawnpointMenuPage._add_spawn_area_marker = function (self, spawn_area_name, position)
	local config = {
...
SelectSpawnpointMenuPage._remove_spawn_area_marker = function (self, item)
...
SelectSpawnpointMenuPage._add_objective_marker = function (self, objective_unit)
...
SelectSpawnpointMenuPage._remove_objective_marker = function (self, item)
	self:remove_item_from_group("objective_markers", item)
end

SelectSpawnpointMenuPage._add_squad_marker = function (self, player)
	local config = {
...
SelectSpawnpointMenuPage._remove_squad_marker = function (self, item)
	if self._selected_spawn_target == item:name() then
		self._selected_spawn_target = nil
	end
...
SelectSpawnpointMenuPage._add_local_player_marker = function (self)
	local config = {
		disabled = true,
...
SelectSpawnpointMenuPage._remove_local_player_marker = function (self)
...
SelectSpawnpointMenuPage._set_selected_spawn_target = function (self, selected_spawn_target)
	if self._selected_spawn_target then
...
SelectSpawnpointMenuPage._update_container_size = function (self, dt, t)
...
SelectSpawnpointMenuPage._update_container_position = function (self, dt, t)
...
SelectSpawnpointMenuPage.render = function (self, dt, t)
...
SelectSpawnpointMenuPage._first_highlightable_index_of_type = function (self, type)
...
SelectSpawnpointMenuPage._first_item_of_type = function (self, type)
	for index, item in ipairs(self._items) do
		if item:highlightable() and (not type or item.config.type == type) then
			return index
		end
...
SelectSpawnpointMenuPage._find_index_of_item = function (self, selected_item)
...
SelectSpawnpointMenuPage._select_next_spawnpoint = function (self)
	local index
...
SelectSpawnpointMenuPage._select_previous_spawnpoint = function (self)
	local index
...
SelectSpawnpointMenuPage.move_up = function (self)
...
SelectSpawnpointMenuPage.move_down = function (self)
	local controller_active = Managers.input:pad_active(1)
...
SelectSpawnpointMenuPage._update_input = function (self, input)
	if not input then
		return
	end
...
SelectSpawnpointMenuPage.cb_squad_text_visible = function (self, squad_num)
	return self._local_player.team and squad_num <= #self._local_player.team.squads
end

SelectSpawnpointMenuPage.cb_squad_button_visible = function (self, squad_num)
	return self._local_player.team and squad_num <= #self._local_player.team.squads
end

SelectSpawnpointMenuPage.cb_squad_button_disabled = function (self, squad_num)
...
SelectSpawnpointMenuPage.destroy = function (self)
	SelectSpawnpointMenuPage.super.destroy(self)
end

SelectSpawnpointMenuPage.create_from_config = function (compiler_data, page_config, parent_page, item_groups, callback_object)
	local config = {
