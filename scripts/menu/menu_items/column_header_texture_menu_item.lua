...
ColumnHeaderTextureMenuItem.init = function (self, config, world)
	ColumnHeaderTextureMenuItem.super.init(self, config, world)

	self._sort_order = self._default_sort_order
end

ColumnHeaderTextureMenuItem.on_select = function (self, ignore_sound)
...
ColumnHeaderTextureMenuItem.update_size = function (self, dt, t, gui, layout_settings, w, h)
	self._width = w
	self._height = h
end

ColumnHeaderTextureMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

ColumnHeaderTextureMenuItem.render = function (self, dt, t, gui, layout_settings)
...
ColumnHeaderTextureMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
