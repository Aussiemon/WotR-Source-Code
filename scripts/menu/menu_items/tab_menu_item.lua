...
TabMenuItem.init = function (self, config, world)
	TabMenuItem.super.init(self, config, world)
	self:set_selected(false)
end

TabMenuItem.on_select = function (self, ignore_sound)
	self:set_selected(true)
	TabMenuItem.super.on_select(self, ignore_sound)
end

TabMenuItem.on_deselect = function (self)
	self:set_selected(false)
end

TabMenuItem.set_selected = function (self, selected)
	self._selected = selected
end

TabMenuItem.selected = function (self)
	return self._selected
end

TabMenuItem.set_text = function (self, text)
	self.config.text = text
end

TabMenuItem.start_pulse = function (self, speed, alpha_min, alpha_max)
	self._pulse = {
		speed = speed,
		alpha_min = alpha_min,
		alpha_max = alpha_max
...
TabMenuItem.stop_pulse = function (self, speed, alpha_min, alpha_max)
	self._pulse = nil
end

TabMenuItem.pulse = function (self)
	return self._pulse
end

TabMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
TabMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

TabMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
	self:render(dt, t, gui, layout_settings)
end

TabMenuItem.render = function (self, dt, t, gui, layout_settings)
...
TabMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "tab",
		name = config.name,
		page = config.page,
