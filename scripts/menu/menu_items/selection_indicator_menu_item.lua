...
SelectionIndicatorMenuItem.init = function (self, config, world)
...
SelectionIndicatorMenuItem.on_select = function (self, ignore_sound)
...
SelectionIndicatorMenuItem.update = function (self, dt, t)
...
SelectionIndicatorMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self:update(dt, t)
...
SelectionIndicatorMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
...
SelectionIndicatorMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
	return
end

SelectionIndicatorMenuItem.render = function (self, dt, t, gui, layout_settings)
...
SelectionIndicatorMenuItem.on_page_enter = function (self)
...
SelectionIndicatorMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
