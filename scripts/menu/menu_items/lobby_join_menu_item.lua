...
LobbyJoinMenuItem.init = function (self, config, world)
	LobbyJoinMenuItem.super.init(self, config, world)

	self._refresh = true
end

LobbyJoinMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self._width = 800
	self._height = 30
end

LobbyJoinMenuItem.update_position = function (self, dt, t, layout_settings, x, y)
	self._x = x
	self._y = y
end

LobbyJoinMenuItem.render = function (self, dt, t, gui, layout_settings)
...
LobbyJoinMenuItem.on_page_exit = function (self)
...
LobbyJoinMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "lobby_join",
		page = config.page,
