...
ProgressBarMenuItem.init = function (self, config, world)
...
ProgressBarMenuItem.set_bar_data = function (self, data)
	self._bar_data = data
end

ProgressBarMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
ProgressBarMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x + self._offset_x
	self._y = y
	self._z = z
end

ProgressBarMenuItem.render = function (self, dt, t, gui, layout_settings)
...
ProgressBarMenuItem.on_page_enter = function (self)
...
ProgressBarMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "progress_bar",
		page = config.page,
		name = config.name,
