...
ScoreboardPlayerMenuItem.init = function (self, config, world)
...
ScoreboardPlayerMenuItem.update_size = function (self, dt, t, gui, layout_settings, w, h)
	self._width = w
	self._height = h
end

ScoreboardPlayerMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

ScoreboardPlayerMenuItem.render = function (self, dt, t, gui, layout_settings)
...
ScoreboardPlayerMenuItem.score = function (self)
	return self._stats:get(self._network_id, "experience_round")
end

ScoreboardPlayerMenuItem.player_name = function (self)
	return self._player:name()
end

ScoreboardPlayerMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
