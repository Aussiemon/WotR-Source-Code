...
OutfitCheckboxMenuItem.init = function (self, config, world)
	OutfitCheckboxMenuItem.super.init(self, config, world)
end

OutfitCheckboxMenuItem.on_select = function (self, ignore_sound)
...
OutfitCheckboxMenuItem.update_disabled = function (self)
...
OutfitCheckboxMenuItem.render = function (self, dt, t, gui, layout_settings)
...
OutfitCheckboxMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
	if not self.config.avalible then
		local texture, text, text_color = MenuHelper.outfit_menu_item_requirement_info(layout_settings, self.config)
...
OutfitCheckboxMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
