...
AtlasTextureMenuItem.init = function (self, config, world)
	AtlasTextureMenuItem.super.init(self, config, world)
end

AtlasTextureMenuItem.on_page_enter = function (self)
...
AtlasTextureMenuItem.update = function (self, dt, t)
...
AtlasTextureMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self:update(dt, t)
...
AtlasTextureMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

AtlasTextureMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
...
AtlasTextureMenuItem.render = function (self, dt, t, gui, layout_settings)
...
AtlasTextureMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "atlas_texture",
		name = config.name,
