...
LobbyPracticeMenuItem.init = function (self, config, world)
...
LobbyPracticeMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self._width = 600
	self._height = 30
end

LobbyPracticeMenuItem.update_position = function (self, dt, t, layout_settings, x, y)
	self._x = x
	self._y = y
end

LobbyPracticeMenuItem.render = function (self, dt, t, gui, layout_settings)
...
LobbyPracticeMenuItem.cb_lobby_created = function (self)
	self._refresh_lobby_data = true
end

LobbyPracticeMenuItem._level_list = function (self)
	local options = {}
	local num_options = 0
...
LobbyPracticeMenuItem.select_next_level = function (self)
...
LobbyPracticeMenuItem.selected_level = function (self)
	return self._levels[self._selected_level_index].level_key
end

LobbyPracticeMenuItem._game_mode_list = function (self)
	return LevelSettings[self:selected_level()].game_modes or {}
end

LobbyPracticeMenuItem.select_next_game_mode = function (self)
...
LobbyPracticeMenuItem.on_page_exit = function (self)
...
LobbyPracticeMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "lobby_practice",
		page = config.page,
