...
BattleReportSummaryAwardMenuItem.init = function (self, config, world)
...
BattleReportSummaryAwardMenuItem.start = function (self, play_animation)
...
BattleReportSummaryAwardMenuItem._anim_fade_in = function (self, dt, t, gui, layout_settings)
...
BattleReportSummaryAwardMenuItem._anim_idle = function (self)
	return
end

BattleReportSummaryAwardMenuItem.update_size = function (self, dt, t, gui, layout_settings, w, h)
	self._width = w
	self._height = h
...
BattleReportSummaryAwardMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
...
BattleReportSummaryAwardMenuItem.render = function (self, dt, t, gui, layout_settings)
...
BattleReportSummaryAwardMenuItem._render_gui = function (self, dt, t, gui, layout_settings)
...
BattleReportSummaryAwardMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
