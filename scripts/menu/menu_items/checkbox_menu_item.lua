...
CheckboxMenuItem.init = function (self, config, world)
	CheckboxMenuItem.super.init(self, config, world)
end

CheckboxMenuItem.on_page_enter = function (self)
...
CheckboxMenuItem.render = function (self, dt, t, gui, layout_settings)
...
CheckboxMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
