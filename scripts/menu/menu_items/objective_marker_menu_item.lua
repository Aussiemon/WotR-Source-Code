...
ObjectiveMarkerMenuItem.init = function (self, config, world)
...
ObjectiveMarkerMenuItem.update_size = function (self, dt, t, gui, layout_settings, layout_settings_2)
...
ObjectiveMarkerMenuItem._update_size = function (self, dt, t, gui, layout_settings)
...
ObjectiveMarkerMenuItem.update_position = function (self, dt, t, layout_settings, layout_settings_2, x, y, z, minimap_props)
...
ObjectiveMarkerMenuItem.render = function (self, dt, t, gui, layout_settings, layout_settings_2, minimap_props)
...
ObjectiveMarkerMenuItem._render_texture = function (self, dt, t, gui, layout_settings, minimap_props, w, h)
	local blackboard = self._blackboard
...
ObjectiveMarkerMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
