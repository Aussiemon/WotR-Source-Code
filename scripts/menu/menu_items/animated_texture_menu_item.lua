...
AnimatedTextureMenuItem.init = function (self, config, world)
	AnimatedTextureMenuItem.super.init(self, config, world)

	self._frame = 0
end

AnimatedTextureMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
AnimatedTextureMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

AnimatedTextureMenuItem.render = function (self, dt, t, gui, layout_settings)
...
AnimatedTextureMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
