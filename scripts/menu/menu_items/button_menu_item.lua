...
ButtonMenuItem.init = function (self, config, world)
	ButtonMenuItem.super.init(self, config, world)
end

ButtonMenuItem.set_text = function (self, text)
	self.config.text = text
end

ButtonMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
ButtonMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
...
ButtonMenuItem.render = function (self, dt, t, gui, layout_settings)
...
ButtonMenuItem._render_background = function (self, gui, layout_settings)
...
ButtonMenuItem._render_text = function (self, gui, layout_settings)
...
ButtonMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = config.type,
