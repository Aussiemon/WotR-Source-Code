...
ColumnHeaderTextMenuItem.init = function (self, config, world)
...
ColumnHeaderTextMenuItem.on_select = function (self, ignore_sound)
...
ColumnHeaderTextMenuItem.update_size = function (self, dt, t, gui, layout_settings, w, h)
	self._width = w
	self._height = h
end

ColumnHeaderTextMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

ColumnHeaderTextMenuItem.render = function (self, dt, t, gui, layout_settings)
...
ColumnHeaderTextMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
