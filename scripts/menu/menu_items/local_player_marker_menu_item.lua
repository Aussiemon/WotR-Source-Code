...
LocalPlayerMarkerMenuItem.init = function (self, config, world)
	LocalPlayerMarkerMenuItem.super.init(self, config, world)

	self._player = config.player
end

LocalPlayerMarkerMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self._width = layout_settings.texture_width
	self._height = layout_settings.texture_height
end

LocalPlayerMarkerMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z, minimap_props)
...
LocalPlayerMarkerMenuItem.render = function (self, dt, t, gui, layout_settings, minimap_props)
...
LocalPlayerMarkerMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
