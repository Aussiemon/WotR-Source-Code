...
TextureMenuItem.init = function (self, config, world)
	TextureMenuItem.super.init(self, config, world)
	self:set_selected(false)
end

TextureMenuItem.on_page_enter = function (self)
...
TextureMenuItem.set_selected = function (self, selected)
	self._selected = selected
end

TextureMenuItem.selected = function (self)
	return self._selected
end

TextureMenuItem.removed = function (self)
	return self.config.removed
end

TextureMenuItem.update = function (self, dt, t)
...
TextureMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
TextureMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

TextureMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
...
TextureMenuItem.render = function (self, dt, t, gui, layout_settings)
...
TextureMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "texture",
		page = config.page,
		name = config.name,
