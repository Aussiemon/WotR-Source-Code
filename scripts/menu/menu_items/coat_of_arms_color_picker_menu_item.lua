...
CoatOfArmsColorPickerMenuItem.init = function (self, config, world)
	CoatOfArmsColorPickerMenuItem.super.init(self, config, world)
	self:set_selected(false)
end

CoatOfArmsColorPickerMenuItem.set_selected = function (self, selected)
	self._selected = selected
end

CoatOfArmsColorPickerMenuItem.selected = function (self)
	return self._selected
end

CoatOfArmsColorPickerMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
CoatOfArmsColorPickerMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

CoatOfArmsColorPickerMenuItem.render = function (self, dt, t, gui, layout_settings)
...
CoatOfArmsColorPickerMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
