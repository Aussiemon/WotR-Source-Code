...
CoatOfArmsMenuItem.init = function (self, config, world)
	CoatOfArmsMenuItem.super.init(self, config, world)
	self:set_selected(false)
end

CoatOfArmsMenuItem.set_selected = function (self, selected)
	self._selected = selected
end

CoatOfArmsMenuItem.selected = function (self)
	return self._selected
end

CoatOfArmsMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
CoatOfArmsMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

CoatOfArmsMenuItem.render = function (self, dt, t, gui, layout_settings)
...
CoatOfArmsMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "coat_of_arms",
		page = config.page,
