...
LoadingTextureMenuItem.init = function (self, config, world)
	LoadingTextureMenuItem.super.init(self, config, world)

	self._rotation = 0
end

LoadingTextureMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
LoadingTextureMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

LoadingTextureMenuItem.render = function (self, dt, t, gui, layout_settings)
...
LoadingTextureMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
