...
LobbyHostMenuItem.init = function (self, config, world)
...
LobbyHostMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self._width = 600
	self._height = 30
end

LobbyHostMenuItem.update_position = function (self, dt, t, layout_settings, x, y)
	self._x = x
	self._y = y
end

LobbyHostMenuItem.render = function (self, dt, t, gui, layout_settings)
...
LobbyHostMenuItem.cb_lobby_created = function (self)
	self._refresh_lobby_data = true
end

LobbyHostMenuItem._level_list = function (self)
	local options = {}
	local num_options = 0
...
LobbyHostMenuItem.select_next_level = function (self)
...
LobbyHostMenuItem.selected_level = function (self)
	return self._levels[self._selected_level_index].level_key
end

LobbyHostMenuItem._game_mode_list = function (self)
	return LevelSettings[self:selected_level()].game_modes or {}
end

LobbyHostMenuItem.select_next_game_mode = function (self)
...
LobbyHostMenuItem.on_page_exit = function (self)
...
LobbyHostMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "lobby_host",
		page = config.page,
