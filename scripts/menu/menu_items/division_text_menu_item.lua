...
DivisionTextMenuItem.render = function (self, dt, t, gui, layout_settings)
...
DivisionTextMenuItem._render_background = function (self, gui, rect, thickness, color, layer, layout_settings)
	Gui.bitmap(gui, "division", Vector3(rect[1], rect[2], layer), Vector2(rect[3], -rect[4]), color)
end

DivisionTextMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "division",
