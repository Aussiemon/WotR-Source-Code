...
SquadMarkerMenuItem.init = function (self, config, world)
...
SquadMarkerMenuItem.set_selected = function (self, selected)
	self._selected = selected
end

SquadMarkerMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self._width = layout_settings.squad_textures_width
	self._height = layout_settings.squad_textures_height
end

SquadMarkerMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z, minimap_props)
...
SquadMarkerMenuItem.render = function (self, dt, t, gui, layout_settings)
	local squad_texture
...
SquadMarkerMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
