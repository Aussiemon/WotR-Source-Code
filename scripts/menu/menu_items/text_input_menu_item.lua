...
TextInputMenuItem.init = function (self, config, world)
...
TextInputMenuItem.set_text = function (self, text)
	self._text = text
...
TextInputMenuItem._utf8chars = function (self, text)
...
TextInputMenuItem.text = function (self)
	return self._text
end

TextInputMenuItem.validate_text_length = function (self)
	return self:_utf8chars(self._text) >= self.config.min_text_length
end

TextInputMenuItem._update_input_text = function (self)
...
TextInputMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
TextInputMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

TextInputMenuItem.render = function (self, dt, t, gui, layout_settings)
	local font = layout_settings.font and layout_settings.font.font or MenuSettings.fonts.menu_font.font
...
TextInputMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "text_input",
		page = config.page,
		name = config.name,
