...
OutfitTextMenuItem.init = function (self, config, world)
	OutfitTextMenuItem.super.init(self, config, world)
end

OutfitTextMenuItem.on_select = function (self, ignore_sound)
...
OutfitTextMenuItem.update_disabled = function (self)
...
OutfitTextMenuItem.render = function (self, dt, t, gui, layout_settings)
...
OutfitTextMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
	if not self.config.avalible then
		local texture, text, text_color = MenuHelper.outfit_menu_item_requirement_info(layout_settings, self.config)
...
OutfitTextMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "outfit_text",
		name = config.name,
