...
TextBoxMenuItem.init = function (self, config, world)
	TextBoxMenuItem.super.init(self, config, world)
end

TextBoxMenuItem.on_page_enter = function (self)
...
TextBoxMenuItem.set_text = function (self, text)
	self.config.text = text
end

TextBoxMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self:update(dt, t)
...
TextBoxMenuItem.update = function (self, dt, t)
...
TextBoxMenuItem._update_text_table = function (self, text, gui, layout_settings)
...
TextBoxMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

TextBoxMenuItem.render = function (self, dt, t, gui, layout_settings)
...
TextBoxMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "text_box",
		page = config.page,
		name = config.name,
