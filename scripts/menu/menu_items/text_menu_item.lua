...
TextMenuItem.init = function (self, config, world)
	TextMenuItem.super.init(self, config, world)
	self:set_selected(false)
end

TextMenuItem.on_select = function (self, ignore_sound)
...
TextMenuItem.on_deselect = function (self)
	self:set_selected(false)
end

TextMenuItem.set_selected = function (self, selected)
	self._selected = selected
end

TextMenuItem.selected = function (self)
	return self._selected
end

TextMenuItem.set_text = function (self, text)
	self.config.text = text
end

TextMenuItem.update = function (self, dt, t)
...
TextMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self:update(dt, t)
...
TextMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
...
TextMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
...
TextMenuItem.render = function (self, dt, t, gui, layout_settings)
...
TextMenuItem.on_page_enter = function (self)
...
TextMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "text",
		page = config.page,
		name = config.name,
