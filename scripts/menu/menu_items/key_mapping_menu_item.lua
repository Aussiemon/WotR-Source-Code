...
KeyMappingMenuItem.init = function (self, config, world)
	KeyMappingMenuItem.super.init(self, config, world)
	self.config.page:set_key_item(self)
end

KeyMappingMenuItem.on_select = function (self, ignore_sound)
	KeyMappingMenuItem.super.on_select(self, ignore_sound)

	self._selected = true
end

KeyMappingMenuItem.on_deselect = function (self)
	self._selected = false
end

KeyMappingMenuItem.set_identical_keybinding = function (self, state)
	self._identical_binding = state
end

KeyMappingMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
...
KeyMappingMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
KeyMappingMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

KeyMappingMenuItem.render = function (self, dt, t, gui, layout_settings)
...
KeyMappingMenuItem._render = function (self, dt, t, gui, layout_settings, rendered_from_child_page)
	local config = self.config
...
KeyMappingMenuItem.key_name = function (self)
	return self.config.key_name
end

KeyMappingMenuItem.keys = function (self)
	return self.config.keys
end

KeyMappingMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "key_mapping",
		page = config.page,
