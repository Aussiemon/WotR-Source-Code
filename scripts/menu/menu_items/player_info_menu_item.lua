...
PlayerInfoMenuItem.init = function (self, config, world)
...
PlayerInfoMenuItem.on_select = function (self, ignore_sound)
	self:set_selected(true)
	PlayerInfoMenuItem.super.on_select(self, ignore_sound)
end

PlayerInfoMenuItem.on_deselect = function (self)
	self:set_selected(false)
end

PlayerInfoMenuItem.set_selected = function (self, selected)
	self._selected = selected
end

PlayerInfoMenuItem.selected = function (self)
	return self._selected
end

PlayerInfoMenuItem.update_size = function (self, dt, t, gui, layout_settings, w, h)
	self._width = w
	self._height = h
end

PlayerInfoMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

PlayerInfoMenuItem.render = function (self, dt, t, gui, layout_settings)
...
PlayerInfoMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "player_info",
		page = config.page,
		name = config.name,
