...
ScrollBarMenuItem.init = function (self, config, world)
...
ScrollBarMenuItem.set_grid_properties = function (self, top_visible_row, num_visible_rows, total_num_of_rows)
...
ScrollBarMenuItem.update_size = function (self, dt, t, gui, layout_settings, w, h, scroll_height)
	self._width = w
	self._height = h
	self._scroll_height = scroll_height
end

ScrollBarMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

ScrollBarMenuItem.highlightable = function (self)
	return false
end

ScrollBarMenuItem.render = function (self, dt, t, gui, layout_settings)
...
ScrollBarMenuItem.on_select_down = function (self, mouse_pos)
	local handle_height = math.max(self._grid_num_visible_rows / self._grid_total_num_of_rows * self._scroll_height, self._min_handle_height)
...
ScrollBarMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "scroll_bar",
		name = config.name,
