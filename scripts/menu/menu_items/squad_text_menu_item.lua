...
SquadTextMenuItem.init = function (self, config, world)
...
SquadTextMenuItem.set_joined = function (self, joined)
	self._joined = joined
end

SquadTextMenuItem.set_num_max_members = function (self, num_max_members)
	self._num_max_members = num_max_members
end

SquadTextMenuItem.set_num_members = function (self, num_members)
	self._num_members = num_members
end

SquadTextMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
SquadTextMenuItem.render = function (self, dt, t, gui, layout_settings)
...
SquadTextMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "squad_text",
		page = config.page,
