...
DropDownListMenuItem.init = function (self, config, world)
...
DropDownListMenuItem.update_size = function (self, dt, t, gui, layout_settings)
...
DropDownListMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

DropDownListMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
	self:render(dt, t, gui, layout_settings, true)
end

DropDownListMenuItem.render = function (self, dt, t, gui, layout_settings, rendered_from_child)
...
DropDownListMenuItem.description_text_width = function (self)
	return self._description_text_width
end

DropDownListMenuItem.description_text_height = function (self)
	return self._description_text_height
end

DropDownListMenuItem.on_page_enter = function (self)
...
DropDownListMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "drop_down_list",
		name = config.name,
		page = config.page,
