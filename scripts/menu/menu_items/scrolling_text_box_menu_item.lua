...
ScrollingTextBoxMenuItem.init = function (self, config, world)
...
ScrollingTextBoxMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self:update(dt, t)
...
ScrollingTextBoxMenuItem.on_select_down = function (self, mouse_pos)
...
ScrollingTextBoxMenuItem.scroll = function (self, amount)
	local new_scroll_value = self._scroll_offset + amount

	self:set_scroll_value(new_scroll_value)
end

ScrollingTextBoxMenuItem.set_scroll_value = function (self, value)
	if value < 0 then
		value = 0
...
ScrollingTextBoxMenuItem.update = function (self, dt, t)
...
ScrollingTextBoxMenuItem._update_text_table = function (self, text, gui, layout_settings)
...
ScrollingTextBoxMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z or 1
end

ScrollingTextBoxMenuItem.render = function (self, dt, t, gui, layout_settings)
...
ScrollingTextBoxMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
