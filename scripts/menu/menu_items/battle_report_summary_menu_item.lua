...
BattleReportSummaryMenuItem.init = function (self, config, world)
...
BattleReportSummaryMenuItem.start = function (self, data, play_animation)
...
BattleReportSummaryMenuItem.update_size = function (self, dt, t, gui, layout_settings, w, h)
	self._width = w
	self._height = h
end

BattleReportSummaryMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

BattleReportSummaryMenuItem.render = function (self, dt, t, gui, layout_settings)
...
BattleReportSummaryMenuItem._anim_fade_in = function (self, dt, t, gui, layout_settings)
...
BattleReportSummaryMenuItem._anim_increment = function (self, dt, t, gui, layout_settings)
	local xp_delta = 0
	local coins_delta = 0
...
BattleReportSummaryMenuItem._anim_fade_out = function (self, dt, t, gui, layout_settings)
...
BattleReportSummaryMenuItem._anim_pulse = function (self, dt, t, gui, layout_settings)
...
BattleReportSummaryMenuItem._anim_idle = function (self)
	return
end

BattleReportSummaryMenuItem._render_gui = function (self, dt, t, gui, layout_settings)
...
BattleReportSummaryMenuItem._render_text = function (self, text, offset_x, offset_y, gui, layout_settings)
...
BattleReportSummaryMenuItem._render_fade_out_text = function (self, text, offset_x, offset_y, gui, layout_settings)
	local font = layout_settings.font and layout_settings.font.font or MenuSettings.fonts.menu_font.font
	local font_material = layout_settings.font and layout_settings.font.material or MenuSettings.fonts.menu_font.material
	local c = layout_settings.text_color
	local color = Color(c[1], c[2], c[3], c[4])
...
BattleReportSummaryMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		disabled = true,
