...
BattleReportScoreboardMenuItem.init = function (self, config, world)
...
BattleReportScoreboardMenuItem.update_size = function (self, dt, t, gui, layout_settings, w, h)
	self._width = w
	self._height = h
end

BattleReportScoreboardMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

BattleReportScoreboardMenuItem.render = function (self, dt, t, gui, layout_settings)
...
BattleReportScoreboardMenuItem.score = function (self)
	return self._stats:get(self._network_id, "experience_round")
end

BattleReportScoreboardMenuItem.stats = function (self, name)
	return self._stats:get(self._network_id, name)
end

BattleReportScoreboardMenuItem.player_name = function (self)
	return self._player_name
end

BattleReportScoreboardMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
