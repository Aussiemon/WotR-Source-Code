...
TextureLinkButtonMenuItem.init = function (self, config, world)
	TextureLinkButtonMenuItem.super.init(self, config, world)
end

TextureLinkButtonMenuItem.update_size = function (self, dt, t, gui, layout_settings)
	self._width = layout_settings.texture_width
	self._height = layout_settings.texture_height
end

TextureLinkButtonMenuItem.update_position = function (self, dt, t, layout_settings, x, y, z)
...
TextureLinkButtonMenuItem.render_from_child_page = function (self, dt, t, gui, layout_settings)
...
TextureLinkButtonMenuItem.render = function (self, dt, t, gui, layout_settings)
...
TextureLinkButtonMenuItem.create_from_config = function (compiler_data, config, callback_object)
	local config = {
		type = "link_button",
		name = config.name,
		page = config.page,
