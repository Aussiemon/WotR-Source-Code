...
NewsTickerMenuContainer.init = function (self)
	NewsTickerMenuContainer.super.init(self)

	self._text_table = nil
end

NewsTickerMenuContainer.load = function (self)
	self._anim_offset_x = 0

	Managers.news_ticker:load(callback(self, "cb_news_ticker_loaded"))
end

NewsTickerMenuContainer.cb_news_ticker_loaded = function (self, info)
...
NewsTickerMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
NewsTickerMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

NewsTickerMenuContainer.render = function (self, dt, t, gui, layout_settings)
