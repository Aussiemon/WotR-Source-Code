...
TextBoxMenuContainer.init = function (self)
	TextBoxMenuContainer.super.init(self)

	self._text = nil
end

TextBoxMenuContainer.set_text = function (self, text, layout_settings, gui)
...
TextBoxMenuContainer.clear_text = function (self)
	self._text = nil
end

TextBoxMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
TextBoxMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

TextBoxMenuContainer.render = function (self, dt, t, gui, layout_settings)
	if self._text then
...
TextBoxMenuContainer.create_from_config = function ()
