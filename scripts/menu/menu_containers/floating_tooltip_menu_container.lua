...
FloatingTooltipMenuContainer.init = function (self, header, text, parent_item)
...
FloatingTooltipMenuContainer.is_playing = function (self)
	return self._playing
end

FloatingTooltipMenuContainer.play = function (self)
	self._playing = true
...
FloatingTooltipMenuContainer.stop = function (self)
	self._playing = false
...
FloatingTooltipMenuContainer._anim_fade_in_delay = function (self, dt, t, gui, layout_settings)
...
FloatingTooltipMenuContainer._anim_fade_in = function (self, dt, t, gui, layout_settings)
	self._alpha_multiplier = math.lerp(self._alpha_multiplier, 1, dt * layout_settings.fade_in_speed)
end

FloatingTooltipMenuContainer._anim_fade_out_delay = function (self, dt, t, gui, layout_settings)
...
FloatingTooltipMenuContainer._anim_fade_out = function (self, dt, t, gui, layout_settings)
	self._alpha_multiplier = math.lerp(self._alpha_multiplier, 0, dt * layout_settings.fade_out_speed)
end

FloatingTooltipMenuContainer._reset_animations = function (self)
...
FloatingTooltipMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
FloatingTooltipMenuContainer._update_text_table = function (self, text, gui, layout_settings, width)
...
FloatingTooltipMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

FloatingTooltipMenuContainer.render = function (self, dt, t, gui, layout_settings)
...
FloatingTooltipMenuContainer._render_gui = function (self, dt, t, gui, layout_settings)
...
FloatingTooltipMenuContainer.create_from_config = function (header, text, parent_item)
