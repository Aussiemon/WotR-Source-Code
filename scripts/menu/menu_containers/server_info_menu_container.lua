...
ServerInfoMenuContainer.init = function (self, page, player_list_item_group)
...
ServerInfoMenuContainer.clear = function (self)
	self._player_list_item_group = {}
	self._server = nil
end

ServerInfoMenuContainer.set_server = function (self, server)
	self:clear()
...
ServerInfoMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
ServerInfoMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
...
ServerInfoMenuContainer.render = function (self, dt, t, gui, layout_settings)
	local server = self._server
...
ServerInfoMenuContainer.create_from_config = function (page, player_list_item_group)
