...
TextMenuContainer.init = function (self, text)
...
TextMenuContainer.set_text = function (self, text)
	self._text = text
end

TextMenuContainer.set_rendering = function (self, rendering)
	self._rendering = rendering
end

TextMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
TextMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

TextMenuContainer.render = function (self, dt, t, gui, layout_settings)
...
TextMenuContainer.create_from_config = function (text)
