...
TipOfTheDayMenuContainer.init = function (self, world)
...
TipOfTheDayMenuContainer.load_tip = function (self, tip_name, level_name, layout_settings, gui)
...
TipOfTheDayMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
TipOfTheDayMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
...
TipOfTheDayMenuContainer.render = function (self, dt, t, gui, layout_settings)
...
TipOfTheDayMenuContainer.destroy = function (self)
...
TipOfTheDayMenuContainer.create_from_config = function (world)
