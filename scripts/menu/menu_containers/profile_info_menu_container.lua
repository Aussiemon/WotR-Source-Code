...
ProfileInfoMenuContainer.init = function (self)
...
ProfileInfoMenuContainer.clear = function (self)
...
ProfileInfoMenuContainer.set_active = function (self, active)
	self._active = active
end

ProfileInfoMenuContainer.load = function (self, profile)
	self:clear()
...
ProfileInfoMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
ProfileInfoMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	if not self._active then
		return
	end
...
ProfileInfoMenuContainer.render = function (self, dt, t, gui, layout_settings)
	if not self._active then
		return
	end
...
ProfileInfoMenuContainer._render_texts = function (self, dt, t, gui, layout_settings)
...
ProfileInfoMenuContainer.create_from_config = function ()
