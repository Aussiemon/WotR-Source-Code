...
SpawnPointMenuContainer.init = function (self, local_player, map, squad_markers, spawn_areas, objective_markers, local_player_marker)
...
SpawnPointMenuContainer._init_map_bounding_box = function (self)
...
SpawnPointMenuContainer._update_objectives_description_text = function (self, gui, layout_settings)
...
SpawnPointMenuContainer._set_level_description = function (self, gui, layout_settings)
...
SpawnPointMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
SpawnPointMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	local map = self._map[1]
	local map_layout_settings = MenuHelper:layout_settings(map.config.layout_settings)
...
SpawnPointMenuContainer.render = function (self, dt, t, gui, layout_settings)
	local map = self._map[1]
	local map_layout_settings = MenuHelper:layout_settings(map.config.layout_settings)
...
SpawnPointMenuContainer.create_from_config = function (local_player, map, markers, spawn_areas, objective_markers, local_player_marker)
