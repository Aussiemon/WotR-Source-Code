...
CoatOfArmsViewerMenuContainer.init = function (self, world_name, viewport_name)
...
CoatOfArmsViewerMenuContainer.add_alignment_unit = function (self, name, unit)
	self._alignment_units[name] = unit
end

CoatOfArmsViewerMenuContainer.clear = function (self)
	self:remove_unit("shield")
end

CoatOfArmsViewerMenuContainer.load_coat_of_arms = function (self, settings, offset_forward, offset_up, offset_right)
	self:remove_unit("shield")
...
CoatOfArmsViewerMenuContainer.load_shield = function (self, settings, offset_forward, offset_up, offset_right)
...
CoatOfArmsViewerMenuContainer.set_coat_of_arms_material_properties = function (self, settings)
...
CoatOfArmsViewerMenuContainer.load_helmet = function (self, settings)
...
CoatOfArmsViewerMenuContainer.load_helmet_crest = function (self, settings)
...
CoatOfArmsViewerMenuContainer.render = function (self, dt, t, gui, layout_settings)
	local world = Managers.world:world(self._world_name)
	local viewport = ScriptWorld.viewport(world, self._viewport_name)
...
CoatOfArmsViewerMenuContainer.create_from_config = function (world_name, viewport_name)
