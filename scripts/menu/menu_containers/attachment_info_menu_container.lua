...
AttachmentInfoMenuContainer.init = function (self)
	AttachmentInfoMenuContainer.super.init(self)

	self._attachment_settings = {}
end

AttachmentInfoMenuContainer.clear = function (self)
	self._attachment_settings = {}
end

AttachmentInfoMenuContainer.load_gear_attachment = function (self, gear_name, attachment_category, attachment_name)
...
AttachmentInfoMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
AttachmentInfoMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

AttachmentInfoMenuContainer.render = function (self, dt, t, gui, layout_settings)
...
AttachmentInfoMenuContainer.create_from_config = function ()
