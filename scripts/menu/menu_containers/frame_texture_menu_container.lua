...
FrameTextureMenuContainer.init = function (self)
	FrameTextureMenuContainer.super.init(self)
end

FrameTextureMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
	local width, height
...
FrameTextureMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

FrameTextureMenuContainer.render = function (self, dt, t, gui, layout_settings)
...
FrameTextureMenuContainer.create_from_config = function ()
