...
TextureMenuContainer.init = function (self)
	TextureMenuContainer.super.init(self)
end

TextureMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
	local width, height
...
TextureMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

TextureMenuContainer.render_from_child_page = function (self, dt, t, gui, layout_settings)
...
TextureMenuContainer.render = function (self, dt, t, gui, layout_settings)
...
TextureMenuContainer.create_from_config = function ()
