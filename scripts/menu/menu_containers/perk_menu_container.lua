...
PerkMenuContainer.init = function (self)
	PerkMenuContainer.super.init(self)
	self:clear()
end

PerkMenuContainer.clear = function (self)
	self._basic = nil
	self._specialized_1 = nil
	self._specialized_2 = nil
end

PerkMenuContainer.load = function (self, profile, perk_type)
	self:clear()
...
PerkMenuContainer.basic_perk = function (self)
	return self._basic
end

PerkMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
	self._width = layout_settings.width
	self._height = layout_settings.height
end

PerkMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
end

PerkMenuContainer._render_perk_text = function (self, gui, text, font, font_size, color_table, offset_x, offset_y, drop_shadow_table, drop_shadow_offset)
...
PerkMenuContainer.render = function (self, dt, t, gui, layout_settings)
	if self._basic then
...
PerkMenuContainer._render_perk_textures = function (self, gui, textures, offset_x, offset_y, width, height, layout_settings)
...
PerkMenuContainer.create_from_config = function (text)
