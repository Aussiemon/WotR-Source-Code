...
ProfileViewerMenuContainer.init = function (self, world_name, viewport_name, menu_settings)
...
ProfileViewerMenuContainer.add_alignment_unit = function (self, name, unit)
	self._alignment_units[name] = unit
end

ProfileViewerMenuContainer.clear = function (self)
	self:remove_unit("player")
	self:remove_unit("mount")
end

ProfileViewerMenuContainer.remove_unit = function (self, name)
...
ProfileViewerMenuContainer._set_unit_position_rotation = function (self, unit_name, position_offset, rotation_offset)
...
ProfileViewerMenuContainer._align_unit_position_rotation = function (self, unit_name, alignment_unit)
...
ProfileViewerMenuContainer.load_profile = function (self, player_profile)
	self:remove_unit("player")
	self:remove_unit("mount")
...
ProfileViewerMenuContainer._camera_unit = function (self)
...
ProfileViewerMenuContainer.load_player = function (self, player_profile)
...
ProfileViewerMenuContainer.player_unit = function (self)
	return self:unit("player")
end

ProfileViewerMenuContainer.update_coat_of_arms = function (self, team_name)
...
ProfileViewerMenuContainer.load_mount = function (self, mount_profile)
	local spawn_config = {
...
ProfileViewerMenuContainer.load_gear = function (self, player_profile)
...
ProfileViewerMenuContainer._load_wielded_gear = function (self, name, gear_name, wielded_gear)
	local gear_settings = Gear[gear_name]
...
ProfileViewerMenuContainer._load_unwielded_gear = function (self, name, gear_name)
	local gear_settings = Gear[gear_name]
	local spawn_config = {
		unit_name = gear_settings.husk_unit,
...
ProfileViewerMenuContainer.load_head = function (self, player_profile)
...
ProfileViewerMenuContainer.load_helmet = function (self, player_profile)
...
ProfileViewerMenuContainer.load_helmet_attachments = function (self, player_profile)
	local helmet = Helmets[player_profile.helmet.name]
	local pattern
...
ProfileViewerMenuContainer.load_armour_attachments = function (self, player_profile)
	local armour = Armours[player_profile.armour]
	local pattern = armour.attachment_definitions.patterns[player_profile.armour_attachments.patterns]
	local meshes = armour.preview_unit_meshes
...
ProfileViewerMenuContainer.render = function (self, dt, t, gui, layout_settings)
	local world = Managers.world:world(self._world_name)
	local viewport = ScriptWorld.viewport(world, self._viewport_name)
...
ProfileViewerMenuContainer.create_from_config = function (world_name, viewport_name, menu_settings)
