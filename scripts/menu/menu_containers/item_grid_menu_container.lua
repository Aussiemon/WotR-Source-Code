...
ItemGridMenuContainer.init = function (self, items, header_items, scroll_bar_items)
...
ItemGridMenuContainer.is_mouse_inside = function (self, mouse_x, mouse_y)
...
ItemGridMenuContainer.can_scroll = function (self, layout_settings)
...
ItemGridMenuContainer.top_visible_row = function (self)
	return self._top_visible_row
end

ItemGridMenuContainer.set_top_visible_row = function (self, row)
	if row > 1 or row < #self._items then
		self._top_visible_row = row
	end
end

ItemGridMenuContainer.scroll_up = function (self)
	if self._top_visible_row > 1 then
		self._top_visible_row = self._top_visible_row - 1
	end
end

ItemGridMenuContainer.scroll_down = function (self, layout_settings)
	local column_settings = layout_settings.items.columns
	local number_of_columns = #column_settings
	local number_of_rows = math.ceil(#self._items / number_of_columns)
	local number_of_visible_rows = layout_settings.number_of_visible_rows or number_of_rows
...
ItemGridMenuContainer.items = function (self)
	return self._items
end

ItemGridMenuContainer.update_size = function (self, dt, t, gui, layout_settings)
...
ItemGridMenuContainer.update_position = function (self, dt, t, layout_settings, x, y, z)
	self._x = x
	self._y = y
	self._z = z
...
ItemGridMenuContainer.render = function (self, dt, t, gui, layout_settings)
...
ItemGridMenuContainer._update_items_size = function (self, dt, t, gui, layout_settings, items, settings)
...
ItemGridMenuContainer._update_items_position = function (self, dt, t, layout_settings, x, y, z, items, row_offset, settings, column_width_table)
	local column_settings = settings.columns
	local number_of_columns = #column_settings
	local number_of_rows = math.ceil(#self._items / number_of_columns)
	local number_of_visible_rows = layout_settings.number_of_visible_rows or number_of_rows
...
ItemGridMenuContainer._visible_items_table = function (self, number_of_columns, number_of_visible_rows)
	local visible_items = {}
...
ItemGridMenuContainer.row_info = function (self)
	return self._start_index, self._end_index
end

ItemGridMenuContainer._columns_width = function (self, items, column_settings)
...
ItemGridMenuContainer._items_in_column = function (self, items, column_num, num_columns)
...
ItemGridMenuContainer._row_background_color = function (self, gui, layout_settings, i, settings, rows_height, rows_offset)
	local number_of_columns = #settings.columns
	local current_row = math.ceil(i / number_of_columns)
	local row_settings = settings.rows[current_row] or settings.rows[#settings.rows]
	local c
...
ItemGridMenuContainer.create_from_config = function (items, header_items, scroll_bar_items)
