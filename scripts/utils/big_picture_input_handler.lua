...
BigPictureInputHandler.init = function (self)
	self:_setup_variables()
end

BigPictureInputHandler._setup_variables = function (self)
...
BigPictureInputHandler.is_deactivating = function (self)
	return self._overlay_deactivate_time and self._overlay_deactivate_time > Managers.time:time("main")
end

BigPictureInputHandler.show_text_input = function (self, description, min_length, max_length, password)
...
BigPictureInputHandler.poll_text_input_done = function (self)
	local text = ""
