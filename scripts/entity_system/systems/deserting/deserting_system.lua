...
DesertingSystem.init = function (self, context, system_name)
...
DesertingSystem.on_add_extension = function (self, world, unit, extension_name, extension_class, ...)
...
DesertingSystem.on_remove_extension = function (self, unit, extension_name)
	return
end

DesertingSystem.update = function (self, context, t)
	for extension_name, _ in pairs(self._extensions) do
		self:update_extension(extension_name, context, t)
	end
end

DesertingSystem.update_extension = function (self, extension_name, context, t)
...
DesertingSystem._set_desert_timer = function (self, unit, player, t)
...
DesertingSystem._remove_desert_timer = function (self, unit, player)
...
DesertingSystem._unit_in_active_boundary = function (self, unit)
...
DesertingSystem._kill_player = function (self, unit, player, damage_extension)
	if player.remote then
		local network_manager = Managers.state.network
...
DesertingSystem.flow_cb_activate_boundary_area = function (self, params)
...
DesertingSystem.flow_cb_deactivate_boundary_area = function (self, params)
	local team_name = Managers.state.team:name(params.side)
	local area = params.boundary_area
...
DesertingSystem.hot_join_synch = function (self, sender, player)
	return
end

DesertingSystem.destroy = function (self)
	return
end
