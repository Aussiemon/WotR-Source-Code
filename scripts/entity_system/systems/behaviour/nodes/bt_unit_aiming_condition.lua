...
BTUnitAimingCondition.init = function (self, ...)
	BTUnitAimingCondition.super.init(self, ...)
	fassert(self._input, "No input set for node %q", self._name)
end

BTUnitAimingCondition.accept = function (self, unit, blackboard, t, dt)
...
BTUnitAimingCondition.aiming_at_me = function (self, unit, target_unit, locomotion, target_locomotion)
