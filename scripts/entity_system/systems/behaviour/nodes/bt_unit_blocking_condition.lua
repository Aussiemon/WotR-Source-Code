...
BTUnitBlockingCondition.init = function (self, ...)
	BTUnitBlockingCondition.super.init(self, ...)
	fassert(self._input, "No input set for node %q", self._name)
end

BTUnitBlockingCondition.setup = function (self, unit, blackboard, profile)
...
BTUnitBlockingCondition.accept = function (self, unit, blackboard, t, dt)
