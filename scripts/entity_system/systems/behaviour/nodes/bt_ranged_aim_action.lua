...
BTRangedAimAction.init = function (self, ...)
...
BTRangedAimAction.setup = function (self, unit, blackboard, profile)
	self._aim_node = self._data.aim_node or "Neck"
	self._projectile_gravity = ProjectileSettings.gravity:unbox()[3]
end

BTRangedAimAction.run = function (self, unit, blackboard, t, dt)
