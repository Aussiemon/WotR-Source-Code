...
BTProcessMoveOrdersAction.init = function (self, ...)
	BTProcessMoveOrdersAction.super.init(self, ...)
	fassert(self._input, "No input set for node %q", self._name)
end

BTProcessMoveOrdersAction.run = function (self, unit, blackboard, t, dt)
...
BTProcessMoveOrdersAction._command_finished = function (self, unit, blackboard, goal, command)
	local move_orders = blackboard[self._input]
