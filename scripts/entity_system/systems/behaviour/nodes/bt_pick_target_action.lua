...
BTPickTargetAction.init = function (self, ...)
...
BTPickTargetAction.setup = function (self, unit, blackboard, profile)
...
BTPickTargetAction.run = function (self, unit, blackboard, t, dt)
