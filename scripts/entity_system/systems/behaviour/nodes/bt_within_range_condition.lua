...
BTWithinRangeCondition.init = function (self, ...)
...
BTWithinRangeCondition.setup = function (self, unit, blackboard, profile)
	BTWithinRangeCondition.super.setup(self, unit, blackboard, profile)

	self._range = self._data.range
end

BTWithinRangeCondition.accept = function (self, unit, blackboard, t, dt)
