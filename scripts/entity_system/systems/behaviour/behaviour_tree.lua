...
BehaviourTree.init = function (self, name, tree_definition)
	self._name = name
...
BehaviourTree.name = function (self)
	return self._name
end

BehaviourTree._parse_tree_definition = function (self, node_definition, parent_node)
...
BehaviourTree._create_node = function (self, node_definition, parent_node)
...
BehaviourTree.setup = function (self, unit, blackboard, profile)
	self._root_node:setup(unit, blackboard, profile)
end

BehaviourTree.run = function (self, unit, blackboard, t, dt)
