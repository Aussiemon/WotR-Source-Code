...
EntitySystem.init = function (self, creation_context)
...
EntitySystem._init_systems = function (self)
	self.systems = {}
...
EntitySystem._add_system = function (self, name, class, context, active, post_update)
...
EntitySystem.update = function (self, dt, spec_system_table)
	self.delta_time = dt
	self.t = self.t + dt
...
EntitySystem.system_update = function (self, update_func, system_table, spec_system_table)
	local system_context = {}
...
EntitySystem.hot_join_synch = function (self, sender, player)
...
EntitySystem.timer = function (self, enabled)
	self.timer_enabled = enabled
	self.bb.timer_enabled = enabled
end

EntitySystem.get_entities = function (self, system_name)
