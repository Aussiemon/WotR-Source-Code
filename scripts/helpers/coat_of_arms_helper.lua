...
CoatOfArmsHelper.coat_of_arms_setting = function (self, category, name)
...
CoatOfArmsHelper.set_material_properties = function (self, settings, unit, mesh_name, material_name, team_name)
