...
MenuHelper.layout_settings = function (self, settings_table)
...
MenuHelper.layout_settings_string = function (self, settings_string)
...
MenuHelper.container_position = function (self, container, layout_settings)
	local res_width, res_height = Gui.resolution()
...
MenuHelper.scale_to_fullscren = function (original_width, original_height, keep_aspect_ratio)
	local res_width, res_height = Gui.resolution()
	local width, height
...
MenuHelper.format_text = function (self, text, gui, font, font_size, max_width)
	return Gui.word_wrap(gui, text, font, font_size, max_width, " ", "-+&/*", "\n")
end

MenuHelper.lines = function (self, str)
	local t = {}
...
MenuHelper.create_input_popup_page = function (self, world, parent_page, callback_object, on_enter_options, on_item_selected, cb_save_button_disabled, page_z, sounds, header_text, layout_settings_page, layout_settings_header, layout_settings_input, layout_settings_button, min_text_length, max_text_length, password)
	local compiler_data = {
		world = world
	}
	local page_config = {
...
MenuHelper.create_confirmation_popup_page = function (self, world, parent_page, callback_object, on_enter_options, on_item_selected, page_z, sounds, header_text, message_text, layout_settings_page, layout_settings_header, layout_settings_message, layout_settings_button)
	local compiler_data = {
		world = world
	}
	local page_config = {
...
MenuHelper.cb_buy_entity_popup_selected = function (self, args)
...
MenuHelper.cb_purchase_complete = function (self, success)
...
MenuHelper.create_purchase_market_item_popup_page = function (self, world, parent_page, market_item_type, market_item_name, message_args, page_z, sounds)
...
MenuHelper.create_rank_not_met_popup_page = function (self, world, parent_page, entity_type, unlock_key, entity_ui_name, page_z, sounds)
...
MenuHelper.create_locked_in_demo_popup_page = function (self, world, parent_page, page_z, sounds)
...
MenuHelper.create_filter_popup_page = function (self, world, parent_page, page_z, sounds)
...
MenuHelper.create_required_perk_popup_page = function (self, world, parent_page, ui_name, required_perk, page_z, sounds)
	local layout_settings_page = MainMenuSettings.pages.message_popup
	local layout_settings_header = MainMenuSettings.items.popup_header
	local layout_settings_message = MainMenuSettings.items.popup_textbox
	local layout_settings_button = MainMenuSettings.items.popup_button
...
MenuHelper.create_buy_gold_popup_page = function (self, world, parent_page, callback_object, on_enter_options, on_item_selected, page_z, sounds)
	local page_config = {
		on_enter_options = on_enter_options,
		on_item_selected = on_item_selected,
		z = page_z,
...
MenuHelper.create_sale_popup_page = function (self, world, callback_object, parent_page, page_z, sounds, sale_items)
	local page_config = {
...
MenuHelper.outfit_menu_item_requirement_info = function (layout_settings, config)
...
MenuHelper.calculate_minimap_position = function (pos, minimap_props)
...
MenuHelper.light_adaption_fix_shading_callback = function (world, shading_env)
...
MenuHelper.is_outside_screen = function (x, y, w, h, padding)
	local res_width, res_height = Gui.resolution()
...
MenuHelper.single_player_levels_sorted = function ()
	local sorted_table = {}
