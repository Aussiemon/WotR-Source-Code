...
AreaBuffHelper.play_squad_area_buff_voice_over = function (self, unit, buff_type, world, sender)
...
AreaBuffHelper.create_squad_area_buff = function (self, player, owning_unit, buff_type, world)
...
AreaBuffHelper.unit_in_buff_area = function (self, unit, owning_unit, shape, radius)
...
AreaBuffHelper.cb_squad_eligible_target_calculation = function (self, player)
	return self:alive_units_in_squad(player)
end

AreaBuffHelper.alive_units_in_squad = function (self, player)
...
AreaBuffHelper.cb_squad_area_buff_level_calculation = function (self, source_name)
