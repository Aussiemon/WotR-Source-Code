...
WeaponHelper.locomotion_velocity = function (self, u)
...
WeaponHelper.gear_impact = function (self, hit_gear_unit, gear_unit, target_type, direction, damage, damage_without_armour, position, normal, world, fully_charged_attack)
...
WeaponHelper.shield_impact_character = function (self, hit_character_unit, damage, position, normal, world, hit_zone, impact_direction)
...
WeaponHelper.push_impact_character = function (self, hit_character_unit, damage, position, normal, world, hit_zone, impact_direction)
	self:_player_hit_by_damaging_source(hit_character_unit, damage)
...
WeaponHelper.rush_impact_character = function (self, hit_character_unit, position, normal, world, impact_direction)
	local damage_ext = ScriptUnit.extension(hit_character_unit, "damage_system")
	local kd = damage_ext.is_knocked_down and damage_ext:is_knocked_down()
	local dead = damage_ext:is_dead()
...
WeaponHelper.mount_impact_character = function (self, hit_character_unit, damage_without_armour, position, normal, world, hit_zone, impact_direction)
	local damage_ext = ScriptUnit.extension(hit_character_unit, "damage_system")
	local kd = damage_ext.is_knocked_down and damage_ext:is_knocked_down()
	local dead = damage_ext:is_dead()
...
WeaponHelper.weapon_impact_character = function (self, hit_character_unit, gear_unit, target_type, direction, stun, damage, damage_without_armour, position, normal, world, hit_zone, impact_direction, weapon_damage_direction)
...
WeaponHelper._blood_trail = function (self, world, unit, position, weapon_damage_direction)
...
WeaponHelper.handgonne_impact_character = function (self, hit_character_unit, position, damage, world, stun, hit_zone, impact_direction)
	self:_player_hit_by_damaging_source(hit_character_unit, damage)
...
WeaponHelper.projectile_impact = function (self, world, hit_unit, projectile_unit, player, position, rotation, damage, penetrated, target_type, hit_zone, impact_direction, normal, stun)
...
WeaponHelper._projectile_impact_sound_event = function (self, hit_unit, position, penetrated, player, world, hit_zone)
	local timpani_world = World.timpani_world(world)
...
WeaponHelper._hurt_sound_event = function (self, hit_character_unit, damage, world)
	local timpani_world = World.timpani_world(world)
...
WeaponHelper._blood_splat_decal = function (self, world, raycast_position, raycast_direction)
...
WeaponHelper._blood_splat_decal_raycast_result = function (self, raycast_direction, world, hit, position, distance, normal, actor)
...
WeaponHelper._player_hit_by_damaging_source = function (self, hit_character_unit, damage, impact_direction)
	if damage > 0 then
		local locomotion_ext = ScriptUnit.extension(hit_character_unit, "locomotion_system")
...
WeaponHelper.player_unit_hit_reaction_animation = function (self, unit, hit_zone, impact_direction, aim_direction)
...
WeaponHelper.player_unit_stun_animation = function (self, unit, hit_zone, impact_direction)
	if script_data.impact_direction_debug then
		local drawer = Managers.state.debug:drawer({
			mode = "retained",
			name = "weapon"
...
WeaponHelper._impact_direction_strings = function (self, unit, impact_direction)
	local unit_rot = Unit.world_rotation(unit, 0)
	local unit_forward = Quaternion.forward(unit_rot)
	local flat_impact_dir = Vector3.normalize(Vector3.flat(impact_direction))
	local unit_right = Quaternion.right(unit_rot)
...
WeaponHelper._hit_sound_event = function (self, world, weapon_unit, hit_unit, hit_unit_type, damage, damage_without_armor, attack_name)
...
WeaponHelper._armour_type_sound_parameter = function (self, unit)
...
WeaponHelper._play_melee_hit_sound_event = function (self, hit_unit, weapon_unit, world, damage_type, armour_type_short, damage_level, damage_description)
	local event_id
	local timpani_world = World.timpani_world(world)
...
WeaponHelper.shaft_damage_type = function (self, weapon_unit)
	return SHAFT_TYPES[self:_armour_type_sound_parameter(weapon_unit)]
end

WeaponHelper.non_damage_hit_sound_event = function (self, world, weapon_unit, hit_unit)
	local armour_type_short = self:_armour_type_sound_parameter(hit_unit)
...
WeaponHelper.melee_weapon_velocity = function (self, weapon_unit, attack_name, attack_time, attachment_multipliers, duration)
...
WeaponHelper.calculate_melee_damage = function (self, attacker_velocity, weapon_velocity, victim_velocity, weapon_unit, attacker_unit, victim_unit, attack_name, damage_type, charge_time, actor, attachment_multipliers, properties, impact_direction)
	local attack_settings = Unit.get_data(weapon_unit, "attacks")[attack_name]
...
WeaponHelper.calculate_perk_attack_damage = function (self, weapon_unit, attacker_unit, victim_unit, attack_name, damage_type, charge_time, actor, impact_direction)
	local attack_settings = Unit.get_data(weapon_unit, "attacks")[attack_name]
...
WeaponHelper.calculate_projectile_damage = function (self, attacker_velocity, weapon_velocity, victim_velocity, firing_gear_name, projectile_unit, victim_unit, projectile_name, actor, position, normal, impact_direction, properties, damage_multiplier)
...
WeaponHelper._debug_projectile_penetration = function (self, position, normal, impact_direction)
	local drawer = Managers.state.debug:drawer({
		mode = "retained",
		name = "weapon"
	})
...
WeaponHelper.calculate_handgonne_damage = function (self, weapon_unit, attacker_unit, victim_unit, projectile_name, actor, properties, impact_direction, distance, weapon_settings, projectile_settings)
...
WeaponHelper.hit_zone = function (self, unit, actor)
...
WeaponHelper._weapon_impact_speed = function (self, attacker_velocity, weapon_velocity, victim_velocity)
...
WeaponHelper._armour_values = function (self, victim_unit, hit_zone_hit, actor, impact_direction)
...
WeaponHelper._debug_melee_damage = function (self, base_damage, charge_value, impact_speed, weapon_speed_max, damage_without_armor, penetration_value, penetration_coefficient, penetrated, actor, hit_zone_multiplier, absorption_value, absorption_coefficient, damage)
...
WeaponHelper._debug_projectile_damage = function (self, base_damage, impact_speed, weapon_speed_max, damage_without_armor, penetration_value, penetration_coefficient, penetrated, actor, hit_zone_multiplier, absorption_value, absorption_coefficient, damage, scaled_penetration_value)
	print("*** DAMAGE DEBUG START ***************************")
	print("base_damage = " .. base_damage)
	print("impact_speed = " .. impact_speed)
	print("weapon_speed_max = " .. weapon_speed_max)
...
WeaponHelper._debug_handgonne_damage = function (self, base_damage, damage_without_armor, penetration_value, penetration_coefficient, penetrated, actor, hit_zone_multiplier, absorption_value, absorption_coefficient, damage)
	print("*** DAMAGE DEBUG START ***************************")
	print("base_damage = " .. base_damage)
...
WeaponHelper.projectile_fire_position_from_camera = function (self, weapon_unit, user_unit, projectile_name)
	local attack_settings = Unit.get_data(weapon_unit, "attacks").ranged
	local weapon_name = Unit.get_data(weapon_unit, "gear_name")
...
WeaponHelper.handgonne_fire_position_from_camera = function (self, gear_unit, user_unit, muzzle_position, max_bullet_spread)
	local camera_manager = Managers.state.camera
	local viewport_name = Unit.get_data(user_unit, "viewport_name")
	local camera_position = camera_manager:camera_position(viewport_name)
	local camera_rotation = camera_manager:camera_rotation(viewport_name)
...
WeaponHelper.handgonne_fire_position_from_handgonne = function (self, gear_unit, user_unit, muzzle_position, max_bullet_spread)
...
WeaponHelper._add_spread = function (self, rotation, max_spread_angle, user_unit)
	local locomotion_ext = ScriptUnit.extension(user_unit, "locomotion_system")
...
WeaponHelper.bow_projectile_fire_velocity_from_camera = function (self, weapon_unit, user_unit, draw_time, draw_time_loss)
	local attack_settings = Unit.get_data(weapon_unit, "attacks").ranged
	local settings
	local speed_func = attack_settings.speed_function
...
WeaponHelper.crossbow_projectile_fire_velocity_from_camera = function (self, weapon_unit, user_unit)
	local attack_settings = Unit.get_data(weapon_unit, "attacks").ranged
	local speed_max = attack_settings.speed_max
	local camera_manager = Managers.state.camera
	local viewport_name = Unit.get_data(user_unit, "viewport_name")
...
WeaponHelper.projectile_fire_position_from_ranged_weapon = function (self, weapon_unit, user_unit, projectile_name)
	local weapon_name = Unit.get_data(weapon_unit, "gear_name")
	local projectile_settings = self:attachment_settings(weapon_name, "projectile_head", projectile_name)
	local parent_link_node_name = projectile_settings.parent_link_node
	local parent_link_node = Unit.node(user_unit, parent_link_node_name)
...
WeaponHelper.projectile_fire_velocity_from_bow = function (self, weapon_unit, aim_direction, draw_time)
	local attack_settings = Unit.get_data(weapon_unit, "attacks").ranged
	local speed_func = attack_settings.speed_function
	local speed_max = attack_settings.speed_max
...
WeaponHelper.remove_projectiles = function (self, unit)
...
WeaponHelper.add_damage = function (self, world, victim_unit, player, player_unit, damage_type, damage, position, normal, actor, damage_range_type, gear_name, hit_zone, impact_direction, real_damage, show_damage, range)
...
WeaponHelper.add_damage_over_time = function (self, world, victim_unit, player, damage_type)
	local network_manager = Managers.state.network
...
WeaponHelper.damage_over_time_property = function (self, property)
	return property == "bleeding" or property == "burning"
end

WeaponHelper.new_attachment_multipliers = function (self)
...
WeaponHelper.attachment_items_by_category = function (self, gear_name, category)
...
WeaponHelper.attachment_settings = function (self, gear_name, category, name)
...
WeaponHelper._weapon_has_property = function (self, properties, value)
...
WeaponHelper.current_impact_direction = function (self, weapon_unit, current_attack_name)
...
WeaponHelper.perk_attack_hit_damagable_prop = function (self, world, user_unit, weapon_unit, hit_unit, position, normal, actor, current_attack, impact_direction)
...
WeaponHelper.perk_attack_hit_non_damagable_prop = function (self, world, user_unit, weapon_unit, hit_unit, position, normal, actor, current_attack, impact_direction)
...
WeaponHelper.add_perk_attack_damage = function (self, world, user_unit, weapon_unit, victim_unit, position, normal, actor, hit_zone, apply_damage, current_attack, impact_direction)
...
WeaponHelper.apply_damage = function (self, world, user_unit, weapon_unit, victim_unit, position, normal, actor, damage_type, damage, damage_range_type, raw_damage, current_attack, hit_zone, impact_direction, weapon_properties, real_damage)
...
WeaponHelper.apply_damage_to_self = function (self, world, user_unit, weapon_unit, damage_type, damage, position, normal, damage_range_type, impact_direction)
	local settings = Unit.get_data(weapon_unit, "settings")
...
WeaponHelper.helmet_hack = function (self, hit_unit, actor)
