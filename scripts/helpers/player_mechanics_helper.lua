...
PlayerMechanicsHelper.suicide = function (internal)
...
PlayerMechanicsHelper.player_unit_tagged = function (local_player, other_player_unit)
...
PlayerMechanicsHelper.time_to_tag = function (player_unit, tagged_unit)
...
PlayerMechanicsHelper.calculate_fall_distance = function (internal, fall_height, landing_position)
...
PlayerMechanicsHelper._pick_landing = function (internal, fall_distance)
...
PlayerMechanicsHelper.horse_update_movement_inair = function (self, unit, internal, dt)
...
PlayerMechanicsHelper.velocity_driven_update_movement = function (self, unit, internal, dt, allow_upward_velocity)
	local mover = Unit.mover(unit)
	local velocity = internal.velocity:unbox()
	local speed = Vector3.length(velocity)
...
PlayerMechanicsHelper.animation_driven_update_movement = function (self, unit, internal, dt, allow_upward_velocity)
	local mover = Unit.mover(unit)
...
PlayerMechanicsHelper.clamp_delta_vs_husks = function (current_position, delta, internal)
...
math.closest_point_on_line_2d = function (position, line_start, line_end)
...
PlayerMechanicsHelper.clamp_delta_vs_dyanmic_objects = function (current_position, delta, internal)
	local actors = internal.husks_in_proximity
...
PlayerMechanicsHelper.script_driven_camera_relative_update_movement = function (self, unit, internal, dt, allow_upward_velocity)
	local mover = Unit.mover(unit)
	local current_position = Unit.local_position(unit, 0)
	local velocity = internal.velocity:unbox()
	local speed = Vector3.length(velocity)
