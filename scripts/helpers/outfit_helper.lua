...
OutfitHelper.attachment_multiplier_to_gear_property = function (multiplier_name)
...
OutfitHelper.gear_property_to_attachment_multiplier = function (gear_property)
...
OutfitHelper.gear_property = function (gear_name, property_name)
...
OutfitHelper._gear_gravity = function ()
	return math.abs(ProjectileSettings.gravity:unbox()[3])
end

OutfitHelper._gear_mean_speed = function (gear_name)
	local sum_speed = 0
	local num_attacks = 0
...
OutfitHelper._gear_reload_time = function (gear_name)
	local gear_settings = Gear[gear_name]
...
OutfitHelper._gear_attack_penalty_mean_value = function (gear_name, ...)
	local sum = 0
	local num = select("#", ...)
	local changed = false
...
OutfitHelper._gear_attack_property_mean_value = function (gear_name, property_name, ...)
	local sum = 0
	local num_attacks = 0
	local gear_settings = Gear[gear_name]
...
OutfitHelper.gear_property_min = function (property_name)
...
OutfitHelper.gear_property_max = function (property_name)
	local max_value = 0
...
OutfitHelper.armour_property_max = function (property_name)
	local max_value = 0
...
OutfitHelper.helmet_property_max = function (property_name)
	local max_value = 0
...
OutfitHelper.mount_property_max = function (property_name)
	local max_value = 0
...
OutfitHelper.small_attachment_textures = function (gear_name, attachment_category, attachment_name)
	local gear_settings = Gear[gear_name]
	local textures = {}
...
OutfitHelper.outfit_editor_character_profiles_options = function ()
	local options = {}
...
OutfitHelper.outfit_editor_slot_options = function ()
	local options = {
		{
			value = "menu_perks",
			key = "perks"
...
OutfitHelper.outfit_editor_gear_category_options = function (slot_name)
	local sorted_table = {}
...
OutfitHelper.outfit_editor_armour_category_options = function ()
	local sorted_table = {}
...
OutfitHelper.outfit_editor_helmet_category_options = function ()
	local sorted_table = {}
...
OutfitHelper.outfit_editor_perk_category_options = function ()
	local options = {
		{
...
OutfitHelper.outfit_editor_mount_category_options = function ()
	local sorted_table = {}
...
OutfitHelper.gear_hidden = function (config)
...
OutfitHelper.outfit_editor_gear_options = function (category)
	local sorted_table = {}
...
OutfitHelper.outfit_editor_armour_options = function (category)
	local sorted_table = {}
...
OutfitHelper.outfit_editor_helmet_options = function (category)
	local sorted_table = {}
...
OutfitHelper.outfit_editor_basic_perk_options = function (category, player_profile)
	local options = {}
...
OutfitHelper.outfit_editor_specialized_perk_options = function (basic_perk, player_profile)
	local options = {}
...
OutfitHelper.outfit_editor_mount_options = function (category)
	local sorted_table = {}
