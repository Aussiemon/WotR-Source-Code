...
GameModeHelper.announcement_parameters = function (self, announcement, player, world)
...
GameModeHelper.objective_parameters = function (self, objective, player, world)
...
GameModeHelper.own_team_ui_name = function (self, player)
	return player.team.ui_name
end

GameModeHelper.enemy_team_ui_name = function (self, player)
...
GameModeHelper.enemy_team_ui_name_definite_plural = function (self, player)
	local enemy_team_name = player.team.name == "red" and "white" or "red"
	local enemy_team = Managers.state.team:team_by_name(enemy_team_name)
...
GameModeHelper.round_time_left = function (self, player)
	return Managers.state.game_mode:hud_timer_text()
end

GameModeHelper.current_level_name = function (self, player)
	local level_settings = LevelHelper:current_level_settings()

	return L(level_settings.display_name)
end

GameModeHelper.attackers_objectives_grouped_on_interaction = function (self, player)
...
GameModeHelper.sp_objectives_grouped_on_interaction = function (self, player)
...
GameModeHelper.attackers_objective_ui_names = function (self, player)
	local active_objectives = Managers.state.game_mode:active_objectives_by_side("attackers")
	local str = ""
...
GameModeHelper.last_objective_ui_name = function (self, player)
...
GameModeHelper.player_unit_tagged_by_own_squad_corporal = function (self, player)
...
GameModeHelper.objective_unit_tagged_by_own_squad_corporal = function (self, player, world)
	local network_manager = Managers.state.network
	local game = network_manager:game()
...
GameModeHelper.name_of_player_tagged_by_squad_corporal = function (self, player)
...
GameModeHelper.name_of_objective_tagged_by_squad_corporal = function (self, player, world)
...
GameModeHelper.interaction_of_objective_tagged_by_squad_corporal = function (self, player, world)
	local tagged_unit = self:objective_unit_tagged_by_own_squad_corporal(player, world)
