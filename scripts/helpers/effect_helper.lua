...
EffectHelper.play_surface_material_effects = function (effect_name, world, unit, position, rotation, normal)
...
EffectHelper.remote_play_surface_material_effects = function (effect_name, world, unit, position, rotation, normal)
...
EffectHelper.footstep_raycast_result = function (self, effect_name, foot_direction, hit, position, distance, normal, actor)
	if hit then
