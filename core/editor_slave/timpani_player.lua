...
Keyboard.button = function (i)
	return keyboard[Keyboard.button_name(i)] or 0
end

Mouse.axis = function (i)
...
TimpaniPlayer.init = function (self)
	self:init_world()
	self:init_camera()
...
TimpaniPlayer.init_world = function (self)
...
TimpaniPlayer.init_camera = function (self)
...
TimpaniPlayer.shutdown = function (self)
...
TimpaniPlayer.reboot = function (self)
	self:shutdown()
	self:init_world()
	self:init_camera()
...
TimpaniPlayer.load_level = function (self, level)
...
TimpaniPlayer.render = function (self)
...
TimpaniPlayer.event = function (self, name, parameters)
...
TimpaniPlayer.sound = function (self, name, parameters)
	local tw = World.timpani_world(self.world)
	local id
...
TimpaniPlayer.stop_all = function (self)
	local tw = World.timpani_world(self.world)

	tw:stop_all()
end

TimpaniPlayer.set_environment = function (self, name)
	local tw = World.timpani_world(self.world)

	tw:set_environment(name)
end

TimpaniPlayer.set_parameter = function (self, name, value)
	self.parameters[name] = value

	self:update_parameters()
end

TimpaniPlayer.update_parameters = function (self)
	if not self.id then
		return
	end
...
TimpaniPlayer.update = function (self, dt)
	self.t = self.t + dt
...
TimpaniPlayer.set_source = function (self, type)
...
TimpaniPlayer.set_listener = function (self, type)
...
TimpaniPlayer.update_sound_source = function (self, dt)
