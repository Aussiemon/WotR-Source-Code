...
TextDrawer.init = function (self, gui, font, material)
...
TextDrawer.space = function (self, s)
...
ParticleEditor.init = function (self)
	self.t = 0
...
ParticleEditor.init_world = function (self)
...
ParticleEditor.init_camera = function (self)
...
ParticleEditor.set_camera_distance = function (self, d)
...
ParticleEditor.shutdown = function (self)
	self.camera_distance = nil
...
ParticleEditor.reboot = function (self)
	self:shutdown()
	self:init_world()
	self:init_camera()
...
ParticleEditor.load_level = function (self, level)
...
ParticleEditor.render = function (self)
...
ParticleEditor.stop = function (self)
	if self.id then
...
ParticleEditor.test = function (self)
	self:stop()
...
ParticleEditor.respawn = function (self)
	self.t = 0
...
ParticleEditor.set_paused = function (self, paused)
	self.paused = paused
end

ParticleEditor.scrub = function (self, t)
	if t < self.t then
		self:respawn()
	end
...
ParticleEditor.update_emitter = function (self, dt)
...
ParticleEditor.update = function (self, dt)
...
ParticleEditor.draw_ruler = function (self)
...
ParticleEditor.draw_stats = function (self)
...
ParticleEditor.draw_flash = function (self)
	local size = 50
...
ParticleEditor.draw_box = function (self, tm, radius, color)
...
ParticleEditor.mouse_ray = function (self)
...
ParticleEditor.pick_variable = function (self)
...
ParticleEditor.draw_variables = function (self)
	local cam, dir = self:mouse_ray()
...
ParticleEditor.mouse_down = function (self)
	if self.options.show_variables then
...
ParticleEditor.mouse_up = function (self)
	self.drag = nil
end

ParticleEditor.drag_pos = function (self, start_pos, cam_delta, lock)
...
ParticleEditor.do_drag = function (self)
