...
BitsquidSplash.create = function (viewport_template_name, shading_environment_name, high_quality, foreground_color, background_color)
...
BitsquidSplash.render = function (splash)
